...
<head>
	...
	<script>
		...
		function goTCSTmMbr(id, nm, type){
			misSearchForm.action = "./cost_statistics_mbr";
			misSearchForm.srch_team_id.value = id;
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<br/>
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./cost_statistics">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<img src="./resources/ne_img/btn/btn_srch.gif" style="cursor: pointer;" onclick="fnSearchUserBtn();"/>		
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<c:import url="./cost_statistics1.jsp"></c:import>
						</div>
						<div class="guestcnt4" style="display:none;">
							<c:import url="./cost_statistics2.jsp"></c:import>
						</div>
						<div class="guestcnt4" style="display:none;">
							<c:import url="./cost_statistics3.jsp"></c:import>
						</div>						
					</div><!-- //guest -->
				</div><!-- centercnt_bot2 -->
			</div><!-- //center_cnt -->
