        ...
        <table class="costStatisticsTable" cellpadding="0" cellspacing="0" width="1060" align="center" <c:if test="${srchArg.excelYN == 'Y'}">border="1"</c:if>>
            ...
            <c:forEach var="vo" items="${getTCStmClaim1}" varStatus="status">
                <tr onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
                    ...
                    <c:set var="sum1_cash31" value="${sum1_cash41 + vo.cash41}" />
                    ...
                    <c:set var="sum1_card31" value="${sum1_card41 + vo.card41}" />
            ...
            <c:forEach var="vo" items="${getTCStmClaim4}" varStatus="status">
                <tr onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
                    ...
                    <c:set var="sum4_cash31" value="${sum4_cash41 + vo.cash41}" />
                    ...
                    <c:set var="sum4_card31" value="${sum4_card41 + vo.card41}" />
