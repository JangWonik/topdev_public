			...
			<div class="center_cnt">
				<div class="centercnt_bot1-3">
					<div class="guest">
						...
						<c:set var="primBizInvMemo" value="${primBizInvMemo}"/>
						<div class= "tableStyle4">
							<table cellpadding="0" cellspacing="0">
				                    ...
				                    <tr>
				                    	<td align="center"><c:out value="${primBizInvMemo.getTeam_id()}"/></td>
				                    	<td align="center"><c:out value="${primBizInvMemo.getUser_name()}"/></td>
				                    	<td align="center"><fmt:formatNumber value="${primBizInvMemo.getAmt_total()}" pattern="###,###,##0.##"/></td>
				                    </tr>
				                    ...
				                    <tr>
				                    	<td align="center"><c:out value="${primBizInvMemo.getPtnr_name()}"/></td>
				                    	<td align="center"><c:out value="${primBizInvMemo.getPtnr_mbr_name()}"/></td>
				                    	<td align="center"><c:out value="${primBizInvMemo.getBeneficiary_nm()}"/></td>
				                    </tr>
				                    <tr>
				                    	<td colspan="3">
				                    		<textarea style="width:100%" rows="10" id="rpt_invoice_memo" name="rpt_invoice_memo" ><c:out value="${primBizInvMemo.getRpt_invoice_memo()}"/></textarea>
				                    		<input type="hidden" id="rpt_invoice_no" name="rpt_invoice_no" value="${primBizInvMemo.getRpt_invoice_no()}" />
				                    		<input type="hidden" id="suim_rpt_no" name="suim_rpt_no" value="${primBizInvMemo.getSuim_rpt_no()}" />
				                    	</td>
									</tr>
							</table>
						</div>
