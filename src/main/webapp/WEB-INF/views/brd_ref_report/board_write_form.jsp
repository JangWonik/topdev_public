				...
				<div class="centercnt_bot1-2">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" name="uploadForm" action="./refReportBoardWrite" method="post" enctype="multipart/form-data">
								<input type="hidden" id="cateSearch" name="cateSearch" value="${searchVO.cateSearch}"/>
								<div class="tableStyle2">
									<table>
										<tr>
											<td width="15%" bgcolor="#e7ecf1">종 목</td>
											...
											<td width="15%" bgcolor="#e7ecf1">유 형</td>
											<td style="text-align:left;padding-left:7px;">
							...
							<p style="text-align:right;margin-top:10px;">
								...
								<a href="./refReportBoardList?cateSearch=${searchVO.cateSearch}" class="btn-vacation-aprv" style="background:#F6CED8;">취소</a>								
							</p>
						</div>
					</div>
				</div>
