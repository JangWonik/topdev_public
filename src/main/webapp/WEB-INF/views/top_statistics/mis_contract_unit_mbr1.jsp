...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
							...
							<div class="tableStyle2" id="dataTable">
								...
								<caption>팀 기본통계</caption>
									...
									<tbody>
										<c:forEach var="vo" items="${getMisContractUnitMbr}" varStatus="status">
										<tr onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
											<td><p><a href="javascript:goMisContractTmMbr2('${vo.team_id}','${vo.team_name}','${vo.team_type}','${vo.user_no}','${vo.user_name}');">${vo.user_name}</a></p></td>
											<td>${vo.team_name}</td>
