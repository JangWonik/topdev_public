				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./MisEndPtnrTotal">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="교통비" class="buttonDiaAll" onclick="goMisEndPtnr('MisEndPtnrTraffic');" type="button" value="교통비">
							<input title="자문료+기타" class="buttonDiaAll" onclick="goMisEndPtnr('MisEndPtnrQr');" type="button" value="자문료+기타">
							<input title="총 합계" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goMisEndPtnr('MisEndPtnrTotal');" type="button" value="총 합계">							
						</div>
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">총 합계</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_end_ptnr_total1.jsp"></c:import>
						</div>
