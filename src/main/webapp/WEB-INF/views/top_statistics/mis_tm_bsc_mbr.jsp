...
<head>
	...
	<script>
		...
		function goMisTmBscMbr2(id, nm){
			misSearchForm.action = "./getMisTmBscMbr2";
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./getMisTmBscMbr">
...
<%-- 											<c:if test="${inVO.primContractYN == 'Y'}">checked</c:if> /> 적부</b>&nbsp;&nbsp; --%>
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">${inVO.team_name} 개인별 통계</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_tm_bsc_mbr1.jsp"></c:import>
						</div>
