...
<head>
	...
	<script>
		...
		function goMisResultPtnr(ptnr_id, ptnr_nick, viewFromDate, viewToDate){
			misSearchForm.action = "./MisResultPtnr";
			...
			<div class="center_cnt2">
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./MisResultPtnr">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">보험사별 청구내용</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_result_ptnr1.jsp"></c:import>
						</div>
