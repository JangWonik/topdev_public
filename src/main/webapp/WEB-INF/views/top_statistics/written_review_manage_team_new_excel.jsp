		...
		<c:otherwise>
			...
			<c:forEach var="items" items="${writtenTeamList}" varStatus="status">
				...
				<tr id="written_view_${items.serialNo}">
					<td style="width:170px;text-align:center;">${items.ptnrName}</td>			
					<td style="width:170px;text-align:center;">${items.centerName}</td>
					<td style="width:170px;text-align:center;">${items.teamName}</td>					
