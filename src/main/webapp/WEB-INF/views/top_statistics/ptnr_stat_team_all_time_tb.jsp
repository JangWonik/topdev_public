...
<div class="tableStyle2">
    ...
    <div style="height:600px; overflow-x: hidden; overflow-y: auto;">
    	...
    	<table>
    		<tbody>
	            ...
	            <!-- Type 별 가로열 합계 -->
	            <c:set var="timeColTeamAllTotalSum_5" value="0"></c:set>
   				    			
    			<c:forEach var="vo" items="${ptnrStatTeamAllTimeList}" varStatus="status">    				    				
		    		<tr>
		    			<c:if test="${status.index == 0}">
		                    <td onclick="goPtnrStatMenu('ptnrStatTime');" style="width: 80px;bgcolor: #E7ECF1; text-align: center; cursor: pointer;" onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''" rowspan="${leftRowTeamAll}">
		                    	1종 조사
		                    </td>
		                </c:if>
		                <c:choose>
		    		...
		    		<c:choose>
		    			<c:when test="${teamCnt == vo.rowCnt and vo.rowCnt > 1}">
		    				...
		    				<!-- time12 -->
			                <td style="width: 75px;text-align:right;padding-right:5px; border-left:0.2em solid #b9b9b9 !important;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_12_5}" pattern="#,##0.##"/></td>
			                <!-- time11 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_11_5}" pattern="#,##0.##"/></td>
			                <!-- time10 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_10_5}" pattern="#,##0.##"/></td>
			                <!-- time09 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_09_5}" pattern="#,##0.##"/></td>
			                <!-- time08 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_08_5}" pattern="#,##0.##"/></td>
			                <!-- time07 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_07_5}" pattern="#,##0.##"/></td>
			                <!-- time06 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_06_5}" pattern="#,##0.##"/></td>
			                <!-- time05 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_05_5}" pattern="#,##0.##"/></td>
			                <!-- time04 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_04_5}" pattern="#,##0.##"/></td>
			                <!-- time03 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_03_5}" pattern="#,##0.##"/></td>
			                <!-- time02 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_02_5}" pattern="#,##0.##"/></td>
			                <!-- time01 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_01_5}" pattern="#,##0.##"/></td>
			                <!-- 가로 합계 -->
			                ...
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllColSum_5}" pattern="#,##0.##"/></td>
		    	...
		    	<!-- 1종 조사 소계 시작 -->
		    	<c:if test="${ptnrStatTeamAllTimeList.size() > 0 }">
		    	<tr bgcolor="#E7ECF1">
	                <th colspan="4" style="height:25px;">1종 조사 소계</th>
	                <!-- time12 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_12_5}" pattern="#,##0.##"/></th>
	                <!-- time11 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_11_5}" pattern="#,##0.##"/></th>
	                <!-- time10 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_10_5}" pattern="#,##0.##"/></th>
	                <!-- time09 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_09_5}" pattern="#,##0.##"/></th>
	                <!-- time08 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_08_5}" pattern="#,##0.##"/></th>
	                <!-- time07 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_07_5}" pattern="#,##0.##"/></th>
	                <!-- time06 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_06_5}" pattern="#,##0.##"/></th>
	                <!-- time05 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_05_5}" pattern="#,##0.##"/></th>
	                <!-- time04 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_04_5}" pattern="#,##0.##"/></th>
	                <!-- time03 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_03_5}" pattern="#,##0.##"/></th>
	                <!-- time02 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_02_5}" pattern="#,##0.##"/></th>
	                <!-- time01 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_01_5}" pattern="#,##0.##"/></th>
	                <!-- 가로열 합계 -->
	                <c:set var="timeColTotalSum_5" value="${timeTeamAllTotalSum_12_5 + timeTeamAllTotalSum_11_5 + timeTeamAllTotalSum_10_5 + timeTeamAllTotalSum_09_5 + timeTeamAllTotalSum_08_5 + timeTeamAllTotalSum_07_5 + timeTeamAllTotalSum_06_5 + timeTeamAllTotalSum_05_5 + timeTeamAllTotalSum_04_5 + timeTeamAllTotalSum_03_5 + timeTeamAllTotalSum_02_5 + timeTeamAllTotalSum_01_5}"></c:set>
    	...
    	<table>
    		<tbody>
	            ...
	            <!-- Type 별 가로열 합계 -->
	            <c:set var="timeColTeamAllTotalSum_10" value="0"></c:set>
   				    			
    			<c:forEach var="vo1" items="${ptnrStatTeamAllTimeList_10}" varStatus="status">    				    				
		    		<tr>
		    			<c:if test="${status.index == 0}">
		                    <td onclick="goPtnrStatMenu('ptnrStatTime');" style="width: 80px;bgcolor: #E7ECF1; text-align: center; cursor: pointer;" onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''" rowspan="${leftRowTeamAll_10}">
		                    	1종 심사
		                    </td>
		                </c:if>
		                <c:choose>
		    		...
		    		<c:choose>
		    			<c:when test="${teamCnt == vo1.rowCnt and vo1.rowCnt > 1}">
		    				...
		    				<td style="width:150px;" class="sum-level-2">계</td>
		    				<!-- time12 -->
			                <td style="width: 75px;text-align:right;padding-right:5px; border-left:0.2em solid #b9b9b9 !important;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_12_10}" pattern="#,##0.##"/></td>
			                <!-- time11 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_11_10}" pattern="#,##0.##"/></td>
			                <!-- time10 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_10_10}" pattern="#,##0.##"/></td>
			                <!-- time09 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_09_10}" pattern="#,##0.##"/></td>
			                <!-- time08 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_08_10}" pattern="#,##0.##"/></td>
			                <!-- time07 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_07_10}" pattern="#,##0.##"/></td>
			                <!-- time06 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_06_10}" pattern="#,##0.##"/></td>
			                <!-- time05 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_05_10}" pattern="#,##0.##"/></td>
			                <!-- time04 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_04_10}" pattern="#,##0.##"/></td>
			                <!-- time03 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_03_10}" pattern="#,##0.##"/></td>
			                <!-- time02 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_02_10}" pattern="#,##0.##"/></td>
			                <!-- time01 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_01_10}" pattern="#,##0.##"/></td>
			                <!-- 가로 합계 -->
			                ...
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllColSum_10}" pattern="#,##0.##"/></td>
		    	...
		    	<!-- 1종 심사 소계 시작 -->
		    	<c:if test="${ptnrStatTeamAllTimeList_10.size() > 0 }">
		    	<tr bgcolor="#E7ECF1">
	                <th colspan="4" style="height:25px;">1종 심사 소계</th>
	                <!-- time12 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_12_10}" pattern="#,##0.##"/></th>
	                <!-- time11 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_11_10}" pattern="#,##0.##"/></th>
	                <!-- time10 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_10_10}" pattern="#,##0.##"/></th>
	                <!-- time09 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_09_10}" pattern="#,##0.##"/></th>
	                <!-- time08 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_08_10}" pattern="#,##0.##"/></th>
	                <!-- time07 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_07_10}" pattern="#,##0.##"/></th>
	                <!-- time06 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_06_10}" pattern="#,##0.##"/></th>
	                <!-- time05 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_05_10}" pattern="#,##0.##"/></th>
	                <!-- time04 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_04_10}" pattern="#,##0.##"/></th>
	                <!-- time03 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_03_10}" pattern="#,##0.##"/></th>
	                <!-- time02 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_02_10}" pattern="#,##0.##"/></th>
	                <!-- time01 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_01_10}" pattern="#,##0.##"/></th>
	                <!-- 가로열 합계 -->
	                <c:set var="timeColTotalSum_10" value="${timeTeamAllTotalSum_12_10 + timeTeamAllTotalSum_11_10 + timeTeamAllTotalSum_10_10 + timeTeamAllTotalSum_09_10 + timeTeamAllTotalSum_08_10 + timeTeamAllTotalSum_07_10 + timeTeamAllTotalSum_06_10 + timeTeamAllTotalSum_05_10 + timeTeamAllTotalSum_04_10 + timeTeamAllTotalSum_03_10 + timeTeamAllTotalSum_02_10 + timeTeamAllTotalSum_01_10}"></c:set>
    	...
    	<table>
    		<tbody>
	            ...
	            <!-- Type 별 가로열 합계 -->
	            <c:set var="timeColTeamAllTotalSum_15" value="0"></c:set>
   				    			
    			<c:forEach var="vo2" items="${ptnrStatTeamAllTimeList_15}" varStatus="status">    				    				
		    		<tr>
		    			<c:if test="${status.index == 0}">
		                    <td onclick="goPtnrStatMenu('ptnrStatTime');" style="width: 80px;bgcolor: #E7ECF1; text-align: center; cursor: pointer;" onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''" rowspan="${leftRowTeamAll_15}">
		                    	1종 기타
		                    </td>
		                </c:if>
		                <c:choose>
		    		...
		    		<c:choose>
		    			<c:when test="${teamCnt == vo2.rowCnt and vo2.rowCnt > 1}">
		    				...
		    				<td style="width:150px;" class="sum-level-2">계</td>
		    				<!-- time12 -->
			                <td style="width: 75px;text-align:right;padding-right:5px; border-left:0.2em solid #b9b9b9 !important;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_12_15}" pattern="#,##0.##"/></td>
			                <!-- time11 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_11_15}" pattern="#,##0.##"/></td>
			                <!-- time10 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_10_15}" pattern="#,##0.##"/></td>
			                <!-- time09 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_09_15}" pattern="#,##0.##"/></td>
			                <!-- time08 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_08_15}" pattern="#,##0.##"/></td>
			                <!-- time07 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_07_15}" pattern="#,##0.##"/></td>
			                <!-- time06 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_06_15}" pattern="#,##0.##"/></td>
			                <!-- time05 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_05_15}" pattern="#,##0.##"/></td>
			                <!-- time04 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_04_15}" pattern="#,##0.##"/></td>
			                <!-- time03 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_03_15}" pattern="#,##0.##"/></td>
			                <!-- time02 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_02_15}" pattern="#,##0.##"/></td>
			                <!-- time01 -->
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllSum_01_15}" pattern="#,##0.##"/></td>
			                <!-- 가로 합계 -->
			                ...
			                <td style="width: 75px;text-align:right;padding-right:5px;" class="sum-level-2"><fmt:formatNumber value="${timeTeamAllColSum_15}" pattern="#,##0.##"/></td>
		    	...
		    	<!-- 1종 기타 소계 시작 -->
		    	<c:if test="${ptnrStatTeamAllTimeList_15.size() > 0 }">
		    	<tr bgcolor="#E7ECF1">
	                <th colspan="4" style="height:25px;">1종 기타 소계</th>
	                <!-- time12 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_12_15}" pattern="#,##0.##"/></th>
	                <!-- time11 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_11_15}" pattern="#,##0.##"/></th>
	                <!-- time10 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_10_15}" pattern="#,##0.##"/></th>
	                <!-- time09 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_09_15}" pattern="#,##0.##"/></th>
	                <!-- time08 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_08_15}" pattern="#,##0.##"/></th>
	                <!-- time07 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_07_15}" pattern="#,##0.##"/></th>
	                <!-- time06 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_06_15}" pattern="#,##0.##"/></th>
	                <!-- time05 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_05_15}" pattern="#,##0.##"/></th>
	                <!-- time04 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_04_15}" pattern="#,##0.##"/></th>
	                <!-- time03 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_03_15}" pattern="#,##0.##"/></th>
	                <!-- time02 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_02_15}" pattern="#,##0.##"/></th>
	                <!-- time01 -->
	                <th style="width: 75px;text-align:right;padding-right:5px;"><fmt:formatNumber value="${timeTeamAllTotalSum_01_15}" pattern="#,##0.##"/></th>
	                <!-- 가로열 합계 -->
	                <c:set var="timeColTotalSum_15" value="${timeTeamAllTotalSum_12_15 + timeTeamAllTotalSum_11_15 + timeTeamAllTotalSum_10_15 + timeTeamAllTotalSum_09_15 + timeTeamAllTotalSum_08_15 + timeTeamAllTotalSum_07_15 + timeTeamAllTotalSum_06_15 + timeTeamAllTotalSum_05_15 + timeTeamAllTotalSum_04_15 + timeTeamAllTotalSum_03_15 + timeTeamAllTotalSum_02_15 + timeTeamAllTotalSum_01_15}"></c:set>
    ...
    <c:set var="timeTeamAllTotalSum_col_all" value="${timeTeamAllTotalSum_12_all + timeTeamAllTotalSum_11_all + timeTeamAllTotalSum_10_all + timeTeamAllTotalSum_09_all + timeTeamAllTotalSum_08_all + timeTeamAllTotalSum_07_all + timeTeamAllTotalSum_06_all + timeTeamAllTotalSum_05_all + timeTeamAllTotalSum_04_all + timeTeamAllTotalSum_03_all + timeTeamAllTotalSum_02_all + timeTeamAllTotalSum_01_all}"></c:set>
    <!-- 총 합계 변수 끝 -->
    <div style="padding-right: 17px; background: #e7ecf1;">    	
    	<table>
    		<tr>    			
    			<th style="width: 530px;height:25px;">전체합계</th>    			
    			<th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_12_all}" pattern="#,##0.##"/></th>
                <th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_11_all}" pattern="#,##0.##"/></th>
                <th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_10_all}" pattern="#,##0.##"/></th>
                <th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_09_all}" pattern="#,##0.##"/></th>
                <th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_08_all}" pattern="#,##0.##"/></th>
                <th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_07_all}" pattern="#,##0.##"/></th>
                <th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_06_all}" pattern="#,##0.##"/></th>
                <th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_05_all}" pattern="#,##0.##"/></th>
                <th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_04_all}" pattern="#,##0.##"/></th>
                <th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_03_all}" pattern="#,##0.##"/></th>
                <th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_02_all}" pattern="#,##0.##"/></th>
                <th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_01_all}" pattern="#,##0.##"/></th>
				<th style="width: 75px;text-align:right;padding-right:5px;color:blue;"><fmt:formatNumber value="${timeTeamAllTotalSum_col_all}" pattern="#,##0.##"/></th>    			
    		</tr>
    	</table>
    </div>
    <!-- 총합계 끝 -->
