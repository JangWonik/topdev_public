...
<head>
	...
	<script>
		...
		function goMisTmBscPrimMbr(id, nm, type){
			misSearchForm.action = "./getMisTmBscPrimMbr";
		...
		function goMisTmBscPrimMbr2(id, nm, type){
			misSearchForm.action = "./getMisTmBscPrimMbr2";
			misSearchForm.team_id.value = id;
			misSearchForm.team_name.value = nm;
			misSearchForm.team_type.value = type;
	        misSearchForm.submit();
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./getMisTmBscPrim">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<!-- 							</form> -->
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">팀 기본 통계2 (통합매출)</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_tm_bsc_prim1.jsp"></c:import>
						</div>
