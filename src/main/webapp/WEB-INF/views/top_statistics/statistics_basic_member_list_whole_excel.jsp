...
<table cellpadding="0" cellspacing="0" width="1120" align="center" border="1">
    ...
    <c:forEach  var="itemList" items="${teamExcelList}" varStatus="excelStatus">
	    ...
	    <c:set var="sub1_workLoadMonth" value="0"/>
	    <c:set var="sub1_workLoadYear" value="0"/>	    
        ...
        <c:forEach  var="item" items="${itemTeamList}" varStatus="status">
            <tr>
                ...
                <%-- <td class="right"><fmt:formatNumber value="${item.workLoadMonth-item.workLoadLastMonth}" pattern="#,###.###"/>월환산</td> --%>
                ...
                <%-- <td class="right border-right"><fmt:formatNumber value="${item.workLoadYear}" pattern="#,###.###"/>년환산</td> --%>
            ...
            <%-- <c:set var="sub1_workLoadMonth" value="${sub1_workLoadMonth + (item.workLoadMonth - item.workLoadLastMonth)}"/><!-- 표준업무 월환산 합계추가 by top3009 --> --%>
            <c:set var="sub1_workLoadMonth" value="${sub1_workLoadMonth + item.workLoadMonthCal}"/>
            <c:set var="sub1_workLoadYear" value="${sub1_workLoadYear + item.workLoadYear}"/><!-- 표준업무 년환산 합계추가 by top3009 -->
        ...
        <tr>
            ...
            <%-- <th style="text-align: right"><fmt:formatNumber value="${sub1_closeMonthEa}" pattern="#,###.###"/></th> --%>
            <th class="right"><fmt:formatNumber value="${sub1_workLoadMonth}" pattern="#,###.###"/></th>
            <%-- <th style="text-align: right"><fmt:formatNumber value="${sub1_closeShareEa}" pattern="#,###.###"/></th> --%>
        ...
        <c:set var="g_closeMonthEa" value="${g_closeMonthEa + sub1_closeMonthEa}"/>
        <c:set var="g_closeShareEa" value="${g_closeShareEa + sub1_closeShareEa}"/>
    ...
    <tr>
        ...
        <th style="text-align: right"><fmt:formatNumber value="${g_closeMonthEa}" pattern="#,###.###"/></th>
        <th style="text-align: right"><fmt:formatNumber value="${g_closeShareEa}" pattern="#,###.###"/></th>
...
<table cellpadding="0" cellspacing="0" width="1120" align="center" border="1">
    ...
    <c:set var="g_closeMonthEa" value="0"/>
    <c:set var="g_closeShareEa" value="0"/>
    ...
    <c:forEach  var="itemList" items="${personExcelList}" varStatus="excelStatus">
        ...
        <c:forEach  var="item" items="${itemPersonList}" varStatus="status">
            <tr>
                ...
                <%-- <td class="right"><fmt:formatNumber value="${item.closeMonthEa}" pattern="#,###.###"/></td> --%>
                <td class="right"><fmt:formatNumber value="${item.workLoadMonth-item.workLoadLastMonth}" pattern="#,###.###"/></td>
                <%-- <td class="right"><fmt:formatNumber value="${item.closeShareEa}" pattern="#,###.###"/></td> --%>
                <td class="right border-right"><fmt:formatNumber value="${item.workLoadYear}" pattern="#,###.###"/></td>
        ...
        <c:set var="g_closeMonthEa" value="${g_closeMonthEa + sub1_closeMonthEa}"/>
        <c:set var="g_workLoadMonth" value="${g_workLoadMonth + sub1_workLoadMonth}"/>
        <c:set var="g_closeShareEa" value="${g_closeShareEa + sub1_closeShareEa}"/>
        <c:set var="g_workLoadYear" value="${g_workLoadYear + sub1_workLoadYear}"/>
    ...
    <tr>
        ...
        <%-- <th style="text-align: right"><fmt:formatNumber value="${g_closeMonthEa}" pattern="#,###.###"/></th> --%>
        <th style="text-align: right"><fmt:formatNumber value="${g_workLoadMonth}" pattern="#,###.###"/></th>
        <%-- <th style="text-align: right"><fmt:formatNumber value="${g_closeShareEa}" pattern="#,###.###"/></th> --%>
        <th style="text-align: right"><fmt:formatNumber value="${g_workLoadYear}" pattern="#,###.###"/></th>        
