    ...
    <table cellpadding="0" cellspacing="0" width="1060" align="center" <c:if test="${srchArg.excelYN == 'Y'}">border="1"</c:if>>
       ...
       <tr>
        ...
        <tr>
            ...
            <th class="border-right" colspan="2">표준평가환산건수<!-- 평가건수 --></th>
        ...
        <c:set var="sub1_pendingMonthly45Cnt" value="0"/>
        ...
        <c:forEach  var="item" items="${memberList}" varStatus="status">
            <tr>
                ...
                <!-- 기준업무량갯수로 수정 by top3009 -->
                <%-- <td class="right"><fmt:formatNumber value="${item.closeMonthEa}" pattern="#,###.###"/>당월</td> --%>                
                <%-- <td class="right"><fmt:formatNumber value="${item.closeMonthWorkloadEa}" pattern="#,###.###"/></td> --%>
                ...
                <%-- <td class="right border-right"><fmt:formatNumber value="${item.closeShareEa}" pattern="#,###.###"/>공동적용</td> --%>
                <%-- <td class="right border-right"><fmt:formatNumber value="${item.closeShareWorkloadEa}" pattern="#,###.###"/></td> --%>
                ...
                <td class="right border-right"><fmt:formatNumber value="${item.amtTraffic}" pattern="#,###"/></td>
                ...
                <td class="right border-right"><fmt:formatNumber value="${item.shareAmtTraffic}" pattern="#,###"/></td>
            ...
            <c:set var="sub1_workLoadMonth" value="${sub1_workLoadMonth + item.workLoadMonthCal}"/><!-- 표준업무 월환산 합계추가 by top3009 -->
        ...
        <tr>
            ...
            <%-- <th class="right"><fmt:formatNumber value="${sub1_closeMonthWorkloadEa}" pattern="#,###.###"/></th> --%>
            <th class="right"><fmt:formatNumber value="${sub1_workLoadMonth}" pattern="#,###.###"/></th>            
            <%-- <th class="right border-right"><fmt:formatNumber value="${sub1_closeShareEa}" pattern="#,###.###"/></th> --%>
            <%-- <th class="right border-right"><fmt:formatNumber value="${sub1_closeShareWorkloadEa}" pattern="#,###.###"/></th> --%>
