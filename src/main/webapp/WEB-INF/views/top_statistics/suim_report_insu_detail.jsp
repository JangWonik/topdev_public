...
<div class="tableStyle2">
    <div style="background: #e7ecf1;<c:if test='${ReportList.size() > 21}'>padding-right: 17px;</c:if>">
            ...
            <c:forEach var="vo" items="${ReportList}" varStatus="status">
                <tr style="bgcolor: #E7ECF1; text-align: center;" onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
                    <c:if test="${status.index == 0}">
                        ...
                        <a href="javascript:goInsuList();">                        
						${vo.ptnrNick}
                        </a>
                        </td>                        
                    </c:if>
                    <td><a href="javascript:viewPopup('${vo.suimRptNo}','${vo.delDate}')">${vo.accidentNo}</a></td>
                    <td><a href="javascript:viewPopup('${vo.suimRptNo}','${vo.delDate}')">${vo.suimAcceptNo}</a></td>
                    <td><a href="javascript:viewPopup('${vo.suimRptNo}','${vo.delDate}')">${vo.policyNo }</a></td>
