                    ...
                    <div class="centercnt_top">
                        <div class="nociteA log_top">
                            <div class="search_bar">
                                ...
                                <form id="srchFrm" name="srchFrm" method="post" action="./statistics_basic_member_list">
                                    ...
                                    <select id="srchUserNo" name="user_no" onchange="fnSearch();" style="width:150px;">
                                        <c:forEach var="item" items="${memberList}" varStatus="status">
                                            <option value="${item.userNo}" <c:if test="${item.userNo == srchArg.user_no}">selected="selected"</c:if>>${item.userName}</option>
                                        </c:forEach>
                                    </select>&nbsp;&nbsp;&nbsp;
