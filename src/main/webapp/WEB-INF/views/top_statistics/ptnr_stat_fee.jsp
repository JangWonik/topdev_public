...
<head>
	...
	<script>
		...
		function goPtnrStatCenter( p_ptnrId ){		
			...
			srchFrm.action = "ptnrStatCenterFee";			//보험사 센터별 실적현황(수임건수)
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatFee">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="순수피(Fee)" class="buttonDiaAll"  style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatFee');" type="button" value="순수피(Fee)">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_fee_tb.jsp"></c:import>							
						</div>
