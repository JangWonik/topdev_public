...
<head>
	...
	<script>
		...
		function goMisContractTmMbr(id, nm, type){
			misSearchForm.action = "./getMisContractTmMbr";
			...
			<div class="center_cnt2">
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./getMisContractTm">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">적부(삼성)팀</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_contract_tm1.jsp"></c:import>
						</div>
