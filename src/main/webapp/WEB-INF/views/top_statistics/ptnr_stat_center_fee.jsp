...
<head>
	...
	<script>
		...
		function goPtnrStatTeam( p_ptnrId, p_teamCenter ){			
			...
			srchFrm.action = "ptnrStatTeamFee";
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatCenterFee">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="순수피(Fee)" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatCenterFee');" type="button" value="순수피(Fee)">
						...
						<div id="centerView" class="guestcnt2">
							<c:import url="./ptnr_stat_center_fee_tb.jsp"></c:import>							
						</div>						
						<div id="teamView" class="guestcnt2">
							<c:import url="./ptnr_stat_team_all_fee_tb.jsp"></c:import>							
						</div>
