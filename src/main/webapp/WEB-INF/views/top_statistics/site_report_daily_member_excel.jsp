...
<%
    response.setHeader("Content-Disposition", "attachment; filename=site_member_"+pageContext.getAttribute("today")+".xls");
        ...
        <table border='1'>            
            <c:forEach var="member" items="${memberList}" varStatus="status">            	
                <tr>
                	...
                	<td width="80px">${member.user_name}</td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_30}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_29}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_28}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_27}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_26}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_25}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_24}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_23}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_22}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_21}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_20}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_19}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_18}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_17}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_16}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_15}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_14}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_13}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_12}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_11}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_10}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_9}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_8}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_7}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_6}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_5}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_4}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_3}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_2}" type="number"/></td>
                	<td width="30px"><fmt:formatNumber value="${member.over_per_1}" type="number"/></td>                	
                </tr>
			</c:forEach>    
        </table>
    </div>
