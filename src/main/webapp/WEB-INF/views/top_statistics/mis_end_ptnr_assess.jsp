				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="순수피(Fee)" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goMisEndPtnr('MisEndPtnrAssess');" type="button" value="순수피(Fee)">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_end_ptnr_assess1.jsp"></c:import>
						</div>
