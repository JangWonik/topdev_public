...
<head>
	...
	<script>
		...
		function goMisResultPtnrTm(ptnr_id, ptnr_nick, viewFromDate, viewToDate){
			misSearchForm.action = "./MisResultPtnrTm";
			misSearchForm.ptnr_id.value = ptnr_id;
			misSearchForm.ptnr_nick.value = ptnr_nick;
			misSearchForm.viewFromDate.value = viewFromDate;
			misSearchForm.viewToDate.value = viewToDate;
	        misSearchForm.submit();
		}
		
		function goMisResultPtnrMbr(ptnr_id, ptnr_nick, team_id, team_name, viewFromDate, viewToDate){
			misSearchForm.action = "./MisResultPtnrMbr";
			misSearchForm.ptnr_id.value = ptnr_id;
			misSearchForm.ptnr_nick.value = ptnr_nick;
			misSearchForm.team_id.value = team_id;
			misSearchForm.team_name.value = team_name;
			misSearchForm.viewFromDate.value = viewFromDate;
			misSearchForm.viewToDate.value = viewToDate;
	        misSearchForm.submit();
		}

		function goMisEndPtnrAssess(viewFromDate, viewToDate){
			misSearchForm.action = "./MisEndPtnrAssess";
			misSearchForm.viewFromDate.value = viewFromDate;
			misSearchForm.viewToDate.value = viewToDate;
	        misSearchForm.submit();
		}
		
		function goMisEndPtnrTime(viewFromDate, viewToDate){
			misSearchForm.action = "./MisEndPtnrTime";
			misSearchForm.viewFromDate.value = viewFromDate;
			misSearchForm.viewToDate.value = viewToDate;
	        misSearchForm.submit();
		}
		
		function goMisEndPtnrTraffic(viewFromDate, viewToDate){
			misSearchForm.action = "./MisEndPtnrTraffic";
			misSearchForm.viewFromDate.value = viewFromDate;
			misSearchForm.viewToDate.value = viewToDate;
	        misSearchForm.submit();
		}
		
		function goMisEndPtnrQr(viewFromDate, viewToDate){
			misSearchForm.action = "./MisEndPtnrQr";
			misSearchForm.viewFromDate.value = viewFromDate;
			misSearchForm.viewToDate.value = viewToDate;
	        misSearchForm.submit();
		}
		
		function goMisEndPtnrTotal(viewFromDate, viewToDate){
			misSearchForm.action = "./MisEndPtnrTotal";
			misSearchForm.viewFromDate.value = viewFromDate;
			misSearchForm.viewToDate.value = viewToDate;
	        misSearchForm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./MisResultPtnrTm">
...
<!-- 						<div style="text-align: right;"> -->
<%-- 							<b><a href="javascript:goMisEndPtnr('${inVO.viewFromDate}','${inVO.viewToDate}');">절대건수</a></b>&nbsp;&nbsp;&nbsp; --%>
<%-- 							<b><a href="javascript:goMisEndPtnrAssess('${inVO.viewFromDate}','${inVO.viewToDate}');">순수 피(Fee)</a></b>&nbsp;&nbsp;&nbsp; --%>
<%-- 							<b><a href="javascript:goMisEndPtnrTime('${inVO.viewFromDate}','${inVO.viewToDate}');">일비</a></b>&nbsp;&nbsp;&nbsp; --%>
<%-- 							<b><a href="javascript:goMisEndPtnrTraffic('${inVO.viewFromDate}','${inVO.viewToDate}');">교통비</a></b>&nbsp;&nbsp;&nbsp; --%>
<%-- 							<b><a href="javascript:goMisEndPtnrQr('${inVO.viewFromDate}','${inVO.viewToDate}');">자문료+기타</a></b>&nbsp;&nbsp;&nbsp; --%>
<%-- 							<b><a href="javascript:goMisEndPtnrTotal('${inVO.viewFromDate}','${inVO.viewToDate}');">총합계</a></b>&nbsp;&nbsp;&nbsp; --%>
<!-- 						</div> -->
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">${inVO.ptnr_nick} 팀별 청구내용</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_result_ptnr_tm1.jsp"></c:import>
						</div>
