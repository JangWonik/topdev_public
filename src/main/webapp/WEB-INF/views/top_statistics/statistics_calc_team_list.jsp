                            ...
                            <div class="guestcnt2" id="area_excel" style="display:block;">
                                <div class="tableStyle2">
                                    <table cellpadding="0" cellspacing="0" width="1060" align="center">
                                        ...
                                        <tr>
                                            <th rowspan="3"><span style="color: black;"><b>Type</b></span></th>
                                            <th rowspan="3"><span style="color: black;"><b>팀</b></span></th>
                                            <th colspan="2">수임현황</th>
                                            <th colspan="2">종결현황</th>
                                            <%--<th rowspan="2" colspan="2">처리율</th>--%>
                                            <%--<th colspan="2">미결현황</th>--%>
                                            <th>미결현황</th>
                                            <th colspan="2">종결평가</th>
                                            <th colspan="7"><b>공동수행자의 비율 및 금액을 반영한 결과<span style="color: red">(반영안함!)</span></b></th>
                                            <th rowspan="3">미수금</th>
                                        </tr>
                                        <tr>
                                            ...
                                            <th colspan="7">인보이스 현황<span style="color: red">(당월)</span></th>
                                        </tr>
                                        <tr>
                                            <th>당월</th>
                                            <th>년누계</th>
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td><a href="#noloc" onclick="fnMemberList('72','1');">테스트</a></td>
                                            <td>3</td>
                                            <td>4</td>
                                            <td>5</td>
                                            <%--<td>6</td>--%>
...
<script type='text/javascript'>
    ...
    function _initButton() {
        ...
        $(".monthbtn").click(function(){
            ...
            frm.action = "./statistics_calc_team_list";
            //frm.submit();
        });
