...
<head>
	...
	<script>
		...
		function goPtnrStatMember( p_ptnrId, p_teamId ){
			...
			srchFrm.action = "ptnrStatMemberCntFee";
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatTeamCntFee">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="건당 순수피" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatTeamCntFee');" type="button" value="건당 순수피">
							<input title="일비" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatTeamTime');" type="button" value="일비">
							<input title="건당 일비" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatTeamCntTime');" type="button" value="건당 일비">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_team_cnt_fee_tb.jsp"></c:import>							
						</div>
