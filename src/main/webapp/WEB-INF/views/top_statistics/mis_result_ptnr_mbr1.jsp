...
<!-- 											<th>Type</th> -->
									...
									<tbody>
										<c:forEach var="vo4" items="${MisResultPtnrMbr}" varStatus="status">
...
<%-- 													<td rowspan="${MisResultPtnrMbr.size() + 1}">4종</td> --%>
<%-- 												</c:if> --%>
												<td><a href="javascript:goMisEndPtnrTm('${vo4.ptnr_id}','${vo4.ptnr_nick}','${inVO.viewFromDate}','${inVO.viewToDate}');">${vo4.user_name}</a></td>
												<td>
