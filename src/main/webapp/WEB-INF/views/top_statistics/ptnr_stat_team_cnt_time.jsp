...
<head>
	...
	<script>
		...
		function goPtnrStatMember( p_ptnrId, p_teamId ){
			...
			srchFrm.action = "ptnrStatMemberCntTime";
			srchFrm.submit();
		}
		...
		//function goPtnrStatCenter( p_ptnrId ){			
			//$("#ptnr_id").val(p_ptnrId);
			//srchFrm.action = "ptnrStatCenterMain";			//보험사 센터별 실적현황(수임건수)
			//srchFrm.submit();
		//}
		...
		<div class="contetns2">
			<div class="center_cnt2">
					...
					<div class="nociteA log_top">
						<div class="search_bar">
							<div style="float: left;">
								...
								&nbsp;<b>${ptnrName} ${centerName} 팀 별 실적현황</b>
                           	</div>
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatTeamCntTime">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							<input title="수임건수" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatTeamMain');" type="button" value="수임건수">
							<input title="종결건수" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatTeamEnd');" type="button" value="종결건수">
							<input title="순수피(Fee)" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatTeamFee');" type="button" value="순수피(Fee)">
							<input title="건당 순수피" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatTeamCntFee');" type="button" value="건당 순수피">
							<input title="일비" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatTeamTime');" type="button" value="일비">
							<input title="건당 일비" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatTeamCntTime');" type="button" value="건당 일비">
							<input title="교통비" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatTeamTraffic');" type="button" value="교통비">
							<input title="자문료+기타" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatTeamEtc');" type="button" value="자문료+기타">													
							<input title="총 합계" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatTeamEntire');" type="button" value="총 합계">							
						</div>
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">${ptnrName} ${centerName}</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_team_cnt_time_tb.jsp"></c:import>							
						</div>
...
<!-- //wrapper -->
	...
	<script type='text/javascript'>
	    ...
	    function fnSearch(){
	        ...
	        frm.action = "./ptnrStatTeamCntTime";
	        frm.submit();
	    }
