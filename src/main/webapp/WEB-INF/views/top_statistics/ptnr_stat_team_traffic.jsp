				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatTeamTraffic">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="교통비" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatTeamTraffic');" type="button" value="교통비">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_team_traffic_tb.jsp"></c:import>							
						</div>
...
<!-- //wrapper -->
	...
	<script type='text/javascript'>
	    ...
	    function fnSearch(){
	        ...
	        frm.action = "./ptnrStatTeamTraffic";
	        frm.submit();
	    }
