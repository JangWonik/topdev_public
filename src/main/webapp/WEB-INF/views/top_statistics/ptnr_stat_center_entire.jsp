...
<head>
	...
	<script>
		...
		function goPtnrStatTeam( p_ptnrId, p_teamCenter ){
			...
			srchFrm.action = "ptnrStatTeamEntire";
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatCenterEntire">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="총 합계" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatCenterEntire');" type="button" value="총 합계">							
						</div>
						<div class="guestTap">
							<ul>
						...
						<div id="centerView" class="guestcnt2">
							<c:import url="./ptnr_stat_center_entire_tb.jsp"></c:import>							
						</div>						
						<div id="teamView" class="guestcnt2">
							<c:import url="./ptnr_stat_team_all_entire_tb.jsp"></c:import>							
						</div>
					</div><!-- //guest -->
				</div><!-- centercnt_bot2 -->
...
<!-- //wrapper -->
	...
	<script type='text/javascript'>
	    ...
	    function fnSearch(){
	        ...
	        frm.action = "./ptnrStatCenterEntire";
	        frm.submit();
	    }
