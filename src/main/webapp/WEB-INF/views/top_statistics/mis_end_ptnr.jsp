		...
		<div class="contetns2">
			<div class="center_cnt2">
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./MisEndPtnr">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							<input title="절대건수" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goMisEndPtnr('MisEndPtnr');" type="button" value="절대건수">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_end_ptnr1.jsp"></c:import>
						</div>
