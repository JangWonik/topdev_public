...
<%
    ...
    response.setHeader("Content-Disposition", "attachment; filename=statistics_member_"+pageContext.getAttribute("today")+".xls");
...
<body>
<h1>${teamVo.team_name} 개인기준 개인별 통계</h1>
...
<table cellpadding="0" cellspacing="0" width="1060" align="center" <c:if test="${srchArg.excelYN == 'Y'}">border="1"</c:if>>
    ...
    <tr>
        ...
        <th rowspan="2">당월</th>
        <th rowspan="2"><!-- 공동적용 -->년누계</th>
        
        <th colspan="3" style="background: YELLO;"> 공동수행 반영 전 </th>
        <th colspan="3" style="background: YELLO;"> 공동수행 </th>
        <th colspan="5" style="background: YELLO;"> 공동수행 반영 후 </th>
    ...
    <c:forEach  var="item" items="${memberPersonStandardList}" varStatus="status">
        <tr>
            ...
            <%-- <td class="right"><fmt:formatNumber value="${item.closeShareEa}" pattern="#,###.###"/></td> --%>
            <td class="right border-right"><fmt:formatNumber value="${item.workLoadYear}" pattern="#,###.###"/></td>            
            ...
            <td class="right"><fmt:formatNumber value="${item.amtTraffic}" pattern="#,###"/></td><!-- 교통비(공동수행 미반영) -->
            ...
            <td class="right"><fmt:formatNumber value="${item.shareAmtTraffic}" pattern="#,###"/></td><!-- 공동수행 교통비 -->
            ...
            <td class="right"><fmt:formatNumber value="${item.amtTraffic + item.shareAmtTraffic}" pattern="#,###"/></td><!-- 교통비(공동수행 반영)-->                
        ...
        <c:set var="sub1_pendingPeriodCnt" value="0"/><!-- 기간 미결 카운트 -->
        ...
        <c:set var="sub1_workLoadYear" value="${sub1_workLoadYear + item.workLoadYear}"/>
        <c:set var="sub1_workLoadMonth" value="${sub1_workLoadMonth + item.workLoadMonthCal}"/>
    ...
    <tr>
        ...
        <th class="right"><fmt:formatNumber value="${sub1_receiveYearCnt}" pattern="#,###"/></th>
        <th class="right"><fmt:formatNumber value="${sub1_closeMonthCnt}" pattern="#,###"/></th>
        <th class="right"><fmt:formatNumber value="${sub1_closeYearCnt}" pattern="#,###"/></th>
        <th class="right">
        ...
        <th class="right"><fmt:formatNumber value="${sub1_workLoadMonth}" pattern="#,###.###"/></th>
        <%-- <th class="right"><fmt:formatNumber value="${sub1_closeShareEa}" pattern="#,###.###"/></th> --%>
        <th class="right border-right"><fmt:formatNumber value="${sub1_workLoadYear}" pattern="#,###.###"/></th>
        ...
        <th class="right"><fmt:formatNumber value="${sub1_shareAmtTraffic}" pattern="#,###"/></th>
        ...
        <th class="right"><fmt:formatNumber value="${sub1_shareSumAmtTraffic}" pattern="#,###"/></th>
...
<h1>${teamVo.team_name} 팀기준 개인별 통계</h1>
<table cellpadding="0" cellspacing="0" width="1060" align="center" <c:if test="${srchArg.excelYN == 'Y'}">border="1"</c:if>>
    <colgroup>
        <col width="60">
    ...
    <c:forEach  var="item" items="${memberList}" varStatus="status">
        <tr>
            ...
            <td class="right">
                <c:set var="shareSumAmtTotal" value="${subTotal + item.amtTraffic + item.shareAmtTraffic + item.amtCounsel + item.amtEtc}"/>
                <fmt:formatNumber value="${shareSumAmtTotal}" pattern="#,###"/>
            </td>
        ...
        <c:set var="sub2_workLoadMonth" value="${sub2_workLoadMonth + item.workLoadMonthCal}"/>
        <c:set var="sub2_workLoadYear" value="${sub2_workLoadYear + item.workLoadYear}"/>        
        ...
        <c:set var="sub1_amtCounsel" value="${sub1_amtCounsel + item.amtCounsel}"/>
        <c:set var="sub1_amtEtc" value="${sub1_amtEtc + item.amtEtc}"/>
        <c:set var="sub1_shareSumAmtTotal" value="${sub1_shareSumAmtTotal + shareSumAmtTotal}"/>
    ...
    <tr>
        ...
        <%-- <th class="right"><fmt:formatNumber value="${sub1_closeMonthEa}" pattern="#,###.###"/></th> --%>
        <th class="right"><fmt:formatNumber value="${sub2_workLoadMonth}" pattern="#,###.###"/></th>
        <%-- <th class="right"><fmt:formatNumber value="${sub1_closeShareEa}" pattern="#,###.###"/></th> --%>
        <th class="right border-right"><fmt:formatNumber value="${sub2_workLoadYear}" pattern="#,###.###"/></th>
