...
<head>
	...
	<script>
		...
		function goPtnrStatTeam( p_ptnrId, p_teamCenter ){	
			...
			srchFrm.action = "ptnrStatTeamEnd";
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatCenterEnd">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="종결건수" class="buttonDiaAll"style=" background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatCenterEnd');" type="button" value="종결건수">
							...
							<input title="교통비" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatCenterTraffic');" type="button" value="교통비">
						...
						<div class="guestTap">
							<ul>
								<li id="centerTab" onclick="javascript:clickTab('center');"><a href="#">${ptnrName} 센터별 실적현황</a></li>
								<li id="teamTab" onclick="javascript:clickTab('team');"><a href="#">${ptnrName} 팀별 실적현황</a></li>
								<%-- <li id="memberTab" onclick="javascript:clickTab('member');"><a href="#">${ptnrName} 개인별 실적현황</a></li> --%>
							</ul>
						</div>
						
						<div id="centerView" class="guestcnt2">
							<c:import url="./ptnr_stat_center_end_tb.jsp"></c:import>							
						</div>						
						<div id="teamView" class="guestcnt2">
							<c:import url="./ptnr_stat_team_all_end_tb.jsp"></c:import>							
						</div>
						<%-- <div id="memberView" class="guestcnt2">
							<c:import url="./ptnr_stat_member_all_end_tb.jsp"></c:import>							
						</div> --%>
					</div><!-- //guest -->
				</div><!-- centercnt_bot2 -->
