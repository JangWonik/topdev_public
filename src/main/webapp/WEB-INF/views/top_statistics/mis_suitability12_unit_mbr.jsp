...
<head>
	...
	<script>
		...
		function goMisTmBscMbr2NeedToEdit(id, nm){
			misSearchForm.action = "./getMisTmBscMbr2NeedToEdit";
			misSearchForm.user_no.value = id;
			misSearchForm.user_name.value = nm;
	        misSearchForm.submit();
		}
		
		function goMisSuitability12TmMbr2(id, nm, type, user_no, user_name){
			misSearchForm.action = "./getMisSuitability12TmMbr2";
			misSearchForm.team_id.value = id;
			misSearchForm.team_name.value = nm;
			misSearchForm.team_type.value = type;
			misSearchForm.user_no.value = user_no;
			misSearchForm.user_name.value = user_name;
	        misSearchForm.submit();
		}
	</script>
			...
			<div class="center_cnt2">
					...
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<div style="float: left;">
								...
								&nbsp;<b>${inVO.team_name} 개인별 적부심사 (한화) 통계</b>
							</div>
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./getMisSuitability12UnitMbr">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">${inVO.team_name} 개인별 한화 적부 통계</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_suitability12_unit_mbr1.jsp"></c:import>
						</div>
