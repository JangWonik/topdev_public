				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./MisEndPtnrTime">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="일비" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goMisEndPtnr('MisEndPtnrTime');" type="button" value="일비">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_end_ptnr_time1.jsp"></c:import>
						</div>
