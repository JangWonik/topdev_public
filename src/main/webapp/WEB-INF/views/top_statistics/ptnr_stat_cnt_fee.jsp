...
<head>
	...
	<script>
		...
		function goPtnrStatCenter( p_ptnrId ){		
			...
			srchFrm.action = "ptnrStatCenterCntFee";			//보험사 센터별 실적현황(수임건수)
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatCntFee">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="건당 순수피" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatCntFee');" type="button" value="건당 순수피">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_cnt_fee_tb.jsp"></c:import>							
						</div>
