...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./resources/wm_css/style.css?v=20170315151920" />
                ...
                <div class="center_cnt2">
                        ...
                        <div class="nociteA log_top">
                            <div class="search_bar">
                                <div style="float: left;">
                                    <img src="./resources/ls_img/dotte.gif" width="12" height="12" border="0" align="absmiddle">&nbsp; 팀별 업무처리현황
                                </div>
                                <br/><br/>
                                <form id="srchFrm" name="srchFrm" method="post" action="./statistics_work_team_list">
                    ...
                    <div class="centercnt_bot2" style="margin:0 auto;">
                        <div class="guest">
                            <div class="guestTap">
                                <ul>
                                    <li class="on"><a>${fn:substring(srchArg.stdBgnde,5,7)}월 팀별 처리내용</a></li>
                                </ul>
                            </div>
                                ...
                                <div class="tableStyle2">
                                    <div style="padding-right: 17px; background: #e7ecf1;">
                                        <table cellpadding="0" cellspacing="0" width="1060" align="center">
                                            ...
                                            <tr>
                                                <th rowspan="2"><span style="color: black;"><b>Type</b></span></th>
                                                <th class="border-right" rowspan="2"><span style="color: black;"><b>팀</b></span></th>
                                                <th rowspan="2">인원</th>
                                                <th rowspan="2">접수</th>
                                                <th class="border-right" rowspan="2">종결</th>
                                                <th class="border-right" colspan="17">진행</th>
                                                <th colspan="2"><span style="color: black;"><b>합계</b></span></th>
                                            </tr>
                                            <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="1060" align="center">
                                            ...
                                            <c:forEach  var="item" items="${workTeamList1}" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td class="left border-right"><a href="#noloc" onclick="fnMemberList('${item.teamId}','1');">${item.teamName}</a></td>
                                                ...
                                                <%--<c:set var="subDayAvrTime1" value="${subDayAvrTime1 + item.dayAvrTime}"/>--%>
                                            ...
                                            <tr bgcolor="#EFEFEF">
                                                ...
                                                <td class="border-right" colspan="2">소계</td>
                                            ...
                                            <c:forEach  var="item" items="${workTeamList4}" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td class="left border-right"><a href="#noloc" onclick="fnMemberList('${item.teamId}','4');">${item.teamName}</a></td>
                                                    <td class="right"><fmt:formatNumber value="${item.userCnt}" pattern="#,###"/></td>
                                                    <td class="right"><fmt:formatNumber value="${item.receiveCnt}" pattern="#,###"/></td>
                                                    <td class="right border-right"><fmt:formatNumber value="${item.closeCnt}" pattern="#,###"/></td>
                                                    <td class="right"><fmt:formatNumber value="${item.day10PrevCnt}" pattern="#,###"/></td>
                                            ...
                                            <tr bgcolor="#EFEFEF">
                                                ...
                                                <td class="right border-right"><fmt:formatNumber value="${subCloseCnt4}" pattern="#,###"/></td>
                                                <td class="right"><fmt:formatNumber value="${subDay10PrevCnt4}" pattern="#,###"/></td>
                                                <td class="right border-right"><fmt:formatNumber value="${subTotalCnt4 == 0 ? 0.0 : subDay10PrevCnt4 / subTotalCnt4 * 100}" pattern="#,##0.0"/>%</td>
                                                <td class="right"><fmt:formatNumber value="${subDay10NextCnt4}" pattern="#,###"/></td>
                                                <td class="right border-right"><fmt:formatNumber value="${subTotalCnt4 == 0 ? 0.0 : subDay10NextCnt4 / subTotalCnt4 * 100}" pattern="#,##0.0"/>%</td>
                                                <td class="right"><fmt:formatNumber value="${subDay20NextCnt4}" pattern="#,###"/></td>
                                                <td class="right border-right"><fmt:formatNumber value="${subTotalCnt4 == 0 ? 0.0 : subDay20NextCnt4 / subTotalCnt4 * 100}" pattern="#,##0.0"/>%</td>
                                                <td class="right"><fmt:formatNumber value="${subDay30NextCnt4}" pattern="#,###"/></td>
                                                <td class="right border-right"><fmt:formatNumber value="${subTotalCnt4 == 0 ? 0.0 : subDay30NextCnt4 / subTotalCnt4 * 100}" pattern="#,##0.0"/>%</td>
                                                <td class="right"><fmt:formatNumber value="${subDay60NextCnt4}" pattern="#,###"/></td>
                                                <td class="right border-right"><fmt:formatNumber value="${subTotalCnt4 == 0 ? 0.0 : subDay60NextCnt4 / subTotalCnt4 * 100}" pattern="#,##0.0"/>%</td>
                                                <td class="right"><fmt:formatNumber value="${subDay90NextCnt4}" pattern="#,###"/></td>
                                                <td class="right border-right"><fmt:formatNumber value="${subTotalCnt4 == 0 ? 0.0 : subDay90NextCnt4 / subTotalCnt4 * 100}" pattern="#,##0.0"/>%</td>
                                                <td class="right"><fmt:formatNumber value="${subDay120NextCnt4}" pattern="#,###"/></td>
                                                <td class="right border-right"><fmt:formatNumber value="${subTotalCnt4 == 0 ? 0.0 : subDay120NextCnt4 / subTotalCnt4 * 100}" pattern="#,##0.0"/>%</td>
                                                <td class="right"><fmt:formatNumber value="${subTotalCnt4}" pattern="#,###"/></td>
                                                <td class="right border-right"><fmt:formatNumber value="${subTotalCnt4 == 0 ? 0.0 : subTotalCnt4 / subTotalCnt4 * 100}" pattern="#,###"/>%</td>
                                                <td class="right border-right">
                                            ...
                                            <tr bgcolor="#F8F8F8">
                                                <td class="border-right" colspan="2">합계</td>
                                                ...
                                                <td class="right border-right"><span style="color: red"><fmt:formatNumber value="${subCloseCnt1 + subCloseCnt4}" pattern="#,###"/></span></td>
                                                <td class="right"><span style="color: red"><fmt:formatNumber value="${subDay10PrevCnt1 + subDay10PrevCnt4}" pattern="#,###"/></td>
                                                <td class="right border-right"><span style="color: red"><fmt:formatNumber value="${GlobalTotalCnt == 0 ? 0.0 : (subDay10PrevCnt1 + subDay10PrevCnt4) / GlobalTotalCnt * 100}" pattern="#,##0.0"/>%</span></td>
                                                <td class="right"><span style="color: red"><fmt:formatNumber value="${subDay10NextCnt1 + subDay10NextCnt4}" pattern="#,###"/></span></td>
                                                <td class="right border-right"><span style="color: red"><fmt:formatNumber value="${GlobalTotalCnt == 0 ? 0.0 : (subDay10NextCnt1 + subDay10NextCnt4) / GlobalTotalCnt * 100}" pattern="#,##0.0"/>%</span></td>
                                                <td class="right"><span style="color: red"><fmt:formatNumber value="${subDay20NextCnt1 + subDay20NextCnt4}" pattern="#,###"/></span></td>
                                                <td class="right border-right"><span style="color: red"><fmt:formatNumber value="${GlobalTotalCnt == 0 ? 0.0 : (subDay20NextCnt1 + subDay20NextCnt4) / GlobalTotalCnt * 100}" pattern="#,##0.0"/>%</span></td>
                                                <td class="right"><span style="color: red"><fmt:formatNumber value="${subDay30NextCnt1 + subDay30NextCnt4}" pattern="#,###"/></span></td>
                                                <td class="right border-right"><span style="color: red"><fmt:formatNumber value="${GlobalTotalCnt == 0 ? 0.0 : (subDay30NextCnt1 + subDay30NextCnt4) / GlobalTotalCnt * 100}" pattern="#,##0.0"/>%</span></td>
                                                <td class="right"><span style="color: red"><fmt:formatNumber value="${subDay60NextCnt1 + subDay60NextCnt4}" pattern="#,###"/></span></td>
                                                <td class="right border-right"><span style="color: red"><fmt:formatNumber value="${GlobalTotalCnt == 0 ? 0.0 : (subDay60NextCnt1 + subDay60NextCnt4) / GlobalTotalCnt * 100}" pattern="#,##0.0"/>%</span></td>
                                                <td class="right"><span style="color: red"><fmt:formatNumber value="${subDay90NextCnt1 + subDay90NextCnt4}" pattern="#,###"/></span></td>
                                                <td class="right border-right"><span style="color: red"><fmt:formatNumber value="${GlobalTotalCnt == 0 ? 0.0 : (subDay90NextCnt1 + subDay90NextCnt4) / GlobalTotalCnt * 100}" pattern="#,##0.0"/>%</span></td>
                                                <td class="right"><span style="color: red"><fmt:formatNumber value="${subDay120NextCnt1 + subDay120NextCnt4}" pattern="#,###"/></span></td>
                                                <td class="right border-right"><span style="color: red"><fmt:formatNumber value="${GlobalTotalCnt == 0 ? 0.0 : (subDay120NextCnt1 + subDay120NextCnt4) / GlobalTotalCnt * 100}" pattern="#,##0.0"/>%</span></td>
                                                <td class="right"><span style="color: red"><fmt:formatNumber value="${GlobalTotalCnt}" pattern="#,###"/></span></td>
                                                <td class="right border-right"><span style="color: red"><fmt:formatNumber value="${GlobalTotalCnt == 0 ? 0.0 : GlobalTotalCnt / GlobalTotalCnt * 100}" pattern="#,###.#"/>%</span></td>
                                                <td class="right border-right">
...
<script type='text/javascript'>
    ...
    function fnMemberList(teamId, teamType){
        ...
        var frm = document.getElementById("srchFrm");
        frm.action = "./statistics_work_member_list";
        frm.submit();
    }
