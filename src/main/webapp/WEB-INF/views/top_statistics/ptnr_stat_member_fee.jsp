				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatMemberFee">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="순수피(Fee)" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatMemberFee');" type="button" value="순수피(Fee)">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_member_fee_tb.jsp"></c:import>							
						</div>
