...
<head>
	...
	<script>
		...
		function goMisSuitabilityTmMbr(id, nm, type){
			misSearchForm.action = "./getMisSuitabilityTmMbr";
			...
			<div class="center_cnt2">
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./getMisSuitabilityTm">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">적부(KB)팀</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_suitability_tm1.jsp"></c:import>
						</div>
