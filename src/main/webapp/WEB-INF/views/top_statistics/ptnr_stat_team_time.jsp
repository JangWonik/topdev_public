...
<head>
	...
	<script>
		...
		function goPtnrStatMember( p_ptnrId, p_teamId ){
			...
			srchFrm.action = "ptnrStatMemberTime";
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatTeamTime">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="일비" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatTeamTime');" type="button" value="일비">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_team_time_tb.jsp"></c:import>							
						</div>
