...
<head>
	...
	<script>
		...
		function goMisTmBscMbr(id, nm, type){
			misSearchForm.action = "./getMisTmBscMbr";
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./getMisTmBsc">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<%-- 											<c:if test="${inVO.primContractYN == 'Y'}">checked</c:if> /> 적부</b>&nbsp;&nbsp; --%>
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">1종 + 4종</a></li>
								<li><a href="#">1종</a></li>
								<li><a href="#">4종</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_tm_bsc1.jsp"></c:import>
						</div>
						<div class="guestcnt2" style="display:none;">
							<c:import url="./mis_tm_bsc2.jsp"></c:import>
						</div>
						<div class="guestcnt2" style="display:none;">
							<c:import url="./mis_tm_bsc3.jsp"></c:import>
						</div>
