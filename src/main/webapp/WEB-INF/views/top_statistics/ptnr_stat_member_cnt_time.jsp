		...
		<div class="contetns2">
			<div class="center_cnt2">
					...
					<div class="nociteA log_top">
						<div class="search_bar">
							<div style="float: left;">
								...
								&nbsp;<b>${ptnrName} ${teamName} 직원 별 실적현황</b>
                           	</div>
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatMemberCntTime">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							<input title="수임건수" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatMemberMain');" type="button" value="수임건수">
							<input title="종결건수" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatMemberEnd');" type="button" value="종결건수">
							<input title="순수피(Fee)" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatMemberFee');" type="button" value="순수피(Fee)">
							<input title="건당 순수피" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatMemberCntFee');" type="button" value="건당 순수피">
							<input title="일비" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatMemberTime');" type="button" value="일비">
							<input title="건당 일비" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatMemberCntTime');" type="button" value="건당 일비">
							<input title="교통비" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatMemberTraffic');" type="button" value="교통비">
							<input title="자문료+기타" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatMemberEtc');" type="button" value="자문료+기타">
							<input title="총 합계" class="buttonDiaAll" onclick="goPtnrStatMenu('ptnrStatMemberEntire');" type="button" value="총 합계">							
						</div>
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">${ptnrName} ${teamName}</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_member_cnt_time_tb.jsp"></c:import>							
						</div>
...
<!-- //wrapper -->
	...
	<script type='text/javascript'>
	    ...
	    function fnSearch(){
	        ...
	        frm.action = "./ptnrStatMemberCntTime";
	        frm.submit();
	    }
