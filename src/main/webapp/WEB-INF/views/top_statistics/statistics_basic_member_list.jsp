                    ...
                    <div class="centercnt_bot2" style="margin:0 auto;">
                        <div class="guest">
                            ...
                            <div class="guestcnt2" style="display:block;">
                                <c:import url="./statistics_basic_member_list_02.jsp"></c:import>
                            </div>
                            <div class="guestcnt2" style="display:none;">
                                <c:import url="./statistics_basic_member_list_01.jsp"></c:import>
                            </div>
                        </div>
                    </div>
...
//        $("#excelFrm").submit();
    ...
    function fnWholeExcel(){
        var frm = document.getElementById("srchFrm");
        $("#retireUser").val('N');
        frm.action = "./statistics_basic_member_list_whole_excel";
        frm.submit();
    }
