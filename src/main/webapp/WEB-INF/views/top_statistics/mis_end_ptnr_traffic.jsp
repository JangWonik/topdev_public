		...
		<div class="contetns2">
			<div class="center_cnt2">
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./MisEndPtnrTraffic">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							<input title="절대건수" class="buttonDiaAll" onclick="goMisEndPtnr('MisEndPtnr');" type="button" value="절대건수">
							<input title="순수피(Fee)" class="buttonDiaAll" onclick="goMisEndPtnr('MisEndPtnrAssess');" type="button" value="순수피(Fee)">
							<input title="일비" class="buttonDiaAll" onclick="goMisEndPtnr('MisEndPtnrTime');" type="button" value="일비">
							<input title="교통비" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goMisEndPtnr('MisEndPtnrTraffic');" type="button" value="교통비">
							<input title="자문료+기타" class="buttonDiaAll" onclick="goMisEndPtnr('MisEndPtnrQr');" type="button" value="자문료+기타">
							<input title="총 합계" class="buttonDiaAll" onclick="goMisEndPtnr('MisEndPtnrTotal');" type="button" value="총 합계">							
						</div>
						<div class="guestTap">
							<ul>
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_end_ptnr_traffic1.jsp"></c:import>
						</div>
