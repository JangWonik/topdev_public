...
<head>
	...
	<script>
		...
		function goMisResultPtnrMbr(ptnr_id, ptnr_nick, viewFromDate, viewToDate){
					...
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<div style="float: left;">
								...
								&nbsp;<b>${inVO.ptnr_nick} ${inVO.team_name} 청구내용</b>
							</div>
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./MisResultPtnrMbr">
...
<!-- 						</div> -->
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">${inVO.team_name} 청구내용</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_result_ptnr_mbr1.jsp"></c:import>
						</div>
