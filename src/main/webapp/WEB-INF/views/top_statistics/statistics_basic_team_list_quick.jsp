                    ...
                    <div class="centercnt_bot2" style="margin:0 auto;">
                        <div class="guest">
                            ...
                            <div class="guestcnt2" style="display:block;">
                            	<c:if test="${tabType eq '1' || tabType eq ''}">
                            	<c:import url="./statistics_basic_team_list_02_quick.jsp"></c:import>
                            	</c:if>
                            	<c:if test="${tabType eq '4'}">                                                            
                                <c:import url="./statistics_basic_team_list_03_quick.jsp"></c:import>
                                </c:if>
                                <c:if test="${tabType eq '5'}">                            
                                <c:import url="./statistics_basic_team_list_01_quick.jsp"></c:import>
                                </c:if>
                            </div>
                        </div>
                    </div>
...
<script type='text/javascript'>
    ...
    function fnSearch(){
        ...
        frm.action = "./statistics_basic_team_list_quick";
