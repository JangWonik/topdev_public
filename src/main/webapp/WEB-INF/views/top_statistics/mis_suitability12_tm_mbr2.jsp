				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./getMisSuitability12TmMbr2">
...
<!-- 								<input type="hidden" id="user_name" name="user_name" /> -->
								...
								<input type="hidden" name="user_name" id="user_name" value="${inVO.user_name}" />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_suitability12_tm_mbr3.jsp"></c:import>
						</div>
