					...
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<div style="float: left;">
								...
								&nbsp;<b>${inVO.team_name} 개인별 일일 배당 현황</b>
...
<%-- 								<input type="hidden" id="team_id" name="team_id" value="${inVO.team_id}" /> --%>
								...
								<input type="hidden" id="team_written" name="team_written" value="${inVO.team_written}" />
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">${inVO.team_name} 개인별 일일 배당</a></li>
								<!-- <li><a href="#">전체 개인별 일일 배당</a></li> -->
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_allot_tm_mbr1.jsp"></c:import>
						</div>
