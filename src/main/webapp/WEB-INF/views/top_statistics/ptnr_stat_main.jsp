		...
		<div class="contetns2">
			<div class="center_cnt2">
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatMain">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							<input title="수임건수" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatMain');" type="button" value="수임건수">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_suim.jsp"></c:import>							
						</div>
