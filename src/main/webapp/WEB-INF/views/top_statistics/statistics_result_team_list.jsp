                    ...
                    <div class="centercnt_top">
                        <div class="nociteA log_top">
                            <div class="search_bar">
                                ...
                                <form id="srchFrm" name="srchFrm" method="post" action="./statistics_result_team_list">
                                ...
                                <div class="tableStyle2">
                                    <div style="padding-right: 20px; background: #e7ecf1;">
                                        <table cellpadding="0" cellspacing="0" width="1060" align="center">
                                            <tr>
                                                <th><span style="color: black;"><b>Type</b></span></th>
                                    ...
                                    <div style="height:618px; overflow-x: hidden; overflow-y: auto;">
                                        <table cellpadding="0" cellspacing="0" width="1060" align="center">
                                            <colgroup>
                                                <col width="50">
                                                <col width="150">
                                            ...
                                            <c:set var="listCnt" value="${teamList.size()}"/>
                                            <c:forEach  var="item" items="${teamList}" varStatus="status">
                                                <tr>
                                                    <c:if test="${status.index == 0}">
                                                        <td rowspan="${listCnt}" bgcolor="#F8F8F8">4종</td>
                                                    </c:if>
...
<script type='text/javascript'>
    ...
    function _initButton() {
        ...
        $(".monthbtn").click(function(){
            ...
            frm.action = "./statistics_result_team_list";
            frm.submit();
        });
