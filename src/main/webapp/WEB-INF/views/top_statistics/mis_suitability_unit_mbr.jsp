...
<head>
	...
	<script>
		...
		function goMisSuitabilityTmMbr2(id, nm, type, user_no, user_name){
			misSearchForm.action = "./getMisSuitabilityTmMbr2";
			...
			<div class="center_cnt2">
					...
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<div style="float: left;">
								...
								&nbsp;<b>${inVO.team_name} 개인별 적부심사 (KB) 통계</b>
							</div>
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./getMisSuitabilityUnitMbr">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">${inVO.team_name} 개인별 KB 적부 통계</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_suitability_unit_mbr1.jsp"></c:import>
						</div>
