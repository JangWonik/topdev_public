...
<head>
	...
	<script>
		...
		*/
		function goMisRegPtnrTmMbr(teamId, teamType, ptnrId, ptnrNick){
			srchFrm.action = "./MisRegPtnrTmMbr";
			srchFrm.team_id.value = teamId;
			srchFrm.team_type.value = teamType;
			srchFrm.ptnr_id.value = ptnrId;
			srchFrm.ptnr_nick.value = ptnrNick;
			srchFrm.submit();
		}
			...
			<div class="center_cnt2">
					...
					<div class="nociteA log_top">
						<div class="search_bar">
							<div style="float: left;">
								...
								&nbsp;<b>${srchArg.ptnr_nick} 보험사별 수임 현황</b>
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./MisRegPtnrTm">
								...
								<input type="hidden" id="viewToDate" name="viewToDate" value="${srchArg.stdEndde}" />
                               	...
                               	<input type="hidden" id="team_type" name="team_type" value="" />	
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">팀별 수임 현황</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_reg_ptnr_tm1.jsp"></c:import>
						</div>
