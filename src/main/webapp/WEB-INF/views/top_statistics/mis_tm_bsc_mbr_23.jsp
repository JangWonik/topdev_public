...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
							...
							<div class="tableStyle2">
								<table cellpadding="0" cellspacing="0" summary="개인 기본통계">
									...
									<c:forEach var="vo" items="${getMisTmBscMbr2PrimContract1}" varStatus="status">
						                <tr style="bgcolor: #E7ECF1; text-align: center;" onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
											...
											<td><a href="javascript:popSuimDtlPrim('${vo.getRid()}')"><c:out value="${vo.getReport_id()}" /></a></td>
									...
									<c:forEach var="vo" items="${getMisTmBscMbr2PrimContract2}" varStatus="status">
						                <tr style="bgcolor: #E7ECF1; text-align: center;" onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
							...
							<div class="tableStyle2">
								<table cellpadding="0" cellspacing="0" width="990" bordercolordark="white" bordercolorlight="#CCCCCC" align="center">
	                                ...
	                                <tbody>
		                                <c:forEach var="vo" items="${getMisTmBscMbr2MiPrimContract}" varStatus="status">
		                                <tr style="bgcolor: #E7ECF1; text-align: center;" onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
