		...
		<div class="contetns2">
			<div class="center_cnt2">
					...
					<div class="nociteA log_top">
						<div class="search_bar">
							<div style="float: left;">
								...
								&nbsp;<b>${MisEndPtnrTmTraffic1.get(0).ptnr_nick} 팀기준 보험사별 종결 현황</b>
                           	</div>
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							<b><a href="#noloc" onclick="goMisEndPtnrTm('${srchArg.ptnr_id}','MisEndPtnrTm');">절대건수</a></b>&nbsp;&nbsp;&nbsp;
							<b><a href="#noloc" onclick="goMisEndPtnrTm('${srchArg.ptnr_id}','MisEndPtnrTmAssess');">순수 피(Fee)</a></b>&nbsp;&nbsp;&nbsp;
							<b><a href="#noloc" onclick="goMisEndPtnrTm('${srchArg.ptnr_id}','MisEndPtnrTmTime');">일비</a></b>&nbsp;&nbsp;&nbsp;
							<b><a href="#noloc" onclick="goMisEndPtnrTm('${srchArg.ptnr_id}','MisEndPtnrTmTraffic');">교통비</a></b>&nbsp;&nbsp;&nbsp;
							<b><a href="#noloc" onclick="goMisEndPtnrTm('${srchArg.ptnr_id}','MisEndPtnrTmQr');">자문료+기타</a></b>&nbsp;&nbsp;&nbsp;
							<b><a href="#noloc" onclick="goMisEndPtnrTm('${srchArg.ptnr_id}','MisEndPtnrTmTotal');">총합계</a></b>&nbsp;&nbsp;&nbsp;
						</div>
						<div class="guestTap">
							<ul>
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_end_ptnr_tm_traffic1.jsp"></c:import>
						</div>
...
<!-- //wrapper -->
	...
	<script type='text/javascript'>
	    ...
	    function fnSearch(){
	        ...
	        frm.action = "./MisEndPtnrTmTraffic";
	        frm.submit();
	    }
