 ...
 --%>
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./MisEndTmMbrQr">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">자문료+기타</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_end_tm_mbr_qr1.jsp"></c:import>
						</div>
