...
<head>
	...
	<script>
		...
		//개인기준
		function goMisEndTmMbr(viewFromDate, viewToDate, team_id){
		...
		function goMisEndTmAssessMbr(viewFromDate, viewToDate, team_id){
		...
		function goMisEndTmTimeMbr(viewFromDate, viewToDate, team_id){
		...
		function goMisEndTmTrafficMbr(viewFromDate, viewToDate, team_id){
		...
		function goMisEndTmQrMbr(viewFromDate, viewToDate, team_id){
		...
		function goMisEndTmTotalMbr(viewFromDate, viewToDate, team_id){
...
<%--
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./MisEndTmMbr">
 ...
 --%>
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./MisEndTmMbrTraffic">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							<b><a href="#noloc" onclick="javascript:goMisEndTmMbr('${srchArg.stdBgnde}','${srchArg.stdEndde}','${srchArg.team_id}');">절대건수</a></b>&nbsp;&nbsp;&nbsp;
							<b><a href="#noloc" onclick="javascript:goMisEndTmAssessMbr('${srchArg.stdBgnde}','${srchArg.stdEndde}','${srchArg.team_id}');">순수 피(Fee)</a></b>&nbsp;&nbsp;&nbsp;
							<b><a href="#noloc" onclick="javascript:goMisEndTmTimeMbr('${srchArg.stdBgnde}','${srchArg.stdEndde}','${srchArg.team_id}');">일비</a></b>&nbsp;&nbsp;&nbsp;
							<b><a href="#noloc" onclick="javascript:goMisEndTmTrafficMbr('${srchArg.stdBgnde}','${srchArg.stdEndde}','${srchArg.team_id}');">교통비</a></b>&nbsp;&nbsp;&nbsp;
							<b><a href="#noloc" onclick="javascript:goMisEndTmQrMbr('${srchArg.stdBgnde}','${srchArg.stdEndde}','${srchArg.team_id}');">자문료+기타</a></b>&nbsp;&nbsp;&nbsp;
							<b><a href="#noloc" onclick="javascript:goMisEndTmTotalMbr('${srchArg.stdBgnde}','${srchArg.stdEndde}','${srchArg.team_id}');">총합계</a></b>&nbsp;&nbsp;&nbsp;
						</div>
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">교통비</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_end_tm_mbr_traffic1.jsp"></c:import>
						</div>
