...
<head>
	...
	<script>
		...
		*/
		...
		function goMisRegPtnrTm(ptnr_id, ptnr_nick){
			srchFrm.action = "./MisRegPtnrTm";
			...
			<div class="center_cnt2">
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./MisRegPtnr">
								...
								<input type="hidden" id="viewToDate" name="viewToDate" value="${srchArg.stdEndde}" />
                               	...
                               	<input type="hidden" id="ptnr_id" name="ptnr_id" value=""/>
                               	<input type="hidden" id="ptnr_nick" name="ptnr_nick" value="">	
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./MisRegPtnr">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">보험사별 수임</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_reg_ptnr1.jsp"></c:import>
						</div>
