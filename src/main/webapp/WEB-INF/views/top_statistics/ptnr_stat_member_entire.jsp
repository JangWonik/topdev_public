				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatMemberEntire">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="총 합계" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatMemberEntire');" type="button" value="총 합계">							
						</div>
						<div class="guestTap">
							<ul>
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_member_entire_tb.jsp"></c:import>							
						</div>
...
<!-- //wrapper -->
	...
	<script type='text/javascript'>
	    ...
	    function fnSearch(){
	        ...
	        frm.action = "./ptnrStatMemberEntire";
	        frm.submit();
	    }
