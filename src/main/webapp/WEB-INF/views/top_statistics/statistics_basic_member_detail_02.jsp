...
<%--         <fmt:formatNumber var="total_suimRptEa" value="0" pattern="#.###"/> --%>
        <fmt:formatNumber var="total_workloadEa" value="0" pattern="#.###"/>        
        ...
        <fmt:formatNumber var="total_shareMinusWorkloadEa" value="0" pattern="#.###"/>
        ...
        <fmt:formatNumber var="total_sharePlusWorkloadEa" value="0" pattern="#.###"/>
        ...
        <c:set var="total_sumShareAmtBasic" value="0"/>
        <c:set var="total_sumShareAmtDaily" value="0"/>
        <c:set var="total_sumShareAmtTraffic" value="0"/>
        <c:set var="total_sumShareSuimRptEa" value="0"/>
        <c:set var="total_sumShareSuimRptEa" value="0"/>
        ...
        <c:forEach  var="item" items="${detailPersonStandardList}" varStatus="status">
        ...
        <tr>
            ...
            <%-- <th class="right border-right"><fmt:formatNumber value="${total_sharePlusEa}" pattern="#,###.###"/></th> --%>
