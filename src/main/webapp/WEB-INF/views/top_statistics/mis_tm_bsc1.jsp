    ...
    <div style="height:540px; overflow-x: hidden; overflow-y: auto;">
        <table cellpadding="0" cellspacing="0" width="1060" summary="팀 기본통계 1종">
            ...
            <tr bgcolor="#E7ECF1">
                ...
                <td><fmt:formatNumber value="${sumProc_m1+sumProc_m4}" pattern="#,##0.##"/>%</td>
                <td><fmt:formatNumber value="${sumProc_y1+sumProc_y4}" pattern="#,##0.##"/>%</td>
                <td><fmt:formatNumber value="${sumNend_p1+sumNend_p4}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sumNend_30r1+sumNend_30r4}" pattern="#,##0.##"/>%</td>
                <td><fmt:formatNumber value="${sumEndea_m1+sumEndea_m4}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sumEndea_y1+sumEndea_y4}" pattern="#,##0.##"/></td>
