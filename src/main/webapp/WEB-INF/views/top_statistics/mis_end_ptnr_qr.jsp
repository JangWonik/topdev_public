				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="자문료+기타" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goMisEndPtnr('MisEndPtnrQr');" type="button" value="자문료+기타">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_end_ptnr_qr1.jsp"></c:import>
						</div>
