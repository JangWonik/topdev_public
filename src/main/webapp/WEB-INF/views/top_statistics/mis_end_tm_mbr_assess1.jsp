...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
							...
							<div class="tableStyle2">
								<table cellpadding="0" cellspacing="0" width="990" align="center">
									...
									<tbody>
										<c:forEach var="vo" items="${MisEndTmMbrAssess}" varStatus="status">
											<tr style="bgcolor: #E7ECF1; text-align: center;" 
												...
												<c:if test="${status.index == 0}">
													<td rowspan="${MisEndTmMbrAssess.size() + 1}">${vo.center_name}</td>
												</c:if>
												<td>${vo.team_name}</td>
												<td>${vo.user_name}</td>
												<td>
...
<%-- 												</c:if> --%>
<%-- 												<td><a href="javascript:goMisEndTmTmAssess('${vo.team_id}','${vo.team_name}','${inVO.viewFromDate}','${inVO.viewToDate}');">${vo.team_name}</a></td> --%>
