...
<head>
	...
	<script>
		...
		function goPtnrStatTeam( p_ptnrId, p_teamCenter ){		
			...
			srchFrm.action = "ptnrStatTeamTime";
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatCenterTime">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="일비" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatCenterTime');" type="button" value="일비">
						...
						<div id="centerView" class="guestcnt2">
							<c:import url="./ptnr_stat_center_time_tb.jsp"></c:import>							
						</div>						
						<div id="teamView" class="guestcnt2">
							<c:import url="./ptnr_stat_team_all_time_tb.jsp"></c:import>							
						</div>
					</div><!-- //guest -->
				</div><!-- centercnt_bot2 -->
