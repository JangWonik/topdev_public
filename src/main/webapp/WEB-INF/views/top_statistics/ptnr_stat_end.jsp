...
<head>
	...
	<script>
		...
		function goPtnrStatCenter( p_ptnrId ){	
			...
			srchFrm.action = "ptnrStatCenterEnd";			//보험사 센터별 실적현황(수임건수)
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatEnd">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="종결건수" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatEnd');" type="button" value="종결건수">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_end_tb.jsp"></c:import>							
						</div>
