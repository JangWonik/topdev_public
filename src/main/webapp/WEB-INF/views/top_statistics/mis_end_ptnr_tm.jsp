			...
			<div class="center_cnt2">
					...
					<div class="nociteA log_top">
						<div class="search_bar">
							<div style="float: left;">
								...
								&nbsp;<b>${MisEndPtnrTm1.get(0).ptnr_nick} 팀기준 보험사별 종결 현황</b>
                           	</div>
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">${inVO.team_name} 절대건수</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_end_ptnr_tm1.jsp"></c:import>
						</div>
