				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatMemberCntFee">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="건당 순수피" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatMemberCntFee');" type="button" value="건당 순수피">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_member_cnt_fee_tb.jsp"></c:import>							
						</div>
...
<!-- //wrapper -->
	...
	<script type='text/javascript'>
	    ...
	    function fnSearch(){
	        ...
	        frm.action = "./ptnrStatMemberCntFee";
	        frm.submit();
	    }
