			...
			<div class="center_cnt2">
					...
					<div class="nociteA log_top">
						<div class="search_bar">
							<div style="float: left;">
								...
								<b>
									<font color="red">${srchArg.stdEndde.substring(0,4)}년 ${srchArg.stdEndde.substring(5,7)}월</font> 보험사별 기본 통계
								</b>
                           	</div>
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./MisBscPtnr">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">보험사별 기본 통계</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_ptnr_bsc1.jsp"></c:import>
						</div>
