		    ...
		    <div style="padding-right: 17px; background: #e7ecf1;">
		        <table cellpadding="0" cellspacing="0" width="1060" align="center" <c:if test="${srchArg.excelYN == 'Y'}">border="1"</c:if>>
		            ...
		            <tr>
		                ...
		                <th colspan="2" class="border-right">기준업무량건수<!-- 평가건수 --></th>
		        ...
		        <table cellpadding="0" cellspacing="0" width="1060" align="center" <c:if test="${srchArg.excelYN == 'Y'}">border="1"</c:if>>
		            ...
		            <c:forEach  var="item" items="${teamList1}" varStatus="status">
		                <tr>
		                    ...
		                    <td class="right">
		                    	<%-- <fmt:formatNumber value="${item.workloadMonthResult}" pattern="#,###.###"/> --%>
		            ...
		            <c:forEach  var="item" items="${teamList4}" varStatus="status">
		                ...
		                <c:set var="sub2_workloadMonthResult" value="${sub2_workloadMonthResult + item.workloadMonthResult}"/>
		                <c:set var="sub2_closeYearEa" value="${sub2_closeYearEa + item.closeYearEa}"/>
		                <c:set var="sub2_workloadYearResult" value="${sub2_workloadYearResult + item.workloadYearResult}"/>
		            ...
		            <tr>
		                ...
		                <th class="right"><fmt:formatNumber value="${sub2_workloadMonthResult}" pattern="#,###.###"/></th>
		                <%-- <th class="right border-right"><fmt:formatNumber value="${sub2_closeYearEa}" pattern="#,###.###"/></th> --%>
		                <th class="right border-right"><fmt:formatNumber value="${sub2_workloadYearResult}" pattern="#,###.###"/></th>
		            ...
		            <tr>
		                ...
		                <th class="right"><fmt:formatNumber value="${sub1_workloadMonthResult + sub2_workloadMonthResult}" pattern="#,###.###"/></th>
		                
		                <%-- <th class="right border-right"><fmt:formatNumber value="${sub1_closeYearEa + sub2_closeYearEa}" pattern="#,###.###"/></th> --%>
		                <th class="right border-right"><fmt:formatNumber value="${sub1_workloadYearResult + sub2_workloadYearResult}" pattern="#,###.###"/></th>
