...
<head>
	...
	<script>
		...
		function goPtnrStatMember( p_ptnrId, p_teamId ){
			...
			srchFrm.action = "ptnrStatMemberEnd";
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatTeamEnd">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="종결건수" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatTeamEnd');" type="button" value="종결건수">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_team_end_tb.jsp"></c:import>							
						</div>
