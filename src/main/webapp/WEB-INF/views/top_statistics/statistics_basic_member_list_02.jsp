...
<div class="tableStyle2">
    <table cellpadding="0" cellspacing="0" width="1060" align="center" <c:if test="${srchArg.excelYN == 'Y'}">border="1"</c:if>>
        ...
        <tr>
            ...
            <th rowspan="2">당월</th>
            <th class="border-right" rowspan="2"><!-- 공동<br/>적용 -->년누계</th>
        ...
        <c:forEach  var="item" items="${memberPersonStandardList}" varStatus="status">
            <tr>
                ...
                <td class="right">
                	<fmt:formatNumber value="${item.workLoadMonthCal}" pattern="#,###.###"/>
                	<%-- <fmt:formatNumber value="${item.workLoadMonth-item.workLoadLastMonth}" pattern="#,###.###"/><br/> --%>                	                	
                </td>
            ...
            <%-- <c:set var="sub1_workLoadMonth" value="${sub1_workLoadMonth + (item.workLoadMonth - item.workLoadLastMonth)}"/> --%>
