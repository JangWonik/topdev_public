...
<head>
	...
	<script>
		...
		function goPtnrStatCenter( p_ptnrId ){		
			...
			srchFrm.action = "ptnrStatCenterTime";			//보험사 센터별 실적현황(수임건수)
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatTime">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="일비" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatTime');" type="button" value="일비">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_time_tb.jsp"></c:import>							
						</div>
