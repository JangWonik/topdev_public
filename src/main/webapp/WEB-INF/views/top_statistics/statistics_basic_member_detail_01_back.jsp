    ...
    <table cellpadding="0" cellspacing="0" width="1060" align="center" <c:if test="${srchArg.excelYN == 'Y'}">border="1"</c:if>>
        ...
        <c:forEach  var="item" items="${detailList}" varStatus="status">
            <tr>
                ...
                <td class="right"><span style="color: red"><fmt:formatNumber value="${item.shareMinusEa}" pattern="#,###.###"/></span></td>
        ...
        <tr>
            ...
            <th class="right"><span style="color: red"><fmt:formatNumber value="${total_shareMinusEa}" pattern="#,###.###"/></span></th>
