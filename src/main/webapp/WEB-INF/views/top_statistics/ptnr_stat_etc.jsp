...
<head>
	...
	<script>
		...
		function goPtnrStatCenter( p_ptnrId ){	
			...
			srchFrm.action = "ptnrStatCenterEtc";			//보험사 센터별 실적현황(수임건수)
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatEtc">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="자문료+기타" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatEtc');" type="button" value="자문료+기타">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="./ptnr_stat_etc_tb.jsp"></c:import>							
						</div>
