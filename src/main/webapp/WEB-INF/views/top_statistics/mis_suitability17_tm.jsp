...
<head>
	...
	<script>
		...
		function goMisSuitability17TmMbr(id, nm, type){
			misSearchForm.action = "./getMisSuitability17TmMbr";
			...
			<div class="center_cnt2">
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./getMisSuitability17Tm">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">적부(흥국)팀</a></li>
							</ul>
						</div>
						<div class="guestcnt2" style="display:block;">
							<c:import url="./mis_suitability17_tm1.jsp"></c:import>
						</div>
