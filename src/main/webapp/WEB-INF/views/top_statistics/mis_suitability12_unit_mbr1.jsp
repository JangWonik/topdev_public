								...
								<caption>팀 기본통계</caption>
									...
									<thead>
										<tr align="center" bgcolor="#EFEFEF">
											...
											<td class="td" nowrap rowspan="3"><B>현재팀</B></td>
									...
									<tbody>
										<c:forEach var="vo" items="${getMisSuitability12UnitMbr}" varStatus="status">
										<tr onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
											<td><p><a href="javascript:goMisSuitability12TmMbr2('${vo.team_id}','${vo.team_name}','${vo.team_type}','${vo.user_no}','${vo.user_name}');">${vo.user_name}</a></p></td>
											<td>${vo.team_name}</td>
