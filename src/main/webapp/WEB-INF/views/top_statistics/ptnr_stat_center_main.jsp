		...
		<div class="contetns2">
			<div class="center_cnt2">
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatCenterMain">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							<input title="수임건수" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatCenterMain');" type="button" value="수임건수">
						...
						<div id="centerView" class="guestcnt2">
							<c:import url="./ptnr_stat_center_suim.jsp"></c:import>														
						</div>
						<div id="teamView" class="guestcnt2">
							<c:import url="./ptnr_stat_team_all_suim.jsp"></c:import>														
						</div>						
						<%-- <div id="memberView" class="guestcnt2">
							<c:import url="./ptnr_stat_member_all_suim.jsp"></c:import>														
						</div> --%>
					</div><!-- //guest -->
				</div><!-- centercnt_bot2 -->
