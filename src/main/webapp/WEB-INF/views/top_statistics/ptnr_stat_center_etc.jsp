...
<head>
	...
	<script>
		...
		function goPtnrStatTeam( p_ptnrId, p_teamCenter ){			
			...
			srchFrm.action = "ptnrStatTeamEtc";
			srchFrm.submit();
		}
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form id="srchFrm" name="srchFrm" method="post" action="./ptnrStatCenterEtc">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						<div style="text-align: right;">
							...
							<input title="자문료+기타" class="buttonDiaAll" style="background-color:#FFA500;" onclick="goPtnrStatMenu('ptnrStatCenterEtc');" type="button" value="자문료+기타">
						...
						<div id="centerView" class="guestcnt2">
							<c:import url="./ptnr_stat_center_etc_tb.jsp"></c:import>							
						</div>						
						<div id="teamView" class="guestcnt2">
							<c:import url="./ptnr_stat_team_all_etc_tb.jsp"></c:import>							
						</div>
					</div><!-- //guest -->
				</div><!-- centercnt_bot2 -->
