...
<head>
	...
	$(document).ready(function(){
		...
		if('${ptnrMbr.ptnr_dept_id}' != 0){
			$("#ptnr_dept_id").val('${ptnrMbr.ptnr_dept_id}');
		}
		...
		$("#popptnrsave").click(function(){
			...
			var ptnr_id = $("#ptnr_id").val();
			
			$.post("./popPtnrUdtOK",
					{	 
						 ptnr_id        		:ptnr_id
						,ptnr_dept_id           :$("#ptnr_dept_id").val()
						,ptnr_tm_nm       		:$("#ptnr_tm_nm").val()
					...
					function(data,status){
						if(status == "success"){
							if(data == 0){
								...
								alert("수정되었습니다.");
								window.opener.location.assign("./topPtnrDTL?ptnr_id="+ptnr_id);
								window.self.close();
							}
						}else{
						...
						<div class= "tableStyle2">
							<table cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td style="text-align:left;padding-left:10px">
											<input type="text" name="ptnr_tm_nm" id="ptnr_tm_nm" value="${ptnrMbr.ptnr_tm2_nm}"/>
										</td>
									</tr>
									<tr>
										<td class = "tdHead">이름</td>
										<td style="text-align:left;padding-left:10px">
											<input type="text" name="ptnr_mbr_nm" id="ptnr_mbr_nm" value="${ptnrMbr.getPtnr_mbr_nm()}"/>
											&nbsp;
											<input type="radio" name="ptnr_mbr_work_type" id="ptnr_mbr_work_type" value="1" <c:if test="${ptnrMbr.getPtnr_mbr_work_type() == '1'}"> checked</c:if> />1종
											&nbsp;
											<input type="radio" name="ptnr_mbr_work_type" id="ptnr_mbr_work_type" value="4" <c:if test="${ptnrMbr.getPtnr_mbr_work_type() == '4'}"> checked</c:if> />4종
											&nbsp;
											<input type="radio" name="ptnr_mbr_work_type" id="ptnr_mbr_work_type" value="0" <c:if test="${ptnrMbr.getPtnr_mbr_work_type() == '0'}"> checked</c:if> />1,4종 겸직
										</td>
									</tr>
									<tr>
										<td class = "tdHead">직위</td>
										<td style="text-align:left;padding-left:10px">
											<input type="text" name="ptnr_mbr_position_nm" id="ptnr_mbr_position_nm" value="${ptnrMbr.getPtnr_mbr_position_nm()}"/>
										</td>
									</tr>
									<tr>
										<td class = "tdHead">직책</td>
										<td style="text-align:left;padding-left:10px">
											<input type="text" name="ptnr_mbr_job_memo" id="ptnr_mbr_job_memo" value="${ptnrMbr.getPtnr_mbr_job_memo()}"/>
										</td>
									</tr>
									<tr>
										<td class = "tdHead">휴대전화</td>
										<td style="text-align:left;padding-left:10px">
											<input type="text" name="ptnr_mbr_hp" id="ptnr_mbr_hp" value="${ptnrMbr.getPtnr_mbr_hp()}"/>
										</td>
									</tr>
									<tr>
										<td class = "tdHead">직통전화</td>
										<td style="text-align:left;padding-left:10px">
											<input type="text" name="ptnr_mbr_office_tel" id="ptnr_mbr_office_tel" value="${ptnrMbr.getPtnr_mbr_office_tel()}"/>
										</td>
									</tr>
									<tr>
										<td class = "tdHead">팩스</td>
										<td style="text-align:left;padding-left:10px">
											<input type="text" name="ptnr_mbr_office_fax" id="ptnr_mbr_office_fax" value="${ptnrMbr.getPtnr_mbr_office_fax()}"/>
										</td>
									</tr>
									<tr>
										<td class = "tdHead">E-mail</td>
										<td style="text-align:left;padding-left:10px">
											<input type="text" name="ptnr_mbr_office_email" id="ptnr_mbr_office_email" value="${ptnrMbr.getPtnr_mbr_office_email()}"/>
										</td>
									</tr>
									<tr>
										<td class = "tdHead">주소</td>
										<td style="text-align:left;padding-left:10px">
											<input type="text" name="ptnr_mbr_office_postcode" id="ptnr_mbr_office_postcode" value="${ptnrMbr.getPtnr_mbr_office_postcode()}" size="10" readonly style="background-color:lightgrey;" />
											<input type="button" id="postCodeBtn" value="우편번호 찾기">
											<input type="text" name="ptnr_mbr_office_addr1" id="ptnr_mbr_office_addr1" value="${ptnrMbr.getPtnr_mbr_office_addr1()}" size="30" readonly style="background-color:lightgrey;" />
											<input type="text" name="ptnr_mbr_office_addr2" id="ptnr_mbr_office_addr2" value="${ptnrMbr.getPtnr_mbr_office_addr2()}" size="30" />
										</td>
									</tr>
									<tr>
										<td class = "tdHead">기타 메모</td>
										<td style="text-align:left;padding-left:10px">
											<input type="text" name="ptnr_mbr_work_memo" id="ptnr_mbr_work_memo" value="${ptnrMbr.getPtnr_mbr_work_memo()}" size="50" />
											<input type="hidden" name="ptnr_mbr_no" id="ptnr_mbr_no" value="${ptnrMbr.getPtnr_mbr_no()}"/>
											<input type="hidden" name="ptnr_id" id="ptnr_id" value="${ptnrMbr.ptnr_id}"/>
										</td>
									</tr>
									<tr>
										<td class = "tdHead">세금계산서 담당자</td>
										<td style="text-align:left;padding-left:10px">
											<input type="text" name="ptnr_tax_nm" id="ptnr_tax_nm" value="${ptnrMbr.getPtnr_tax_nm()}"/>
										</td>
									</tr>
