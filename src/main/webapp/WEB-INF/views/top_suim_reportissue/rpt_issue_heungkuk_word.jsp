		    ...
		    <tr>
		        	...
		        	<table id="table_issue_contract_view" style="border: 1px solid currentColor;">
		        		<c:choose>
		        			<c:when test="${ctype eq 'I' }">
		        				<tr style="height:12px;">
				                	<th style="width:17%;"><b>구분</b></th>
				                	<th style="width:83%;"><b>상세내용</b></th>                	
				                </tr>
				                <tr style="height:12px;">
				                    <th style="width:17%;"><b>사고(진료)일시</b></th>
				                    <td style="width:83%;text-align: left;padding-left:5px;">${suimVO.accident_date}</td>                    
				                </tr>				                
				                <tr style="height:12px;">
				                    <th style="width:17%;"><b>사고(진단)내용</b></th>
				                    <td style="width:83%;text-align: left;padding-left:5px;">
				...
				<div class="issue_lotte">					
					<table id="table_issue_contract_view" style="border: 1px solid currentColor;">
						...
						<c:if test="${ctype eq 'C'}">						
							...
							<c:forEach items="${rptIssueSummaryList}" var="item" varStatus="status">
								<tr style="height:12px;">                	
									...
									<td style="width:17%;text-align: right;padding-right:5px;"><fmt:formatNumber value="${item.payPrice}" pattern="#,###" />&nbsp;</td>
								</tr>
							</c:forEach>
							<tr style="height:12px;">                	
									...
									<td style="width:17%;text-align: right;padding-right:5px;"><b><fmt:formatNumber value="${sum_payPrice}" pattern="#,###" /></b>&nbsp;</td>
							</tr>
							<tr style="height:12px;">
						...
						<c:if test="${ctype eq 'B'}">						
							<tr style="height:12px;">
								<th style="width:15%;"><b>목적물</b></th>
								<th style="width:17%;"><b>보상한도액</b></th>
								<th style="width:17%;"><b>손해액</b></th>
								<th style="width:17%;"><b>공제금액</b></th>				
								<th style="width:17%;"><b>지급보험금</b></th>
								<th style="width:17%;"><b>비고</b></th>                	
							</tr>
							<c:forEach items="${rptIssueSummaryList}" var="item" varStatus="status">
								<tr style="height:12px;">                	
									<td style="width:15%;">${item.summaryCate}</td>					
									<td style="width:17%;text-align: right;padding-right:5px;"><fmt:formatNumber value="${item.compLimitPrice}" pattern="#,###" />&nbsp;</td>
									<td style="width:17%;text-align: right;padding-right:5px;"><fmt:formatNumber value="${item.lossPrice}" pattern="#,###" />&nbsp;</td>
									<td style="width:17%;text-align: right;padding-right:5px;"><fmt:formatNumber value="${item.netLossPrice}" pattern="#,###" />&nbsp;</td>					
									<td style="width:17%;text-align: right;padding-right:5px;"><fmt:formatNumber value="${item.payPrice}" pattern="#,###" />&nbsp;</td>
									<td style="width:17%;text-align: right;padding-right:5px;">${item.exceptionVal}&nbsp;</td>
								</tr>
							</c:forEach>
							<tr style="height:12px;">                	
									<td><b>합계</b></td>
									<td style="width:15%;text-align: right;padding-right:5px;"><b><fmt:formatNumber value="${sum_compLimitPrice}" pattern="#,###" /></b>&nbsp;</td>
									<td style="width:17%;text-align: right;padding-right:5px;"><b><fmt:formatNumber value="${sum_lossPrice}" pattern="#,###" /></b>&nbsp;</td>
									<td style="width:17%;text-align: right;padding-right:5px;"><b><fmt:formatNumber value="${sum_netLossPrice}" pattern="#,###" /></b>&nbsp;</td>
									<td style="width:17%;text-align: right;padding-right:5px;"><b><fmt:formatNumber value="${sum_payPrice}" pattern="#,###" /></b>&nbsp;</td>
									<td style="width:17%;text-align: right;padding-right:5px;">&nbsp;</td>
							</tr>								
						</c:if>
						<c:if test="${ctype eq 'I'}">							
							<tr style="height:12px;">
								<th style="width:17%;"><b>증권번호</b></th>
								<th style="width:15%;"><b>담보명</b></th>
								<th style="width:17%;"><b>가입금액</b></th>
								<th style="width:17%;"><b>청구금액</b></th>
								<th style="width:17%;"><b>지급금액</b></th>				
								<th style="width:17%;"><b>비고</b></th>                	
							</tr>
							<c:forEach items="${rptIssueSummaryList}" var="item" varStatus="status">
								<tr style="height:12px;">                	
