...
<script type="text/javascript">
    ...
    function fnReportWord(){
        ...
        window.open('/reportIssueMain?suim_rpt_no='+'${param.suim_rpt_no}'+'&cmd=word'+'&suim_rpt_type1='+'${suimVO.suim_rpt_type1}','word','width='+sw+',height='+sh+',top='+mt+',left='+ml+',resizable=no,scrollbars=yes');
    }
    ...
    function fnReportPrint(){
        ...
        window.open('/reportIssueMain?suim_rpt_no='+'${param.suim_rpt_no}'+'&cmd=print'+'&suim_rpt_type1='+'${suimVO.suim_rpt_type1}','print','width='+sw+',height='+sh+',top='+mt+',left='+ml+',resizable=no,scrollbars=yes');
    }  
    ...
    function fnSendReportPrint(){		//손해사정서 교부 대상자 보고서    	
		...
		window.open("/reportIssueMain?suim_rpt_no=${param.suim_rpt_no}&cmd=report&suim_rpt_type1=${suimVO.suim_rpt_type1}&ptnr_mbr_nm="+ptnr_nm,'print','width='+sw+',height='+sh+',top='+mt+',left='+ml+',resizable=no,scrollbars=yes');
    }
...
<div class="reportWrap">
    <div class="issue_reportContent">
        ...
        <!-- 배상 - 재물,질병,상해 구분 -->        	
		        <div class="display-table" style="margin-top: 20px;">
		            <div class="display-cell">
		                <p class="subtitle" style="width: 440px;">3. 손해액 및 보험금 사정에 크게 영향을 미친사항</p>		                
		            </div>		       		            
		            <div class="display-cell text-right">
		        ...
		        <div id="div_law" class="display-cell text-left">
		            <table id="table_law_view" style="text-align:center;">
		                <tr>
		                	...
		                	<td style="width: 10px; padding-top: 2px;">/</td>
		                	<td>
