    ...
    <div class="issue_reportContent">    	
		...
		<table style="height:30px;">
			...
			<tbody>
				<tr style="height:12px;">
					<td></td>
					<td style="border: 1px solid currentColor;text-align:center;">구 분</td>
					<td style="border: 1px solid currentColor;text-align:center;">성 명</td>
				</tr>
				<tr style="height:12px;">
					<td></td>
					<td style="border: 1px solid currentColor;text-align:center;">담 당 자</td>
					<td style="border: 1px solid currentColor;text-align:center;">${reportInvgUser.userName}</td>
				</tr>
				<tr style="height:12px;">
					<td></td>
					<td style="border: 1px solid currentColor;text-align:center;">대표손해사정사</td>
					<td style="border: 1px solid currentColor;text-align:center;">윤경수<!-- <img alt="윤경수" src="./resources/ne_img/sign_yun.jpg" width="50" height="30"> --></td>
				</tr>				
			</tbody>
		</table>
		<br/> --%>
