...
<script type="text/javascript">
    ...
    function fnReportWord(){
        ...
        window.open('/reportIssueMainPi?suim_rpt_no='+'${param.suim_rpt_no}'+'&cmd=word'+'&suim_rpt_type1='+'${suimVO.suim_rpt_type1}','word','width='+sw+',height='+sh+',top='+mt+',left='+ml+',resizable=no,scrollbars=yes');
    }
    ...
    function fnReportPrint(){
        ...
        window.open('/reportIssueMainPi?suim_rpt_no='+'${param.suim_rpt_no}'+'&cmd=print'+'&suim_rpt_type1='+'${suimVO.suim_rpt_type1}','print','width='+sw+',height='+sh+',top='+mt+',left='+ml+',resizable=no,scrollbars=yes');
    }  
    ...
    function fnSendReportPrint(){		//손해사정서 교부 대상자 보고서    	
		...
		window.open("/reportIssueMainPi?suim_rpt_no=${param.suim_rpt_no}&cmd=report&suim_rpt_type1=${suimVO.suim_rpt_type1}&ptnr_mbr_nm="+ptnr_nm,'print','width='+sw+',height='+sh+',top='+mt+',left='+ml+',resizable=no,scrollbars=yes');
    }
    ...
    function fnIssueContractSave() {					//보험계약사항 수정 저장
        ...
        param.suim_rpt_type1				= $("#suim_rpt_type1").val();        
     ...
     function fnIssueSend(type, idx, agr){
      ...
      function fnIssueSendMsg(idx){
          if(confirm("해당 대상자에게 메시지 발송을 하시겠습니까?\n발송실패로 인한 재발송 시에는 연락처 수정 후 \n수정버튼을 클릭하시고 문자발송하세요.")){
              ...
              var url = "./report_Issue_send_pi_msg";
    ...
    //이메일 발송 추가
  	function fnIssueSendEmail(idx){		
  		...
  		if(confirm("해당 대상자에게 이메일 발송을 하시겠습니까?\n발송 후에는 취소는 불가능합니다.\n발송실패시 이메일 재등록후 발송하세요.")){
			  ...
			  var url = "./report_Issue_send_pi_email";              
...
<div class="reportWrap">
    <div class="issue_reportContent">
        ...
        <div class="text-right">
            <a href="/reportIssueMainPi?suim_rpt_no=${param.suim_rpt_no}&cmd=word&suim_rpt_type1=${suimVO.suim_rpt_type1}"><img src="./resources/ls_img/report/btn_word.gif"></a>
        ...
        <!-- 인보험 손해사정서 물보험 기본 손해사정서와 동일하게 수정 시작 -->
        ...
        <!-- 인보험 손해사정서 물보험 기본 손해사정서와 동일하게 수정 끝 -->
