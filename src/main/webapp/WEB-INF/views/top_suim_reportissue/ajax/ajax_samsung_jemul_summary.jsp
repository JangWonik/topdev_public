		...
		<tbody>
			...
			<c:forEach items="${rptIssueSummaryList}" var="item" varStatus="status">
				<tr>                	
					...
					<td style="text-align: right;padding-right:5px;"><fmt:formatNumber value="${item.lossPrice}" pattern="#,###" /></td>
					<td style="text-align: right;padding-right:5px;"><fmt:formatNumber value="${item.lossCompPrice}" pattern="#,###" /></td>					
			...
			<tr>                	
					...
					<td style="text-align: right;padding-right:5px;"><b><fmt:formatNumber value="${sum_lossPrice}" pattern="#,###" /></b></td>
					<td style="text-align: right;padding-right:5px;"><b><fmt:formatNumber value="${sum_lossCompPrice}" pattern="#,###" /></b></td>
		...
		<tbody>
			...
			<c:if test="${ rowSpan eq 0 }">			
				<tr>
					...
					<td style="text-align: right;padding-right:5px;"><input type="text" class="money" id="net_loss_price" name="net_loss_price" value="0" style="text-align: right;padding-right:5px;width:86px;" onkeydown="return showKeyCode(event)"></td>
				</tr>
			</c:if>
			<c:forEach items="${rptIssueSummaryList}" var="item" varStatus="status">				
				<tr>
					<td>
						...
						<%-- <select name="summary_cate">						
							...
							<option value="재고자산" <c:if test="${ item.summaryCate eq '재고자산' }">selected</c:if> >재고자산</option>
					...
					<td style="text-align: right;padding-right:5px;"><input type="text" class="money" id="net_loss_price" name="net_loss_price" value="${item.netLossPrice}" style="text-align: right;padding-right:5px;width:80px;" onkeydown="return showKeyCode(event)">
			...
			<tr>
				...
				<td colspan="5" style="text-align: right;padding-right:6px;">
					<input type="hidden" id="amt_self_pay_unit" name="amt_self_pay_unit" value="${rptIssueMain.amtSelfPayUnit}" />
					<input type="hidden" id="amt_self_pay_unit_direct" name="amt_self_pay_unit_direct" value="${rptIssueMain.amtSelfPayUnit}" />						
					<input type="hidden" id="amt_self_pay" name="amt_self_pay" value="${rptIssueMain.amtSelfPay}" />
					${rptIssueMain.amtSelfPayUnit} <fmt:formatNumber value="${rptIssueMain.amtSelfPay}" pattern="#,###" />
				</td>
				<%-- <td colspan="5" style="text-align: right;padding-right:6px;">
		...
		<tbody>
			...
			<c:if test="${ rowSpan eq 0 }">			
				<tr>
					...
					<td style="text-align: right;padding-right:5px;"><input type="text" class="money" id="loss_price" name="loss_price" value="0" style="text-align: right;padding-right:5px;" onkeydown="return showKeyCode(event)"></td>
					<td style="text-align: right;padding-right:5px;"><input type="text" class="money" id="loss_comp_price" name="loss_comp_price" value="0" style="text-align: right;padding-right:5px;" onkeydown="return showKeyCode(event)"></td>
					<td style="text-align: right;padding-right:5px;"><input type="text" class="money" id="self_opt_price" name="self_opt_price" value="0" style="text-align: right;padding-right:5px;width:100px;" onkeydown="return showKeyCode(event)"></td>
				</tr>
			</c:if>			
			<c:forEach items="${rptIssueSummaryList}" var="item" varStatus="status">
				<tr>                	
					...
					<td style="text-align: right;padding-right:5px;"><input type="text" class="money" id="loss_price" name="loss_price" value="${item.lossPrice}" style="text-align: right;padding-right:5px;" onkeydown="return showKeyCode(event)"></td>
					<td style="text-align: right;padding-right:5px;"><input type="text" class="money" id="loss_comp_price" name="loss_comp_price" value="${item.lossCompPrice}" style="text-align: right;padding-right:5px;" onkeydown="return showKeyCode(event)"></td>
					<td style="text-align: right;padding-right:5px;"><input type="text" class="money" id="self_opt_price" name="self_opt_price" value="${item.selfOptPrice}" style="text-align: right;padding-right:5px;width:88px;" onkeydown="return showKeyCode(event)">
					<img src="./resources/ls_img/btn_del_s.gif" border="0" onclick="fnSummary_del('${item.suimRptNo }','${item.summaryNo}');" style="cursor:pointer" />
					</td>
				</tr>
			</c:forEach>
			<tr>                	
					...
					<td style="text-align: right;padding-right:5px;"><b>${sum_lossPrice}</b></td>
					<td style="text-align: right;padding-right:5px;"><b>${sum_lossCompPrice}</b></td>
			...
			<c:if test="${ rowSpan eq 0 }">			
				<tr>
					<td>
						<input type="text" id="summary_cate" name="summary_cate" maxlength="8">
						<!-- <select name="summary_cate">						
							<option value="담보1" selected>담보1</option>
							<option value="담보2">담보2</option>
							<option value="담보3">담보3</option>
						</select> -->
					</td>					
					<td style="text-align: right;padding-right:5px;"><input type="text" class="money" id="join_price" name="join_price" value="0" style="text-align: right;padding-right:5px;" onkeydown="return showKeyCode(event)"></td>
					...
					<td style="text-align: left;padding-left:5px;"><input type="text" id="exception_val" name="exception_val" value="" style="text-align: right;padding-right:5px;width:110px;" maxlength="20"></td>
				</tr>
			</c:if>			
			<c:forEach items="${rptIssueSummaryList}" var="item" varStatus="status">
				<tr>                	
					<td>
						<input type="text" id="summary_cate" name="summary_cate" maxlength="8" value="${item.summaryCate}">
						<%-- <select name="summary_cate">						
							<option value="담보1" <c:if test="${ item.summaryCate eq '담보1' }">selected</c:if> >담보1</option>
							<option value="담보2" <c:if test="${ item.summaryCate eq '담보2' }">selected</c:if> >담보2</option>
							<option value="담보3" <c:if test="${ item.summaryCate eq '담보3' }">selected</c:if> >담보3</option>
						</select> --%>
					</td>
					<td style="text-align: right;padding-right:5px;"><input type="text" class="money" id="join_price" name="join_price" value="${item.joinPrice}" style="text-align: right;padding-right:5px;" onkeydown="return showKeyCode(event)"></td>
					...
					<td style="text-align: right;padding-right:5px;"><input type="text" class="money" id="exception_val" name="exception_val" value="${item.exceptionVal}" style="text-align: right;padding-right:5px;width:88px;" maxlength="20">
					<img src="./resources/ls_img/btn_del_s.gif" border="0" onclick="fnSummary_del('${item.suimRptNo }','${item.summaryNo}');" style="cursor:pointer" />
					</td>
				</tr>
			</c:forEach>
