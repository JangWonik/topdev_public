...
<script>
	$(document).ready(function(){	
		$("#acc_cont_sel").change( function(){		//사고내용 변경에 따른 수정
			if( $("#acc_cont_sel").val() == 'direct' ){		//직접입력
				if( confirm("기존에 입력된 사고내용이 삭제됩니다.\n진행하시겠습니까?") ){
					$("#acc_facts").val('');
					$("#acc_facts").focus();
				}
...
<table id="table_issue_contract_edit" style="border: 1px solid currentColor;">
	...
	<tr>
	    ...
	    <td  style="text-align: left;padding-left:5px;">
			...
			<input type="text" id="investigate_addr2" style="width: 75%" value="${suimVO.investigate_addr2}" />
	...
	<tr>
		...
		<textarea id="acc_facts" rows="2" cols="100" style="width:520px;">${rptIssue.insuContent}</textarea>
	...
	<tr>
		<th><b>피해자</b></th>
		<td  style="text-align: left;padding-left:5px;"><input type="text" id="damaged_nm" name="damaged_nm" maxlength="150" value="${suimVO.getDamaged_nm()}"></td>
	</tr>
	</c:if>
    </tbody>
</table>
