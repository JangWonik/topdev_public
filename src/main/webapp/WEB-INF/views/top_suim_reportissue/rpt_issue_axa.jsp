...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function fnIssueSendEmail(idx){		
		...
		if(confirm("해당 대상자에게 이메일 발송을 하시겠습니까?\n발송 후에는 취소는 불가능합니다.\n발송실패시 이메일 재등록후 발송하세요.")){
            ...
            var url = "./report_Issue_send_axa_email";
	...
	function fnIssueAccSave() {	        	
        ...
        //사고경위 추가
        param.insu_sequence	= $("#acc_insu_sequence").val();
        //피해자(물) 추가
	...
	function fnIssueContractSave(){
		if(confirm("1. 계약사항의 내용을 수정하시겠습니까?")){					
			...
			var formData = $("#contEditForm").serialize();           
            
            var url = "./reportIssueAxaUpdate";
	...
	function fnIssueSummarySave(){
		...
		if(confirm("3. 총괄표 내용을 수정하시겠습니까?")){
            ...
            param.reparation_liability_reason = $("#reparation_liability_reason").val();
            param.amt_insu_payment = $("#amt_insu_payment").val();
            param.payment_place = $("#payment_place").val();
            ...
            var url = "./reportIssueAxaSummaryUpdate";
	...
	function fnReportPrint(){
        ...
        window.open('/reportIssueAxa?suim_rpt_no='+'${param.suim_rpt_no}'+'&cmd=print'+'&ctype=${ctype}','print','width='+sw+',height='+sh+',top='+mt+',left='+ml+',resizable=no,scrollbars=yes');
    }
	...
	function fnIssueSendMsg(msgIdx){		
		...
		var url = "./report_Issue_send_axa_msg";
...
<div class="reportWrap">
    <div class="issue_reportContent"> 
    	<div class="text-right">
            <a href="/reportIssueAxa?suim_rpt_no=${suimVO.suim_rpt_no}&cmd=word&ctype=${ctype}"><img src="./resources/ls_img/report/btn_word.gif"></a>
