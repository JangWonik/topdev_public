 ...
 <!--            <p class="c" style="font-size: 0pt;"><img src="https://www.toplac.co.kr/resources/ls_img/ls_body/print_hr.jpg" width="640" border="0" height="3px"></p> -->
        ...
        <div style="margin-top: 0px">
            <table width="640" height="128" border="1">
                ...
                <tr>
			        <th width="90" height="32">계 약 자</th>
			        <td width="230" height="32">&nbsp;${rptIssueMain.policyholderNm}</td>
			        <th width="90" height="32">피 보 험 자</th>
			        <td width="230" height="32">&nbsp;${rptIssueMain.beneficiaryNm}</td>
                </tr>                
