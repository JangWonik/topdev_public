...
<form name="form_chk" id="form_chk" method="post">	
	<input type="hidden" name="EncodeData" id="EncodeData" value="<%= sRequestNumber %>">		<!-- 위에서 업체정보를 암호화 한 데이타입니다. -->	
</form>
<script>
	function doSubmit(){		
		//window.top.opener.name="intraPage";
		document.form_chk.target="intraPage";
		document.form_chk.action="succLogin";
