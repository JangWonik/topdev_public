				...
				<div class="center_cnt_vacation" style="margin:0 auto;">
                    <div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" name="uploadForm" action="./lectureBoardUpdate" method="post" enctype="multipart/form-data">
									...
									<table>
										...
										<tr>
											...
											<td colspan="5" style="text-align: left; padding-left: 10px;">
	                                            <select id="titleSelect" name="titleSelect" style="width:50%;">
													<option value="0">- 전체 -</option>
													<c:forEach items="${qnaLectureList}" var = "titleVo">														
														<option value="${titleVo.pkey}"
															<c:if test="${boardDetail.pkey == titleVo.pkey}">selected</c:if> > ${titleVo.p_title}</option>
													</c:forEach>
												</select>
	                                        </td>
										</tr>
							...
							<p style="text-align:right;margin-top:10px;">								
								...
								<a href="./lectureBoardDetail?boardNo=${boardDetail.board_no}&boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&titleSearch=${searchVO.titleSearch}&reqPgNo=${reqPgNo}&boardType=${searchVO.boardType}" class="btn-vacation-aprv" style="background:#F6CED8;">취소</a>
							</p>
						</div>
					</div>
				</div>
