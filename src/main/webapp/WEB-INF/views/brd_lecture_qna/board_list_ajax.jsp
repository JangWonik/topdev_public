		...
		<c:choose>
			...
			<c:otherwise>
				...
				<tr>
					...
					<td width="24%" style="text-align:left;padding-left:10px;letter-spacing:0px;">
						${brd.pkey_nm}
					</td>										
					<td width="40%" style="text-align:left;padding-left:10px;letter-spacing:0px;">
						<div style="width:400px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
						<a href="./lectureBoardDetail?boardNo=${brd.board_no}&boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&titleSearch=${searchVO.titleSearch}&reqPgNo=${reqPgNoInt1}">					
							${brd.title}							
						</a>
