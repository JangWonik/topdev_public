		...
		<td width="100%" valign="top" height="100%">
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td width="50%">
						<p>
							<img src="https://www.toplac.co.kr/resources/ls_img/report/head_interim_txt1s.jpg" width="205" height="56" border="0">
							<span id="orderNoImg">
								${suimRptSiteVo.orderNo}
							</span>
<%-- 							<img src="https://www.toplac.co.kr/resources/ls_img/report/${suimRptSiteVo.orderNo}.jpg" width="20" height="56" border="0"> --%>
							<img src="https://www.toplac.co.kr/resources/ls_img/report/head_interim_txt1e.jpg" width="40" height="56" border="0">
						</p>
						
					</td>
					<td width="50%">
						<p align="right"><img src="https://www.toplac.co.kr/resources/ls_img/report/head_interim_logo.jpg" width="190" height="56" border="0"></p>
					</td>
				</tr>
				<tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
                    ...
                    <td width="36%" class="td">
						<p><c:out value="${suimListDtl.compensationLimitUnit}"/> <fmt:formatNumber value="${suimListDtl.amtCompensationLimit}" pattern="###,###,##0.##"/></p>
                    </td>
                </tr>
                <tr>
                    <td width="14%" class="td" bgcolor="#CECFFF">
                    ...
                    <td width="36%" class="td">
						<p><c:out value="${suimListDtl.selfPayLimitUnit}"/> <fmt:formatNumber value="${suimListDtl.amtSelfPay}" pattern="###,###,##0.##"/></p>
                    </td>
                </tr>
            </table>
            <p>&nbsp;</p>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td width="36%" class="td">
						<p>￦ ${suimListDtl.amtEstimatedDamage} ( 분류 :
							<c:choose>
	...
	<tr>
		<td width="100%" valign="top" height="100%">
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td width="50%">
						<p><img src="https://www.toplac.co.kr/resources/ls_img/report/head_interim_txt2.jpg" width="262" height="56" border="0"></p>
					</td>
					<td width="50%">
						<p align="right"><img src="https://www.toplac.co.kr/resources/ls_img/report/head_interim_logo.jpg" width="190" height="56" border="0"></p>
					</td>
