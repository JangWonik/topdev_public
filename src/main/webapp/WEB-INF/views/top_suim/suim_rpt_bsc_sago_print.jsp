...
<body bgcolor="white" text="black" link="blue" vlink="purple" alink="red">
	<table align="center" cellpadding="0" cellspacing="0" width="640">
		...
		<TABLE cellSpacing=0 cellPadding="0" width="640" align="center" bordercolordark="white" bordercolorlight="#999999">
			<colgroup>
				<col width="120"></col>
				<col width="160"></col>
				<col width="360"></col>
			...
			<tr>
				...
				<td bgcolor="#EDEDED" class="td">
			        <p align="center"><b>항 &nbsp;&nbsp;&nbsp;목</b>
			    </td>
				<td bgcolor="#EDEDED" class="td">
			        <p align="center"><b>처 &nbsp;리 &nbsp;내 &nbsp;용</b>
			    </td>
		    </tr>
