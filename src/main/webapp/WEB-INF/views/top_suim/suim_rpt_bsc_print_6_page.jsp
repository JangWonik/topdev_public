	...
	<table cellpadding="0" cellspacing="0" width="640" align="center">
		<tr>
			<td width="640">
	                    ...
	                    <td width="75" rowspan="2">
	                        <p>
	                        	<c:if test="${signVoForRptUser.user_sign ne '' or signVoForRptUser.user_sign ne null}">
									<img src='https://www.toplac.co.kr/home/hosting_users/toplac/www/ls_data/member_sign/${signVoForRptUser.user_no}/${signVoForRptUser.user_sign}' width=30 height=30 border=0>	                        	
	                        	</c:if>
	                        </p>
	                    </td>
	                </tr>
				...
				<p align="center"><img src="https://www.toplac.co.kr/ls_report/img/sign_report.jpg" width="300" height="80" border="0"></p>
			</td>
		</tr>
	</table>
<!--보고서 끝-->
