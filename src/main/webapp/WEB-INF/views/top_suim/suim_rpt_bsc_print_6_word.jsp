			...
			<td width="640">
				...
				<table cellpadding="0" cellspacing="0" width="640">
	                ...
	                <tr>
	                    ...
	                    <td width="75" rowspan="2">
	                        <p>
	                        	<c:if test="${mbrVoForBodySantion.user_no ne '' }">
		                        	<img src="https://www.toplac.co.kr/home/hosting_users/toplac/www/ls_data/member_sign/${mbrVoForBodySantion.user_no}/${mbrVoForBodySantion.user_sign}" width=30 height=30 border=0>	                        	
	                        	</c:if>
	                        	<c:if test="${mbrVoForBodySantion.user_no eq '' or mbrVoForBodySantion.user_no eq null}">
	                        		사인 없음
	                        	</c:if>
	                        </p>
	                    </td>
	                ...
	                <tr>
	                    ...
	                    <td width="75" rowspan="2">
	                        <p>
	                        	<c:if test="${signVoForRptUser.user_sign ne '' or signVoForRptUser.user_sign ne null}">
		                        	<img src='https://www.toplac.co.kr/home/hosting_users/toplac/www/ls_data/member_sign/${suimVO.user_no}/${mbrVoForBodySantion.user_sign}' width=30 height=30 border=0>	                        	
	                        	</c:if>
	                        </p>
	                    </td>
	                </tr>
				...
				<p align="center"><img src="https://www.toplac.co.kr/resources/ls_img/report/sign_report.jpg" width="300" height="80" border="0"></p>
			</td>
		</tr>
	</table>
