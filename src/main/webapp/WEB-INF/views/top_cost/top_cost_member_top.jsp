...
<script>
	$(document).ready(function(){
	    ...
	    $("#backBtn").click(function(){
	    	location.href="./topCostTeam?team_id=${team_id}&team_name=${team_name}&viewFromDate=${fromdate}&viewToDate=${todate}";
	    });
	...
	<b>${toAccumYear}년 ${toMonth}월 ${team_name} ${user_name} 경비내역</b>
	...
	<form name="datef" method="GET" action="./topCostMember"> 
	<!-- 달력 From -->
	...
	<input type="hidden" id="user_id" name="user_id" size="10"  value="${user_id}" maxlength="10" />
	<input type="hidden" id="team_name" name="team_name" size="10"  value="${mbrVo_Session.team_name}" maxlength="10" />
	<input type="hidden" id="user_name" name="user_name" size="10"  value="${mbrVo_Session.user_name}" maxlength="10" />
	</form>
