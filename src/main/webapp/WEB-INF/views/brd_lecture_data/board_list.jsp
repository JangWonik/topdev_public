					...
					<div class="guest">
						...
						<div class="guestcnt2">															
								...
								<div class="tableStyle2" style="padding-bottom:10px;border-top:0px;">
									<form method="get" name="boardSrcForm" id="boardSrcForm" action="./brdLectureBoardList">
									<table>																					
										<tr>
											...
											<td style="text-align:right;padding-right:5px;background:#F8FBEF;">
												<a href="javascript:doDataWrite();" class="btn-vacation-aprv" id="boardSrcAddBtn" style="background:#CEE3F6;">등록</a>
											</td>
										</tr>
									</table>
									</form>													
...
<form id="goWriteForm" name="goWriteForm" method="post" action="brdLectureDataWrite">
