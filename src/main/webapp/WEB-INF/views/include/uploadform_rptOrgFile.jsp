...
<script>
	$(document).ready(function(){
		$("#attchFileRptOrg").change(function(){
			$("#rptOrgFileBtn").click();	
		});
		  ...
		  success:function(data) {
			  ...
			  /* 파라미터 설정 끝 */
				  ...
				  if( (data != "0") && (data !="1") && (data !="9") ){
					  ...
					  var fileName = $("#attchFileRptOrg").val();
					  var subfilename = fileName.substr(fileName.lastIndexOf("\\")+1);

					  $("#rptOrgFileList").append(
        				   	"<tr id = 'rptFileOrgTr_"+fileSerial+"'>"
	       					+	"<td>"
	       					+ "<a href='fileDownload?key="+fileSerial+"&type=rptOrigin&suimRptNo="+$("#suimRptNo").val()+"'>"
...
<form name="UploadFileFormRptOrg" id="UploadFileFormRptOrg" method="POST" action="upload" enctype="multipart/form-data">
	...
	<!-- 파일입력 -->
	<input type="file" name="attchFile" id="attchFileRptOrg"  />
	...
	<input style ="display:none; visibility:hidden;" type="submit" id ="rptOrgFileBtn" class="btn" />
</form>
