...
<script>
	$(document).ready(function(){
		$("#attchFileMyCostBill3").change(function(){
			$("#myCostBillFileBtn3").click();
		});
		
	});

	$("#UploadFileFormMyCostBill3").ajaxForm({
		  dataType : 'text',
		  success:function(data) {
			  ...
			  if(gubun == "0"){
				  ...
				  if( (data != "0") && (data !="1") && (data !="9") ){
					  ...
					  var fileName = $("#attchFileMyCostBill3").val();
					  var subfilename = fileName.substr(fileName.lastIndexOf("\\")+1);
 
					  $("#myCostBillFileList3").append(
...
<form name="UploadFileFormMyCostBill3" id="UploadFileFormMyCostBill3" method="POST" action="upload" enctype="multipart/form-data">
	
	<!-- 파일입력 -->
	<input type="file" name="attchFile" id="attchFileMyCostBill3"  />
	...
	<input style ="display:none; visibility:hidden;" type="submit" id ="myCostBillFileBtn3" class="btn" />
</form>
