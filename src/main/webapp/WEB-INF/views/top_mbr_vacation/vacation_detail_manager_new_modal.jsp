...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
			...
			<div class="tableStyle2" style="width: 700px;">
				<table class="vacation-ins-table">
					...
					<tbody>						
						...
						<!-- 예상잔여연차 계산시작 -->
						<c:choose>
							<c:when test="${vacationInfo.vacation_type eq 100 or vacationInfo.vacation_type eq 200 }">
						...
						<c:choose>
							<c:when test="${view_type eq 'view'}">
								...
								<tr>
									<td colspan="6">										
										<a href="javascript:fnVacationCancel(${vacationInfo.serial_no});" class="btn-vacation-aprv" style="background:#c25757;color:#ffffff !important;" >신청취소</a>												
									</td>
								</tr>
								</c:if>
							</c:when>
	...
	<script>
		...
		function fnVacationCancel( p_serial_no ){
			
			var url = "actionVacationManagerCancel";
