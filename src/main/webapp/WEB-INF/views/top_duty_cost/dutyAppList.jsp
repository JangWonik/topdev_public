...
<%-- 								<a id="btn_excel" href="#noloc">									
						    ...
						    <form id=dutyAppList name="dutyAppList" method="get" action="/dutyAppList" onsubmit="return fnSearch();">
	                            ...
	                            <input type="hidden" id="retType" name="retType" value="10"/>	                             
                            </form>															
						...
						<div class="guestTap">
							<ul>								
								...
								<c:if test="${mbrAuthVo_Session.mbr_pms_22 == 1}">	
									<li class="on"><a href="#">당직비 신청 결재</a></li>
								</c:if>
							...
							<div class="tableStyle2">
									...
									<c:forEach var="item" items="${list}" varStatus="status">
										...
										<tr>
											...
											<td><a href="/dutyCostView?dutyId=${item.dutyId}&retType=10&tabFlag=2">${fn:substring(item.dutyId,0,7)}-${fn:substring(item.dutyId,7,9)}</a></td>
...
<script type="text/javascript">
    ...
    function fnGoPage(pageIdx) {
        var frm = document.getElementById("dutyAppList");
        frm.method = "get";
        frm.action = "./dutyAppList";
        $("#pageIdx").val(pageIdx);
        frm.submit();
    }
