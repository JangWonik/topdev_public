				...
				<div class="center_cnt_vacation" >
					...
					<div class="centercnt_bot2" style="margin:0 auto;">
						<div class="guest">
							<div class="guestTap">
								<ul>
									<li id="tabMenu1" class="on"><a href="#">교육과정 결재 대상건</a></li>
									<li id="tabMenu2"><a href="#">교육과정 결재 내역</a></li>
									<li id="tabMenu3"><a href="#">교육과정 결재 전체 내역</a></li>
								</ul>
							</div>
							<!-- 교육 결재 대상건 -->								
							<div class="guestcnt2">
								<c:import url="./lecture_approval_manage.jsp"></c:import>
							</div>
							<!-- 교육 결재 내역 -->
							<div class="guestcnt2" style="display:none;">
								<c:import url="./lecture_approval_manage_result.jsp"></c:import>
							</div>
							<!-- 교육 결재 전체 내역 -->
							<div class="guestcnt2" style="display:none;">
								<c:import url="./lecture_approval_manage_all.jsp"></c:import>									
							</div>
						</div>
					</div>
