				...
				<div class="center_cnt_vacation" >
					...
					<div class="centercnt_bot2" style="margin:0 auto;">
						<div class="guest">
							<div class="guestTap">
								<ul>
									<li id="tabMenu1" <c:if test="${tabView eq 1}"> class="on" </c:if> ><a href="#">나의강의</a></li>
									<li id="tabMenu2" <c:if test="${tabView eq 2}"> class="on" </c:if> ><a href="#">수강신청</a></li>																		
								</ul>
							</div>
							<div class="guestcnt2" <c:if test="${tabView eq 2}"> style="display:none;" </c:if>>
								<c:import url="./lecture_user_list.jsp"></c:import>
							</div>
							<div class="guestcnt2"  <c:if test="${tabView eq 1}"> style="display:none;" </c:if>>
								<c:import url="./lecture_process_user.jsp"></c:import>																	
							</div>												
						</div>
					</div>					
					<!-- 탭 메뉴 끝 -->
