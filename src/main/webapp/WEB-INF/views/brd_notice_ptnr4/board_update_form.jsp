		...
		$(document).ready(function(){
			...
			$(".fileDelBtn").click(function(){
				...
				if(tmp == false){
					...
					$.post("./noticePtnr4BoardFileDelete",
				...
				<div class="centercnt_bot1-2">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" name="uploadForm" action="./noticePtnr4BoardUpdate" method="post" enctype="multipart/form-data">
							...
							<p style="text-align:center;margin-top:10px;">
								...
								<a href="./noticePtnr4BoardDetail?insu=${boardDetail.ptnr_id}&boardNo=${boardDetail.board_no}&boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&reqPgNo=${reqPgNo}"><img src="./resources/ls_img/ls_board/btn_write_cancel.gif" /></a>
							</p>
						</div>
					</div>
				</div>
