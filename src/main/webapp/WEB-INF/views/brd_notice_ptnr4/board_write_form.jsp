				...
				<div class="centercnt_bot1-2">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" name="uploadForm" action="./noticePtnr4BoardWrite" method="post" enctype="multipart/form-data">
							...
							<p style="text-align:center;margin-top:10px;">
								...
								<a href="./noticePtnr4BoardList?insu=${insu}"><img src="./resources/ls_img/ls_board/btn_write_cancel.gif" /></a>
							</p>
						</div>
					</div>
				</div>
