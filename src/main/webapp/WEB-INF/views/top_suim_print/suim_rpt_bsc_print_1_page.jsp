...
<!-- 								<img src="https://www.toplac.co.kr/resources/ls_img/report/sign_report.jpg" width="300" height="80" border="0"> -->
				...
				<c:forEach items="${suimRptImgPrint_1List}" var="attachPrint1ImgVo">
					<div align="center" style=" padding-top:10px; " >
					 	<img src='https://www.toplac.co.kr/home/hosting_users/toplac/www${attachPrint1ImgVo.filePath}${attachPrint1ImgVo.imgName}' id ='print1ImgStream_${attachPrint1ImgVo.serialNo}' width='300' height='225' style='vertical-align:middle;' />
					 	<br />${attachPrint1ImgVo.imgMemo}
					</div>
				</c:forEach>
			</td>
		</tr>
