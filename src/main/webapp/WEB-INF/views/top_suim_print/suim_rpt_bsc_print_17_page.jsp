...
<!-- 								<img src="https://www.toplac.co.kr/resources/ls_img/report/sign_report.jpg" width="300" height="80" border="0"> -->
				...
				<div id = "print17ContentsDivId" style="display:none;">
					...
					<!-- 과거력 시작 -->
					<table cellpadding="0" width="640" cellspacing="0"  align="center" id = "print17_2aTable" style="display:none;">
						<tr>
					...
					<!-- 2대질병 시작 -->
					<table cellpadding="0" width="640" cellspacing="0"  align="center" id = "print17_2bTable" style="display:none;">
						<tr>
							<td class="td" bgcolor="#ECECEC" width="140" >
							 	 <p align="center"><b>청구병명</b></p>
				              </td>
					...
					<!-- 암 시작 -->
					<table cellpadding="0" width="640" cellspacing="0"  align="center" id = "print17_2cTable" style="display:none;">
						<tr>
							<td class="td" bgcolor="#ECECEC" width="140" >
							 	 <p align="center"><b>청구병명</b></p>
				              </td>
					...
					<!-- 상해사망 시작 -->
					<table cellpadding="0" width="640" cellspacing="0"  align="center" id = "print17_2dTable" style="display:none;">
						<tr>
							<td class="td" bgcolor="#ECECEC" width="140" >
					...
					<!-- 일당/간병비 시작 -->
					<table cellpadding="0" width="640" cellspacing="0"  align="center" id = "print17_2eTable" style="display:none;">
						<tr>
							<td class="td" bgcolor="#ECECEC" width="140" >
							 	 <p align="center"><b>사고일시</b></p>
				              </td>
					...
					<!-- 후유장해 시작 -->
					<table cellpadding="0" width="640" cellspacing="0"  align="center" id = "print17_2fTable" style="display:none;">
						<tr>
							<td class="td" bgcolor="#ECECEC" width="140" >
							 	 <p align="center"><b>사고일시</b></p>
				              </td>
