			...
			<div class="center_cnt_1300">
				...
				<div class="center_cnt_vacation" >
					<div class="guest">
						<div class="guestTap">
							<ul>																
								<li class="on" id="mainTab" id="allCnt"><a href="#">관리자 휴직신청 내역</a></li>																
							</ul>
						</div>
						
						<div class="guestcnt8" id="allList">
							<c:import url="/leaveManagerAll" ></c:import>
						</div>
						...
						<script>
							$(document).ready(function(){								
								$("#approval-all-btn-search").click(function(){				
									$("#searchFrm").attr("action","leaveManager");
									searchFrm.submit();
								});
							});
							...
							function openDetailView(serial_no){
								...
								var url = "/leaveDetailManagerModal";		//상세내역페이지
