...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
	...
	<form id="vacationActionFrm">
		...
		<input type="hidden" id="approval_now_val" name="approval_now_val" value="${leaveInfo.approvaler_now}"/>		
		<!-- 신규 파라미터 끝 -->				
				...
				<table class="vacation-ins-table">
					...
					<tbody>						
						...
						<tr>
							...
							<td colspan="2">${leaveInfo.user_name}</td>
						...
						<tr>
							...
							<td colspan="2"><font color="blue">${leaveInfo.approvaler_now_name}</font></td>							
	...
	<script>
	    ...
	    function fnLeaveApprovalNowUpdate(){
			
			var sUrl = "updateLeaveApprovalNow";
			var param = {};
