			...
			<div class="center_cnt2">
				...
				<div class="centercnt_bot2">
					<div class="guest">
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">세금계산서</a></li>
								<li><a href="#">보험사별 합계</a></li>
							</ul>
						</div>

						<div class="guestcnt2" style="display:block;">
							<c:import url="../top_rpt_inv/top_rpt_tax_search.jsp"></c:import>
						</div>						
						<div class="guestcnt2" style="display:none;">
							<c:import url="../top_rpt_inv/top_rpt_tax_summary.jsp"></c:import>
						</div>
					</div>
				</div>
				<!-- //centercnt_bot -->
