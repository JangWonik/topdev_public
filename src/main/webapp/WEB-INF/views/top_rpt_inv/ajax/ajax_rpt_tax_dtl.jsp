				...
				<c:when test="${taxList.size() == 0}">
					<tr>								
						...
						<td style="text-align: right;padding-right:5px;">
							...
							<input type="text" id="publish_amount" name="publish_amount" value="0" class="amt" ONKEYUP="javascript:numberCommaFunc(this);" style="text-align:right;padding-right:5px;" class="amt" /> 원
						</td>						
						...
						<td style="text-align: right;padding-right:5px;">
							...
							<input type="text" id="deposit_amount" name="deposit_amount" value="0" class="amt" ONKEYUP="javascript:numberCommaFunc(this);" style="text-align:right;padding-right:5px;" class="amt" /> 원
							</td>
						<td></td>						
					</tr>
				</c:when>
