				...
				<div class="centercnt_bot1-3">
					<div class="guest">
						...
						<div class="guestcnt5" style="display:block;">
							<c:import url="../top_suim_suit12/top_suim_suit12_dtl_bsc.jsp"></c:import>
							<br>
							<c:import url="../top_suim_suit12/top_suim_suit12_dtl_bld.jsp"></c:import>
							<br>
							<c:import url="../top_suim_suit12/top_suim_suit12_dtl_oj.jsp"></c:import>
						</div><!-- //guestcnt5 -->
