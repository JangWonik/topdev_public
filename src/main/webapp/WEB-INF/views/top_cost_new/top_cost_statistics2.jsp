...
<div class="tableStyle2" id="dataTable">
    ...
    <div style="height:570px; overflow-x: hidden; overflow-y: auto;">
        <table cellpadding="0" cellspacing="0" width="1060" align="center" <c:if test="${srchArg.excelYN == 'Y'}">border="1"</c:if>>
            ...
            <tbody>
            <c:forEach var="vo" items="${getTCStmAdd0}" varStatus="status">
                <tr onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
                    <c:if test="${status.index == 0}">
                        <td rowspan="${getTCStmAdd0.size()}">총괄</td>
                    </c:if>
                    <td>
                    	<c:choose>
            ...
            <c:forEach var="vo" items="${getTCStmAdd1}" varStatus="status">
                <tr onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
                    <c:if test="${status.index == 0}">
                        <td rowspan="${getTCStmAdd1.size()}">1종</td>
                    </c:if>
                    <td>
                    	<c:choose>
                    		<c:when test="${srchArg.excelYN == 'Y'}">
            ...
            <c:forEach var="vo" items="${getTCStmAdd4}" varStatus="status">
                <tr onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
                    <c:if test="${status.index == 0}">
                        <td rowspan="${getTCStmAdd4.size()}">4종</td>
                    </c:if>
                    <td>
                    	<c:choose>
                    		<c:when test="${srchArg.excelYN == 'Y'}">
                    		...
                    		<c:otherwise>
                    			<p><a href="javascript:goTCSTmMbr3('${vo.team_id}','${vo.team_name}','${vo.team_type}');">${vo.getTeam_name()}</a></p>
                    		</c:otherwise>
                    	</c:choose>   
                    </td>
                    <td><fmt:formatNumber value="${vo.cash11 + vo.card11}" pattern="#,##0.##"/></td>
