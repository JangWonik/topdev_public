        ...
        <table cellpadding="0" cellspacing="0" width="1060" align="center" <c:if test="${srchArg.excelYN == 'Y'}">border="1"</c:if>>
            ...
            <c:forEach var="vo" items="${getTCStm0}" varStatus="status">
                <tr onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
                    ...
                    <td><fmt:formatNumber value="${vo.addCashSum + vo.addCardSum}" pattern="#,##0.##"/></td>
                    <td><fmt:formatNumber value="${vo.claimCashSum + vo.claimCardSum}" pattern="#,##0.##"/></td>
                    ...
                    <c:set var="sum0_add_cashSum" value="${sum0_add_cashSum + vo.addCashSum}" />
                    <c:set var="sum0_claim_cashSum" value="${sum0_claim_cashSum + vo.claimCashSum}" />
                    ...
                    <c:set var="sum0_add_cardSum" value="${sum0_add_cardSum + vo.addCardSum}" />
                    <c:set var="sum0_claim_cardSum" value="${sum0_claim_cardSum + vo.claimCardSum}" />
                </tr>
            </c:forEach>
            <tr bgcolor="#E7ECF1">
                <td colspan="2">카드</td>
                ...
                <td><fmt:formatNumber value="${sum0_add_cardSum}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sum0_claim_cardSum}" pattern="#,##0.##"/></td>
            </tr>
            <tr bgcolor="#E7ECF1">
                <td colspan="2">현금</td>
                ...
                <td><fmt:formatNumber value="${sum0_add_cashSum}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sum0_claim_cashSum}" pattern="#,##0.##"/></td>
            </tr>
            <tr bgcolor="#E7ECF1">
                <td colspan="2">소계</td>
                ...
                <td><fmt:formatNumber value="${sum0_add_cashSum+sum0_add_cardSum}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sum0_claim_cashSum+sum0_claim_cardSum}" pattern="#,##0.##"/></td>
            </tr>
            <c:forEach var="vo" items="${getTCStm1}" varStatus="status">
                <tr onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
                    ...
                    <c:set var="sum1_add_cashSum" value="${sum1_add_cashSum + vo.addCashSum}" />
                    <c:set var="sum1_claim_cashSum" value="${sum1_claim_cashSum + vo.claimCashSum}" />
                    ...
                    <c:set var="sum1_add_cardSum" value="${sum1_add_cardSum + vo.addCardSum}" />
                    <c:set var="sum1_claim_cardSum" value="${sum1_claim_cardSum + vo.claimCardSum}" />
                </tr>
            </c:forEach>
            <tr bgcolor="#E7ECF1">
                <td colspan="2">카드</td>
                ...
                <td><fmt:formatNumber value="${sum1_add_cardSum}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sum1_claim_cardSum}" pattern="#,##0.##"/></td>
            </tr>
            <tr bgcolor="#E7ECF1">
                <td colspan="2">현금</td>
                ...
                <td><fmt:formatNumber value="${sum1_add_cashSum}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sum1_claim_cashSum}" pattern="#,##0.##"/></td>
            </tr>
            <tr bgcolor="#E7ECF1">
                <td colspan="2">소계</td>
                ...
                <td><fmt:formatNumber value="${sum1_add_cashSum+sum1_add_cardSum}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sum1_claim_cashSum+sum1_claim_cardSum}" pattern="#,##0.##"/></td>
            </tr>
            <c:forEach var="vo" items="${getTCStm4}" varStatus="status">
                <tr onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
                    ...
                    <c:set var="sum4_add_cashSum" value="${sum1_add_cashSum + vo.addCashSum}" />
                    <c:set var="sum4_claim_cashSum" value="${sum1_claim_cashSum + vo.claimCashSum}" />
                    ...
                    <c:set var="sum4_add_cardSum" value="${sum1_add_cardSum + vo.addCardSum}" />
                    <c:set var="sum4_claim_cardSum" value="${sum1_claim_cardSum + vo.claimCardSum}" />
                </tr>
            </c:forEach>
            <tr bgcolor="#E7ECF1">
                <td colspan="2">카드</td>
                ...
                <td><fmt:formatNumber value="${sum4_add_cardSum}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sum4_claim_cardSum}" pattern="#,##0.##"/></td>
            </tr>
            <tr bgcolor="#E7ECF1">
                <td colspan="2">현금</td>
                ...
                <td><fmt:formatNumber value="${sum4_add_cashSum}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sum4_claim_cashSum}" pattern="#,##0.##"/></td>
            </tr>
            <tr bgcolor="#E7ECF1">
                <td colspan="2">소계</td>
                ...
                <td><fmt:formatNumber value="${sum4_add_cashSum+sum4_add_cardSum}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sum4_claim_cashSum+sum4_claim_cardSum}" pattern="#,##0.##"/></td>
            </tr>
            <tr bgcolor="#E7ECF1">
                <td colspan="2">합계</td>
                ...
                <td><fmt:formatNumber value="${sum0_add_cashSum+sum0_add_cardSum +sum1_add_cashSum+sum1_add_cardSum +sum4_add_cashSum+sum4_add_cardSum}" pattern="#,##0.##"/></td>
                <td><fmt:formatNumber value="${sum0_claim_cashSum+sum0_claim_cardSum +sum1_claim_cashSum+sum1_claim_cardSum +sum4_claim_cashSum+sum4_claim_cardSum}" pattern="#,##0.##"/></td>
            </tr>
            </tbody>
        </table>
    </div>
