				...
				<div class="centercnt_bot1-2">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" name="uploadForm" action="./supportTopBoardWrite" method="post" enctype="multipart/form-data">
								<div class="tableStyle2">
									<table>
										<tr>
											...
											<td width="15%" bgcolor="#e7ecf1">중요 글 설정</td>
											<td style="text-align:left;padding-left:7px;">
												<select id="best_flag" name="best_flag" style="width:95%;">
										...
										<tr>
											...
											<td colspan="3" style="text-align:left;padding-left:7px;"><input type="text" id="title" name="title" value="${boardWriteFailVO.title}" style="width:98%;"></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td  colspan="3" id="addFileFormDiv"></td>
										</tr>
									</table>
								</div>
							</form>							
							<p style="text-align:right;margin-top:10px;">
								...
								<a href="./supportTopBoardList" class="btn-vacation-aprv" style="background:#F6CED8;">취소</a>								
							</p>
						</div>
					</div>
				</div>
