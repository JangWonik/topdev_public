...
<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
	...
	<table>
		<tbody>		
			<tr>
				<th width="10%">교육과정 명</th>
				<td width="50%">${eduInfo.file_name}</td>
				<th width="10%">강사명</th>
				<td width="10%">${eduInfo.teacher_name}</td>
				<th width="10%">등록일</th>
	...
	<table>
		<tr>
			<td>
				...
				<div id="cover" style="position:absolute;top:64px;z-index:9999;background-color:#00FF0000;width:100%;height:705px;">
