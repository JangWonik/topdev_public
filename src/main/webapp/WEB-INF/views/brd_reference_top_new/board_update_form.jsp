		...
		$(document).ready(function(){
			...
			$(".fileDelBtn").click(function(){
				...
				if(tmp == false){
					...
					$.post("./referenceTopBoardFileDelete",
				...
				<div class="centercnt_bot1-2">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" name="uploadForm" action="./referenceTopBoardUpdate" method="post" enctype="multipart/form-data">
							...
							<p style="text-align:right;margin-top:10px;">								
								...
								<a href="./referenceTopBoardDetailNew?boardNo=${boardDetail.board_no}&cateSearch=${searchVO.cateSearch}&boardSrcWord=${searchVO.boardSrcWord}&reqPgNo=${reqPgNoInt1}" class="btn-vacation-aprv" style="background:#F6CED8;">취소</a>
							</p>
						</div>
					</div>
				</div>
