				...
				<div class="centercnt_bot1-2">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" name="uploadForm" action="./referenceTopBoardWrite" method="post" enctype="multipart/form-data">
							...
							<p style="text-align:right;margin-top:10px;">
								...
								<a href="./referenceTopBoardListNew?cateSearch=${searchVO.cateSearch}" class="btn-vacation-aprv" style="background:#F6CED8;">취소</a>								
							</p>
						</div>
					</div>
				</div>
