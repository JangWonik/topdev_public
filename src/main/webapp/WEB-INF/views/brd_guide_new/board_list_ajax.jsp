			...
			<c:otherwise>
				...
				<tr>
					...
					<td width="50%" style="text-align:left;padding-left:10px;letter-spacing:0px;">
						...
						<a href="./brd_guide_view?guide_no=${brd.board_no}&boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&titleSearch=${searchVO.titleSearch}&reqPgNo=${reqPgNoInt1}">
							<c:choose>
					...
					<td width="5%">
						<c:choose>
							<c:when test="${brd.file_cnt eq 1}">
								<a href="brd_guide_file_down?file_no=${brd.board_file_no}" title="바로다운로드">								
