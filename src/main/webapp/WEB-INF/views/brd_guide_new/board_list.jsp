							...
							<table>
								...
								<tr>	
									...
									<td style="text-align:right;padding-right:5px;">
										<form method="get" name="boardSrcForm" id="boardSrcForm" action="./brdGuideBoardList">
											...
											&nbsp;<a href="./brd_guide_write" class="btn-vacation-aprv" id="boardSrcAddBtn" style="background:#CEE3F6;">등록</a>
											</c:if>
										</form>							
									</td>
								</tr>
