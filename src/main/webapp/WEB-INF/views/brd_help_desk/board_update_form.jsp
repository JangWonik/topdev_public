				...
				<div class="centercnt_bot1-2">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" name="uploadForm" action="./helpDeskBoardUpdate" method="post" enctype="multipart/form-data">
								...
								<div class="tableStyle21">
									<table>
										...
										<tr>
											...
											<td colspan="7"><input type="text" id="title" name="title" value="${boardDetail.title}" style="width:100%;"></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td id="addFileFormDiv" colspan="7"></td>
										</tr>
									</table>
								</div>
							</form>
							<p style="text-align:center;margin-top:10px;">
								...
								<a href="./helpDeskBoardDetail?boardNo=${boardDetail.board_no}&boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&reqPgNo=${reqPgNo}"><img src="./resources/ls_img/ls_board/btn_write_cancel.gif" /></a>
							</p>
						</div>
					</div>
				</div>
