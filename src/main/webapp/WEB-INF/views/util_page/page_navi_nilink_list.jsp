...
<ul class="pagination no-margin">
    <c:choose>
        ...
        <c:otherwise>
            <li><a href="#" onclick="fnGoNilinkPage(${firstIdx});">처음</a></li>
            <li><a href="#" onclick="fnGoNilinkPage(${prevIdx});">이전</a></li>
        </c:otherwise>
    </c:choose>
    <c:forEach var="idx" begin="${beginIdx}" end="${endIdx}">
        <c:choose>
            ...
            <c:otherwise>
                <li><a href="#" onclick="fnGoNilinkPage(${idx})"><c:out value="${idx}" /></a></li>
            </c:otherwise>
        </c:choose>
    </c:forEach>
    <c:choose>
        ...
        <c:otherwise>
            <li><a href="#" onclick="fnGoNilinkPage(${nextIdx})">다음</a></li>
            <li><a href="#" onclick="fnGoNilinkPage(${lastIdx})">마지막</a></li>
        </c:otherwise>
    </c:choose>
</ul>
