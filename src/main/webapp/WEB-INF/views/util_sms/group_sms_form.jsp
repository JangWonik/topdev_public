...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="IE=10,chrome=1,FF=3,otherUA=4" />
...
<body bgcolor="white" text="black" link="blue" vlink="purple" alink="red">
	...
	<div id="headerpop">
		<div class="inner clear_v2">
			...
			<div style="text-align:center;padding-top:10px;"><img src="./resources/ls_img/dotte.gif" width="9" height="9" border="0">
				<font color="white"><b><span style="font-size:11pt;"> SMS 전송</span></b></font>
			</div>
		</div>
	</div>
	<!-- //header -->
	...
	<div style="margin:10px 5px 10px 5px;">
		...
		<!-- contents body -->
		<c:import url="../util_sms/import_gsms_form.jsp"></c:import>
		<!-- //contents body -->
