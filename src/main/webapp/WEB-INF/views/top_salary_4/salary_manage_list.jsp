				...
				<div class="center_cnt_vacation" >
					...
					<div class="centercnt_bot2" style="margin:0 auto;">
						<div class="guest">
							<div class="guestTap">
								<ul>
									<li id="tabMenu1" class="on"><a href="#">기본급 설정 관리</a></li>
									<li id="tabMenu2"><a href="#">예외자 설정 관리</a></li>
									<!-- <li id="tabMenu3"><a href="#">교육분류관리</a></li>
									<li id="tabMenu3"><a href="#">교육테스트관리</a></li> -->
								</ul>
							</div>								
							<div class="guestcnt2">									
									<c:import url="./salary_setup_manage.jsp"></c:import>
							</div>
							<div class="guestcnt2" style="display:none;">
									<c:import url="./salary_except_manage.jsp"></c:import>
							</div>
							<%-- <div class="guestcnt2" style="display:none;">
