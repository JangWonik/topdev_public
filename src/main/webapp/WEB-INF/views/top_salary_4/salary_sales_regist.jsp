...
<head>
	...
	$(document).ready(function(){
		...
		$("#yearprev").click(function(){
	        ...
	        $("#sales_date_text").text(imsiyeartxt+"-01-31");
        	...
        	$("#result_sales_date").val(imsiyeartxt+"-01-31");
	        $("#result_sales_date_text").text(imsiyeartxt+"-01-31");
	        
        	$("#result_chk_sdate").val($("#yeartxt").text()+"-12-01");
        	$("#result_chk_edate").val($("#yeartxt").text()+"-12-31");
        	doSalesResultSearch();
	    });
	    ...
	    $(".monthbtn").click(function(){	    	
	    	...
	    	if(imsiMonthStartStr.length > 2) imsiMonthStartStr = imsiMonthStartStr.substring(1, imsiMonthStartStr.length);
	        	...
	        	$("#result_chk_sdate").val($("#yeartxt").text()+"-"+imsiMonthStartStr +"-"+ "01");
	        	//스크립트로 마지막 날 구하기
	        	var lastDay = new Date( $("#yeartxt").text(), imsiMonthStart, 0 );
	        	$("#chk_edate").val($("#yeartxt").text()+"-"+imsiMonthStartStr+"-"+ lastDay.getDate());
	        	$("#result_chk_edate").val($("#yeartxt").text()+"-"+imsiMonthStartStr+"-"+ lastDay.getDate());
	        	
	        	lastDay = new Date( $("#yeartxt").text(), imsimonth, 0 );
	        	$("#sales_date").val( $("#yeartxt").text()+"-"+imsimonth+"-"+lastDay.getDate() );
	        	$("#sales_date_text").text( $("#yeartxt").text()+"-"+imsimonth+"-"+lastDay.getDate() );
	        	
	        	$("#result_sales_date").val( $("#yeartxt").text()+"-"+imsimonth+"-"+lastDay.getDate() );
	        	$("#result_sales_date_text").text( $("#yeartxt").text()+"-"+imsimonth+"-"+lastDay.getDate() );
	        ...
	        if(imsimonth == 1){	        	
	        	...
	        	$("#sales_date_text").text( $("#yeartxt").text()+"-01-31");
	        	
	        	$("#result_chk_sdate").val(($("#yeartxt").text()-1)+"-"+"12" +"-"+ "01");
	        	$("#result_chk_edate").val(($("#yeartxt").text()-1)+"-"+"12" +"-"+ "31");	        	
	        	
	        	$("#result_sales_date").val( $("#yeartxt").text()+"-01-31" );
	        	$("#result_sales_date_text").text( $("#yeartxt").text()+"-01-31");
	        }	        
	        doSalesSearch();
				...
				<div class="center_cnt_vacation" >
					<div class="guest">
						<div style="float: left;padding:10px 0 10px;">
							...
							<a id="yeartxt" href="#">${srchParam.sales_date.substring(0,4)}</a>
					...
					<div class="centercnt_bot2" style="margin:0 auto;">
						<div class="guest">
							<div class="guestTap">
								<ul>
									<li id="tabMenu1" class="on"><a href="#">성과급 실적등록</a></li>
									<li id="tabMenu2"><a href="#">실적조회 및 취소</a></li>									
								</ul>
							</div>								
							<div class="guestcnt2">
								<c:import url="./salary_sales_regist_list.jsp"></c:import>
							</div>
							<div class="guestcnt2" style="display:none;">
									<c:import url="./salary_sales_regist_result_list.jsp"></c:import>
							</div>
							</div>
						</div>
					</div>					
