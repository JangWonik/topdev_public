							...
							if(data.length == 0){
			                    ...
			                    $.each(data, function(index, entry) {
	                        		...
	                        		$("#selectBtn"+index).bind("click",function(){
	                        			popSelect(entry.user_no, entry.user_name, entry.team_id_main);
	                        		});
								});//each
							}
						}else{
				...
				<tbody>
					<tr>
						...
						<td style="text-align:center;">
							...
							<input type="text" id="searchStr" name="searchStr" size="25" style="ime-mode:active"  onKeydown="javascript:memberSearchBtnClick();" />
						</td>
						<td width="20%">
