...
<script>
	...
	<b>${toAccumYear}년 ${toMonthInt}월</b></font> ${team_name}&nbsp;보험사별 수임 현황
	</div>
	...
	<form name="datef" method="POST" action="./reg_team_ig"> 
	...
	<br>
	<form action="./reg_team_ig_excel" method="POST" id="excelform">
