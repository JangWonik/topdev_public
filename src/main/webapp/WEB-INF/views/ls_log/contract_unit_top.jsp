...
<script>
	...
	<b>${toAccumYear}년 ${toMonthInt}월</b></font> 개인별 적부심사(삼성) 통계
	</div>
	...
	<form name="datef" method="POST" action="./contract_unit"> 
	<!-- 달력 From -->
	...
	<br>
	<form action="./contract_unit_excel" method="POST" id="excelform">
