...
<script>
	...
	<b>${toAccumYear}년 ${toMonthInt}월</b></font> ${team_name} 개인별 처리내용
	</div>
	...
	<form name="datef" method="POST" action="./result_member"> 
	...
	<br>
	<form action="./result_member_excel" method="POST" id="excelform">
