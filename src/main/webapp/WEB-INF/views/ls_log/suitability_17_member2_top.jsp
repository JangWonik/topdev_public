...
<script>
	$(document).ready(function(){
	    ...
	    $(".monthbtn").click(function(){
	        ...
	        /* if(imsimonth == 1){
	        	...
	        	$("#selectorFrom").val(($("#yeartxt").text()-1)+"-"+"12" +"-"+ "01");
	        } */
		    datef.submit();
	    });//monthbtn.click
	});//$(document).ready
	...
	<b>${toAccumYear}년 ${toMonthInt}월 </b></font> ${team_name} 개인별 적부심사(흥국) 통계
	</div>
	...
	<form name="datef" method="POST" action="./suitability_17_member2"> 
	...
	<br>
	<form action="./contract_member_excel" method="POST" id="excelform">
