...
<c:set var="ig_nick" value="${ig_nick}" />
				...
				<div class="centercnt_bot2">
					<div class="guest">
						<div class="guestTap">
							<ul>
									<li class="on"><a>${toMonthInt}월 팀별 수임현황</a></li>
							</ul>
						</div>
	...
	<tbody>
		<td class="td" bgcolor="#F8F8F8" rowspan="${kind1regList.size() + 1}">
			<b>1종</b>
		</td>
	...
	<tr onMouseOver=this.style.backgroundColor="#FFECEC" onMouseOut=this.style.backgroundColor="">
		...
		<td>
			<a href="./reg_member?ig_id=${ig_id}&ig_nick=${ig_nick}&team_id=${vo.getTeam_id()}&team_name=${vo.getTeam_name()}&year=${toAccumYear}&month=${month+monthPlusInt}&fromdate=${fromdate}&todate=${todate}">
			<c:set var="monthPlusInt" value="${monthPlusInt+1}" />
			개인별
			</a>
		</td>
		<td>
			<a href="./reg_team_ig?team_id=${vo.getTeam_id()}&team_name=${vo.getTeam_name()}&year=${toAccumYear}&month=${month+monthPlusInt}&fromdate=${fromdate}&todate=${todate}">
			<c:set var="monthPlusInt" value="${monthPlusInt+1}" />
			보험사별
			</a>
		</td>
		...
		<%-- <td class="td">
			<p align="center"><a href="?page=reg_ig_team&ig_id=<?=$row[ig_id]?>&s_day1=<?=$s_day1?>&s_day2=<?=$s_day2?>"><nobr></nobr></a></p>
		</td> --%>
	...
	<tr>
		<td class="td" bgcolor="#EFEFEF" colspan="4">
			<b>소계</b>
		</td>
		<td class="td" bgcolor="#EFEFEF">
	...
	<tbody>
	<tbody>
		<td class="td" bgcolor="#F8F8F8" rowspan="${kind4regList.size() + 1}">
			<b>4종</b>
		</td>
		<c:forEach var="vot" items="${kind4regList}" varStatus="status">
	<tr onMouseOver=this.style.backgroundColor="#FFECEC" onMouseOut=this.style.backgroundColor="">
		<td>
			<a href="./reg_ig_member?ig_id=${ig_id}&ig_nick=${ig_nick}&team_id=${vot.getTeam_id()}&team_name=${vot.getTeam_name()}&year=${toAccumYear}&month=${month+monthPlusInt}&fromdate=${fromdate}&todate=${todate}">
			<c:set var="monthPlusInt" value="${monthPlusInt+1}" />
	...
	<tbody>
	<tr>
		<td class="td" bgcolor="#F8F8F8" colspan="4">
			<p align="center"><b>합계</b></p>
		</td>
