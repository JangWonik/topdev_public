...
<script>
	...
	<b>${toAccumYear}년 ${toMonthInt}월</b></font> ${ig_nick}&nbsp;${team_name}&nbsp;수임 현황
	</div>
	...
	<form name="datef" method="POST" action="./reg_ig_member"> 
	...
	<br>
	<form action="./reg_ig_member_excel" method="POST" id="excelform">
