...
<script>
	...
	<b>${year}년 <c:if test="${month < 10}">0${month}</c:if>월</b></font> 보험사별 수임 및 종결현황
	</div>
	...
	<form name="datef" method="POST" action="./reg_ig_month"> 
	<!-- 달력 From -->
	&nbsp&nbsp&nbsp&nbsp&nbsp
	<input type="hidden" id="selectorFrom1" name="viewFromDate" size="10" value="${fromdate}" maxlength="10" /> <!-- id="selectorFrom" -->
	<!-- <font color="#0066CC">부터&nbsp&nbsp&nbsp</font> -->
	<!-- 달력 To -->
	<input type="hidden" id="selectorTo1" name="viewToDate" size="10"  value="${todate}" maxlength="10" />  <!-- id="selectorTo" -->
	...
	<br>
	<form action="./reg_ig_excel" method="POST" id="excelform">
