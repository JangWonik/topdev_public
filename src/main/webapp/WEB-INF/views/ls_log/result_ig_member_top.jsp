...
<script>
	...
	<b>${toAccumYear}년 ${toMonthInt}월</b></font> ${ig_nick} ${team_name}개인별 처리내용
	</div>
	...
	<form name="datef" method="POST" action="./result_ig_member"> 
	...
	<br>
	<form action="./result_ig_team_excel" method="POST" id="excelform">
