...
<c:set var="kind4regList" value="${kind4regList}" />
	...
	<tr onMouseOver=this.style.backgroundColor="#FFECEC" onMouseOut=this.style.backgroundColor="">
		<td>
			<a href="./reg_ig_team?ig_id=${vo.getIg_id()}&ig_nick=${vo.getIg_nick()}&year=${toAccumYear}&month=${toMonthInt+monthPlusInt}&fromdate=${fromdate}&todate=${todate}">
		...
		<td>
			<a href="./reg_ig_month?year=${toAccumYear}&month=${toMonthInt}">
			<c:set var="monthPlusInt" value="${monthPlusInt+1}" />
		...
		<td>
			<a href="./reg_ig_month?ig_id=${vo.getIg_id()}&year=${toAccumYear}&month=${toMonthInt+monthPlusInt}">
			<c:set var="monthPlusInt" value="${monthPlusInt+1}" />
