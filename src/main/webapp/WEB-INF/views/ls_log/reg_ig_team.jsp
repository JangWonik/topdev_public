...
<c:set var="ig_nick" value="${ig_nick}" />
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							<%@ include file="reg_ig_team_top.jsp" %>
						</div>
					</div>
				</div>
	...
	<tr onMouseOver=this.style.backgroundColor="#FFECEC" onMouseOut=this.style.backgroundColor="">
		<td>
			<a href="./reg_ig_member?ig_id=${ig_id}&ig_nick=${ig_nick}&team_id=${vo.getTeam_id()}&team_name=${vo.getTeam_name()}&year=${toAccumYear}&month=${month+monthPlusInt}&fromdate=${fromdate}&todate=${todate}">
