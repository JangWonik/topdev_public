...
<c:set var="Suit12_sum4" value="${Suit12_sum4}" />
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							<%@ include file="suitability_12_team_top.jsp" %>
						</div>
					</div>
				</div>
				...
				<div class="centercnt_bot2">
					<div class="guest">
						<div class="guestTap">
							<ul>
									<li class="on"><a>${toMonthInt}월 팀별 적부심사(한화)</a></li>
							</ul>
						</div>
				...
				<tbody>
					...
					<c:forEach var="vo" items="${Suit12_1List}" varStatus="status">
				<tr onMouseOver=this.style.backgroundColor="#FFECEC" onMouseOut=this.style.backgroundColor="">
					<c:if test="${status.index == 0}">
						<td class="td" bgcolor="#F8F8F8" rowspan="${Suit12_1List.size()}">
							<c:out value="1종" />
						</td>
					</c:if>
					<td>
						<a href="./suitability_12_member?team_id=${vo.getTeam_id()}&team_name=${vo.getTeam_name()}&ViewFromDate=${fromdate}&ViewToDate=${todate}">
				...
				<tr>
					...
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum1.getSum_reg_m()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum1.getSum_reg_y()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum1.getSum_endok_m()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum1.getSum_endok_y()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum1.getSum_endno_m()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum1.getSum_endno_y()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum1.getSum_end_sum_m()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum1.getSum_end_sum_y()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum1.getSum_rid_mi()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<fmt:formatNumber value="${Suit12_sum1.getSum_price_g()}" pattern="#,##0.##"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<fmt:formatNumber value="${Suit12_sum1.getSum_price_f()}" pattern="#,##0.##"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<fmt:formatNumber value="${Suit12_sum1.getSum_price_sum()}" pattern="#,##0.##"/>
					</td>
			...
			<tbody>
					...
					<c:forEach var="vot" items="${Suit12_4List}" varStatus="status">
				<tr onMouseOver=this.style.backgroundColor="#FFECEC" onMouseOut=this.style.backgroundColor="">
					<c:if test="${status.index == 0}">
						<td class="td" bgcolor="#F8F8F8" rowspan="${Suit12_4List.size()}">
							<c:out value="4종" />
						</td>
					</c:if>
					<td>
						<a href="./suitability_12_member?team_id=${vot.getTeam_id()}&team_name=${vo.getTeam_name()}&ViewFromDate=${fromdate}&ViewToDate=${todate}">
				...
				<tr>
					...
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum4.getSum_reg_m()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum4.getSum_reg_y()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum4.getSum_endok_m()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum4.getSum_endok_y()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum4.getSum_endno_m()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum4.getSum_endno_y()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum4.getSum_end_sum_m()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum4.getSum_end_sum_y()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<c:out value="${Suit12_sum4.getSum_rid_mi()}"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<fmt:formatNumber value="${Suit12_sum4.getSum_price_g()}" pattern="#,##0.##"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<fmt:formatNumber value="${Suit12_sum4.getSum_price_f()}" pattern="#,##0.##"/>
					</td>
					<td class="td" bgcolor="#EFEFEF">
						<fmt:formatNumber value="${Suit12_sum4.getSum_price_sum()}" pattern="#,##0.##"/>
					</td>
				...
				<tr>
					...
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<c:out value="${Suit12_sum14.getSum_reg_m()}"/>
						</font>
					</td>
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<c:out value="${Suit12_sum14.getSum_reg_y()}"/>
						</font>
					</td>
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<c:out value="${Suit12_sum14.getSum_endok_m()}"/>
						</font>
					</td>
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<c:out value="${Suit12_sum14.getSum_endok_y()}"/>
						</font>
					</td>
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<c:out value="${Suit12_sum14.getSum_endno_m()}"/>
						</font>
					</td>
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<c:out value="${Suit12_sum14.getSum_endno_y()}"/>
						</font>
					</td>
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<c:out value="${Suit12_sum14.getSum_end_sum_m()}"/>
						</font>
					</td>
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<c:out value="${Suit12_sum14.getSum_end_sum_y()}"/>
						</font>
					</td>
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<c:out value="${Suit12_sum14.getSum_rid_mi()}"/>
						</font>
					</td>
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<fmt:formatNumber value="${Suit12_sum14.getSum_price_g()}" pattern="#,##0.##"/>
						</font>
					</td>
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<fmt:formatNumber value="${Suit12_sum14.getSum_price_f()}" pattern="#,##0.##"/>
						</font>
					</td>
					<td class="td" bgcolor="#F8F8F8"><font color="red">
						<fmt:formatNumber value="${Suit12_sum14.getSum_price_sum()}" pattern="#,##0.##"/>
						</font>
					</td>
