...
<c:set var="Suit_M2List" value="${Suit_M2List}" />
				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							<%@ include file="suitability_12_member2_top.jsp" %>
						</div>
					</div>
				</div>
				...
				<tbody>
					...
					<c:forEach var="vo" items="${Suit12_M2List}" varStatus="status">
				<tr onMouseOver=this.style.backgroundColor="#FFECEC" onMouseOut=this.style.backgroundColor="">
					...
					<td>
						<c:if test="${vo.getRstPptyNvCpltYn() eq 01}">
							조사완료
						</c:if>
						<c:if test="${vo.getRstPptyNvCpltYn() eq 02}">
							조사실패
						</c:if>
					</td>
