...
<script>
	...
	<b>${toAccumYear}년 ${toMonthInt}월</b></font> ${team_name}&nbsp;개인별 종결 현황
	</div>
	...
	<form name="datef" method="POST" action="./end_member"> 
	...
	<br>
	<form action="./end_member_excel" method="POST" id="excelform">
