...
<c:set var="idmemberList" value="${idmemberList}" />
							...
							<div class="tableStyle2">
								...
								<c:forEach var="vo" items="${idmemberList}" varStatus="status">
				                ...
				                <tr style="bgcolor: #E7ECF1; text-align: center;" onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">						
									...
									<td><c:out value="${summember2.getPrice_assess()}"/></td>
									<td><c:out value="${summember2.getPrice_time()}" /></td>
									<td><c:out value="${summember2.getReport_ea()}" /></td>
									<td><c:out value="${summember2.getP_price_mi_a()}" /></td>
									<td><c:out value="${summember2.getP_price_mi_b()}" /></td>
									<td><c:out value="${summember2.getReport_ea_mi()}" /></td>
									<td><c:out value="${summember2.getP_price_pl_a()}" /></td>
									<td><c:out value="${summember2.getP_price_pl_b()}" /></td>
									<td><c:out value="${summember2.getReport_ea_pl()}" /></td>
									<td><c:out value="${summember2.getSum_little()}" /></td>
									<td><c:out value="${summember2.getPrice_traffic()}" /></td>
									<td><c:out value="${summember2.getPrice_question()}" /></td>
									<td><c:out value="${summember2.getPrice_receipt()}" /></td>
									<td><c:out value="${summember2.getSum_hap()}" /></td>
								</tr>
				               </table>
							</div>
						<!-- // 자기-공동 수행 -->
						...
						<table align="center" cellpadding="0" cellspacing="0" width="990">
							...
							<table cellpadding="0" cellspacing="0" width="990" bordercolordark="white" bordercolorlight="#CCCCCC" align="center">
                                ...
                                <tbody>
                                <c:forEach var="vo" items="${mimemberList}" varStatus="status">
                                <tr style="bgcolor: #E7ECF1; text-align: center;" onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">
                               		<td>-</td>
                                ...
                                <!-- 미수금 합계 시작 -->
                                 <tr style="bgcolor: #E7ECF1; text-align: center;" onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''">						
									...
									<td><c:out value="${summimember2.getPrice_assess()}"/></td>
									<td><c:out value="${summimember2.getPrice_time()}" /></td>
									<td><c:out value="${summimember2.getPrice_traffic()}" /></td>
									<td><c:out value="${summimember2.getPrice_question()}" /></td>
									<td><c:out value="${summimember2.getPrice_receipt()}" /></td>
									<td><c:out value="${summimember2.getSum_hap()}" /></td>
								</tr>
								<!-- 미수금 합계 끝 -->
                                </tbody>
                            </table>
