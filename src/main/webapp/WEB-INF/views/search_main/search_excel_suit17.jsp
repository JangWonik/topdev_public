...
<% response.setHeader("Content-Disposition", "attachment;filename=Suit17RptSearch.xls"); %>
			...
			<table border="1">
									...
									<tbody>
										...
										style ="cursor:pointer;" onclick="popSuimSuit17Dtl('${suit17VO.suimRptNo}', '${suit17VO.delDate}')">
											<!-- no -->
											<td>${suimSuit17List.size() - status.index}</td>
											<!-- lock -->
											<td>
												<c:choose>
