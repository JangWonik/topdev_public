				...
				<div class="centercnt_bot1-2">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" name="uploadForm" action="./noticeTopBoardUpdate" method="post" enctype="multipart/form-data">
									...
									<table>
										...
										<tr>
											...
											<td colspan="5" style="text-align:left;padding-left:10px;">
												<select id="title_classify" name="title_classify" style="width:25%;">
													<c:forEach items="${titleClassifyList}" var = "titleClassifyList">
														<option value="${titleClassifyList.col_cd}"
															<c:if test="${boardDetail.title_classify == titleClassifyList.col_cd}">selected</c:if> > ${titleClassifyList.col_val} </option>
													</c:forEach>
												</select>
											</td>
										</tr>
							...
							<p style="text-align:right;margin-top:10px;">								
								...
								<a href="./noticeTopBoardDetail?boardNo=${boardDetail.board_no}&boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&titleSearch=${searchVO.titleSearch}&reqPgNo=${reqPgNo}" class="btn-vacation-aprv" style="background:#F6CED8;">취소</a>
							</p>
						</div>
					</div>
				</div>
