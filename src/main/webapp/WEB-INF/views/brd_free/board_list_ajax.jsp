			...
			<c:otherwise>
				...
				<tr>
					...
					<td width="50%" style="text-align:left;padding-left:10px;letter-spacing:0px;">
						...
						<a href="./freeBoardDetail?boardNo=${brd.board_no}&boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&reqPgNo=${reqPgNoInt1}">
							${brd.title}							
						</a>
					...
					<td width="5%">
						<c:choose>
							<c:when test="${brd.file_cnt eq 1}">
								<a href="./brdFreeFileDownload?fileNo=${brd.board_file_no}" title="바로다운로드">
