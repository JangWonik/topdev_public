...
<head>
	...
	<script>
		...
		$(document).ready(function(){
			...
			if('${boardFreeWriteFailVO}' != null && '${boardFreeWriteFailVO}' != ''){
				...
				<div class="centercnt_bot1-2">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" name="uploadForm" action="./freeBoardWrite" method="post" enctype="multipart/form-data">
								<div class="tableStyle2">
									<table>
										<tr>
											<td width="15%" bgcolor="#e7ecf1">제 목</td>
											<td><input type="text" id="title" name="title" value="${boardFreeWriteFailVO.title}" style="width:98%;"></td>
										</tr>
										<tr>
											<td bgcolor="#e7ecf1">내 용</td>
											<td>
												<textarea id="contents" name="contents" rows="15" cols="130">${boardFreeWriteFailVO.contents}</textarea>
												<script>
							...
							<p style="text-align:right;margin-top:10px;">
								...
								<a href="./freeBoardList" class="btn-vacation-aprv" style="background:#F6CED8;">취소</a>								
							</p>
						</div>
					</div>
				</div>
