...
<div id="workjob-modal-dialog" title="직무별 세부인원 조회" style="font-size: 12px;" align="center">
	<br/>
	<div class="tableStyle2" style="width: 860px;">
		<table class="vacation-ins-table">
			<tr>
				<th width="15%">구분</th>
				<td width="35%">${paramMap.modalTitle}</td>
				<th width="15%">인원수</th>
				<td width="35%">${memberModalList.size()} 명</td>
			</tr>
		</table>
		<br/>	
		<table>	
