...
<script type="text/javascript">
	...
	function addPopup(){
		...
		$("#actionType").val('add');		//actionType이 add 추가, mod 수정 del 삭제
			...
			<div class="center_cnt_1300">
				...
				<div class="center_cnt_1300_bot">
					<div class="guest">						
						...
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">DIV팝업관리(추가)</a></li>
							</ul>
						</div>
						<div class="guestcnt4" style="display:block;">
							<!-- 팝업입력폼 시작 -->
							<form name="addForm" id="addForm" method="post" action="divPopupAction">
							<input type="hidden" id="repeat_flag" name="repeat_flag" value="0"/>
							...
							<div class= "tableStyle2">
								<table>									
									<tr>
										...
										<th width="10%">시작일자</th>
										<td>
											<input name="sdate" class="classCalendar" id="sdate" style="width: 70px;" type="text">											
										</td>
										<th width="10%">종료일자</th>
										<td>
											<input name="edate" class="classCalendar" id="edate" style="width: 70px;" type="text">											
										</td>										
									</tr>
									<tr>
										<th width="10%">반복여부</th>
										<td style="text-align:left;padding-left: 10px;">
											<input type="radio" name="repeat_chk" id="repeat_day" value="0" checked> &nbsp; 매일 &nbsp;
											<input type="radio" name="repeat_chk" id="repeat_week" value="1"> &nbsp; 매주 &nbsp;
											<input type="radio" name="repeat_chk" id="repeat_month" value="2"> &nbsp; 매월 &nbsp;
											<font color="blue">
										...
										<th width="10%">사용여부</th>
										<td style="text-align:left;padding-left: 10px;">
											<input type="radio" name="is_use" value="0" checked> &nbsp; 사용안함 &nbsp;
											<input type="radio" name="is_use" value="1"> &nbsp; 로그인 전 &nbsp;
											<input type="radio" name="is_use" value="2"> &nbsp; 로그인 후 &nbsp;
										</td>
										<th width="10%">팝업크기</th>
										<td style="text-align:left;padding-left: 10px;">
											H : <input type="text" id="popup_height" name="popup_height" size="10%" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"> px, 
											W : <input type="text" id="popup_width" name="popup_width" size="10%" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"> px
										</td>										
									</tr>
									<tr>
						...
						<!-- 하단버튼시작 -->
							...
							<div style="text-align:right;float:right;">								
								...
								<input type="button" style="width:50px;" value="추가" id="popupAdd" onClick="javascript:addPopup();"/>								
							</div>
						<!-- 하단버튼끝 -->
						</div>
				</div>
