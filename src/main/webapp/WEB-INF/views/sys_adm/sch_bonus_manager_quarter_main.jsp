...
<head>
	...
	<script language="javascript">
		...
		function fnSearch(){			
			...
			$.ajax({
	 			type : "post",
	 			url : "/getSchBonusMemberQuarterListAjax",
	 			data : formData,
		...
		//엑셀다운로드
		function doDownload(){			
			$("#searchFrm").attr("action","schBonusMemberQuarterListExcel");
			$("#searchFrm").submit();
		}
		
		//직원 성과급 세부내역 조회 
		function fnMemberInfoModal( p_skey, p_user_name ){
			
			var url = "/bonusMemberQuarterInfoModal";
			...
			$.ajax({
		        ...
		        success: function(data){
		        	$("#member-detail-dialog").html();
		        	$("#member-detail-dialog").html(data);
					$("#member-detail-dialog").dialog({
						height: 450,
						width: 600,
						closeOnEscape : true,
						draggable : true,
						title: p_user_name+" 성과급 정보조회",						
						modal: true,
						buttons:{							
							"닫기" : function(){
								$(this).dialog("close");
			...
			<div class="center_cnt_1300">
				...
				<div class="center_cnt_vacation" >
					<div class="guest">
						<div class="guestTap">
							<ul>								
								<li class="on" id="mainTab"><a href="#">관리자 기준 성과급 스케줄러</a></li>																								
							</ul>
						</div>
						<!-- 검색 창 시작 -->
						<div class= "tableStyle2" style="border-top: 0px;">
							<form id="searchFrm">
								<div style="float: left;padding:5px 0 0 5px;">
									...
									<b>실적 시작, 종료기준일은 엑셀다운 후 확인 가능합니다.</b>
								</div>								
								...
								<div id="search-box"  align="center">
									...
									<table style="width: 100%;height:60px;" align="center">
										<tr>
											...
											<td width="120px;">
												<select id="srchQuarterFlag" name="srchQuarterFlag" style="width: 100px;">
										...
										<tr>											
											...
											<th>관리자명</th>
											<td>
												<input type="text" id="srchManagerName" name="srchManagerName" style="width:100px;"/>	
											</td>
											<th>팀명</th>
											<td>
										...
										<div class="tableStyle2">
											<table>									
												<tr>
													...
													<th width="80px;">실적건</th>
													<th width="80px;">성과율</th>
													<th width="80px;">기준일자</th>
													<th width="80px;">관리자명</th>													
													<th width="15px;"></th>													
												</tr>
											</table>									
				...
				<div id="member-detail-dialog" title="직원 세부정보 조회" style="font-size: 14px;display:none;" align="center"></div>				
			<!-- //center_cnt -->
			</div>
		</div>
		<!-- //contents -->
