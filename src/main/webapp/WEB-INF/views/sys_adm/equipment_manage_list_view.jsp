...
function goMain(){	
	location.href="./equipment_manage_main_view?viewType=Main";	
}
...
function fnSearch(){
	...
	$("#doExcelDown").val("0");
    var frm = document.getElementById("searchFrm");
    frm.action = "./equipment_manage_main_view";    
    frm.submit();
}
</script>
	<div class= "tableStyle2" style="border-top: 0px;">
		...
		<table>	
			<colgroup>
				...
				<c:choose>
					<c:when test="${equipmentList.size() > 20}"><col style="width:24px;"></c:when>
					<c:otherwise><col style="width:27px;"></c:otherwise>
				</c:choose>
			</colgroup>		
			<tbody>
				<c:choose>
