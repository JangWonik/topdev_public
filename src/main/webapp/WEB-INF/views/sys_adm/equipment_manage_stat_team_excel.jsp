...
<%
    response.setHeader("Content-Disposition", "attachment; filename=top_equipment_team_"+pageContext.getAttribute("today")+".xls");
...
<div>기준일자 : ${selDate}</div>	
	<div class= "tableStyle2" style="border-top: 0px;">							
		<table border="1" style="background: #e7ecf1;">									
			<tr>
