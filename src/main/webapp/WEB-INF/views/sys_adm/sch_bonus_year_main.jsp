...
<head>
	...
	<script language="javascript">
		...
		//엑셀다운로드
		function doDownload(){			
			$("#searchFrm").attr("action","schBonusYearListExcel");
			$("#searchFrm").submit();
		}
			...
			<div class="center_cnt_1300">
				...
				<div class="center_cnt_vacation" >
					<div class="guest">
						<div class="guestTap">
							<ul>								
								<li class="on" id="mainTab"><a href="#">개인기준 성과급 연간스케줄러</a></li>																								
							</ul>
						</div>
						<!-- 검색 창 시작 -->
