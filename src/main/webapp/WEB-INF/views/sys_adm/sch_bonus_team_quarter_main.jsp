...
<head>
	...
	<script language="javascript">
		...
		function fnSearch(){			
			...
			$.ajax({
	 			type : "post",	 			
	 			url : "/getSchBonusTeamQuarterListAjax",
	 			data : formData,
		...
		//엑셀다운로드
		function doDownload(){
			$("#searchFrm").attr("action","schBonusTeamQuarterListExcel");
			$("#searchFrm").submit();
		}
		...
		function fnModifyModal( p_skey ){
			...
			var url = "/schUpdateTeamQuarterModal";
		...
		function fnSchAction( p_action ){
			...
			$.ajax({
	 			type : "post",	 			
	 			url : "/updateSchTeamQuarterInfoAction",
	 			data : formData,
	 			success : function(result){	 				
	 				//창 닫고 새로고침
	 				alert("수정되었습니다.");
			...
			<div class="center_cnt_1300">
				...
				<div class="center_cnt_vacation" >
					<div class="guest">
						<div class="guestTap">
							<ul>								
								<li class="on" id="mainTab"><a href="#">팀 분기별 성과급 스케줄러</a></li>																								
							</ul>
						</div>
						<!-- 검색 창 시작 -->
