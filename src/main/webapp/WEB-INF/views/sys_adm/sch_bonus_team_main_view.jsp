...
<head>
	...
	<script language="javascript">
		...
		//엑셀다운로드
		function doDownload(){
			$("#searchFrm").attr("action","schBonusTeamListExcel");
			$("#searchFrm").submit();
		}
			...
			<div class="center_cnt_1300">
				...
				<div class="center_cnt_vacation" >
					<div class="guest">
						<div class="guestTap">
							<ul>								
								<li class="on" id="mainTab"><a href="#">팀기준 성과급 스케줄러</a></li>																								
							</ul>
						</div>
						<!-- 검색 창 시작 -->
								...
								<div id="search-box"  align="center">
									...
									<table style="width: 100%;height:60px;" align="center">
										<tr>
											...
											<td width="120px;">
												<select id="srchWorkType" name="srchWorkType" style="width: 100px;">
													<option value="9999">- 전체 -</option>
													<option value="14">센터장</option>
