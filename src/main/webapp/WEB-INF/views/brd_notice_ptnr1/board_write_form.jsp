				...
				<div class="centercnt_bot1-2">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" name="uploadForm" action="./noticePtnr1BoardWrite" method="post" enctype="multipart/form-data">
								<input type="hidden" id="ptnr_id" name="ptnr_id" value="${insu}">
								<div class="tableStyle2">
									<table>
										<tr>
											<td width="15%" bgcolor="#e7ecf1" style="text-align:center;">보 험 사</td>
											<td style="text-align:left;padding-left:7px;">${insuNm}</td>
										</tr>
										<tr>
							...
							<p style="text-align:center;margin-top:10px;">
								...
								<a href="./noticePtnr1BoardList?insu=${insu}"><img src="./resources/ls_img/ls_board/btn_write_cancel.gif" /></a>
							</p>
						</div>
					</div>
				</div>
