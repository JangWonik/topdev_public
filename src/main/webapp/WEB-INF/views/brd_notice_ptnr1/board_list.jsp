					...
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
										...
										<c:forEach items="${boardList}" var="boardList">
											<tr>
													...
													<td style="text-align:left;padding-left:7px;">
														<a href="./noticePtnr1BoardDetail?boardNo=${boardList.board_no}&insu=${searchVO.insu}&boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&reqPgNo=${reqPgNoInt1}">
															${boardList.title}
														</a>
													</td>
													<!--첨부-->
							...
							<table border="0" style="margin-top:7px;">
								<tr>
									<td width="50%">
										<form method="get" name="boardSrcForm" action="./noticePtnr1BoardList">
											...
											<a href="./noticePtnr1BoardList?insu=${searchVO.insu}"><img src="./resources/ls_img/ls_board/btn_src_cancel.gif" /></a>
									...
									<td width="20%">
										<p style="text-align:right;">
											<a href="./noticePtnr1BoardWriteForm?insu=${searchVO.insu}"><img src="./resources/ls_img/ls_board/btn_write.gif" /></a>
											<a href="./noticePtnr1Board"><img src="./resources/ls_img/ls_board/btn_write_cancel.gif" /></a>
										</p>
									</td>
								</tr>
							</table>
