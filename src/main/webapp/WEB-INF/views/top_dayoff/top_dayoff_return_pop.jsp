			...
			<div class="center_cnt">
				<div class="centercnt_bot1-3">
					<div class="guest">
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">&nbsp;${user_name} 반려 및 취소</a></li>
							</ul>
						</div>
							...
							<table cellpadding="0" cellspacing="0">
									...
									<tr>
				                        <td bgcolor="#F8F8F8" class="td" height="28">
				                            <p align="center"><b>반려 및 취소사유</b></p>
				                        </td>
				                        <td>
				                        	<textarea id="cancel_memo" name="cancel_memo" value="${selCancelMemo.cancel_memo}" style="width:95%; height:150px;"></textarea>
						...
						<br>
						<p align="center">
							<input type="image" src="./resources/ls_img/ls_report/btn_rch_return.gif" class="dayoffReturnBtn"/>
						</p>
						</div>
					</div><!-- //guest -->
				</div><!-- //bot1-3 -->
