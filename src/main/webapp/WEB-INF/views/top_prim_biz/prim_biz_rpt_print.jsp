            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td colspan="4" class="td" height="40">
                        <p align="center" style="line-height:200%;"><B><u><span style="font-size:11pt;">사 
                        고 처 리 과 정 표</span></u></B></p>
                    </td>
                    <td class="td" height="40">
                        <p align="center">보고서번호</p>
                    </td>
                    <td class="td" height="40">
<p><b>${primBizRptDtl.suim_rpt_no}</b></p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" class="td">
                        <p>${primBizRptDtl.reg_date_fmt}</p>
                    </td>
                    <td class="td">
                        <p align="center">사 고 번 호</p>
                    </td>
                    <td class="td">
<p>${primBizRptDtl.accident_no}</p>
                    </td>
                </tr>
                <tr>
                    <td class="td" height="27">
                ...
                <tr>
                    ...
                    <td class="td">
<p>${primBizRptDtl.ptnr_name}</p>
                    </td>
                    <td class="td">
                        <p align="center">부, 팀명</p>
                    </td>
                    <td class="td">
<p>${primBizRptDtl.team_name}</p>
                    </td>
                    <td class="td">
                        <p align="center">담 &nbsp;&nbsp;당 &nbsp;&nbsp;자</p>
                    </td>
                    <td class="td">
<p>${primBizRptDtl.ptnr_mbr_nm}</p>
                    </td>
                </tr>
                <tr>
                    <td class="td" height="27">
                    ...
                    <td colspan="3" class="td">
<p>${primBizRptDtl.insurance_nm}</p>
                    </td>
                    <td class="td">
                        <p align="center">증 권 번 호</p>
                    </td>
                    <td class="td">
<p>${primBizRptDtl.policy_no}</p>
                    </td>
                </tr>
                <tr>
...
<p>${primBizRptDtl.policyholder_nm}</p>
                    </td>
                    <td rowspan="2" class="td">
                        <p align="center">연 &nbsp;&nbsp;락 &nbsp;&nbsp;처</p>
                    </td>
                    <td class="td">
<p>${primBizRptDtl.policyholder_tel}</p>
                    </td>
                </tr>
                <tr>
                    <td class="td">
                ...
                <tr>
                    ...
                    <td colspan="3" class="td">
<p>${primBizRptDtl.damaged_nm}</p>
                    </td>
                    <td class="td">
                        <p align="center">연 &nbsp;&nbsp;락 &nbsp;&nbsp;처</p>
                    </td>
                    <td class="td">
<p>${primBizRptDtl.damaged_tel}</p>
                    </td>
                </tr>
                <tr>
                    <td class="td" height="27">
                    ...
                    <td colspan="3" class="td">
<p>${primBizRptDtl.accident_date_fmt}</p>
                    </td>
                    <td class="td">
...
<p>${primBizRptDtl.accident_facts}</p>
                    </td>
                </tr>
                <tr>
                    <td class="td" height="27">
                ...
                <tr>
                    ...
                    <td colspan="3" class="td">
<p>
	<c:if test="${primBizRptDtl.suim_rpt_type1 eq '1'}">배상</c:if>
	<c:if test="${primBizRptDtl.suim_rpt_type1 eq '2'}">재물</c:if>
	<c:if test="${primBizRptDtl.suim_rpt_type1 eq '3'}">상해</c:if>
	<c:if test="${primBizRptDtl.suim_rpt_type1 eq '4'}">질병</c:if>
</p>
                    </td>
                    <td class="td">
...
<p>${primBizRptDtl.beneficiary_nm}</p>
                    </td>
                    <td width="20" rowspan="5" class="td">
                        <p align="center">피</p>
                        <p align="center">해</p>
...
<p>&nbsp;</p>
                ...
                <tr>
                    ...
                    <td class="td">
<p>${primBizRptDtl.beneficiary_tel}</p>
                    </td>
                    <td class="td">
                        <p align="center">전 &nbsp;&nbsp;화</p>
                    </td>
