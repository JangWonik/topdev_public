...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<script>
		...
		function popSuimDtl(suim_rpt_no){
			...
			window.open('suimRptBscDtl?suim_rpt_no='+suim_rpt_no,suim_rpt_no,'width='+sw+',height='+sh+',top='+mt+',left='+ml+',resizable=no,scrollbars=yes');
		}
	</script>
								...
								<table>
									<thead>
										<tr>
											...
											<th width="5%">경과</th>
											<th width="5%">상태</th>
											<th width="5%">최근진행사항</th>
											<th width="5%">진행사항길이</th>
										</tr>
									</thead>
									<tbody>
										<!--  -->
										...
										style ="cursor:pointer;" onclick="popSuimDtl('${suimVO.suim_rpt_no}')">
											...
											<!-- 최근진행사항 -->
											<td>${suimVO.now_reg_date_fmt}</td>
											<!-- 진행사항길이 -->
											<td>${suimVO.now_memo_length}</td>
										</tr>
										</c:forEach>
										<!-- 손해보험 출력 끝 -->
									</tbody>
