				...
				<div class="centercnt_top">
					<div class="nociteA log_top">
						<div class="search_bar">
							...
							<form name="misSearchForm" id="misSearchForm" method="GET" action="./myStatistics">
				...
				<div class="centercnt_bot2" style="margin:0 auto;">
					<div class="guest">
						...
						<div class="guestcnt2" style="display:block;">
							<c:import url="../top_statistics/mis_tm_bsc_mbr_21.jsp"></c:import>
						</div>
						<div class="guestcnt2" style="display:none;">
							<c:import url="../top_statistics/mis_tm_bsc_mbr_22.jsp"></c:import>
						</div>
						<div class="guestcnt2" style="display:none;">
							<c:import url="../top_statistics/mis_tm_bsc_mbr_23.jsp"></c:import>
						</div>
