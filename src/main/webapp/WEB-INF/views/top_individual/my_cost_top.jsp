...
<script>
	...
	<form name="datef" method="GET" action="./myCostInsList"> 
	<!-- 달력 From -->
	...
	<input type="hidden" id="selectNo" name="cost_class_no" size="10"  value="${cost_class_no}" maxlength="10" />  
	</form>
