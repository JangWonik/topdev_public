...
<c:set var="realURL" value="https://old.toplac.co.kr/salary/intern/authorization/${salaryInfo.salaryUrl}.do"/>
<c:set var="testURL" value="http://localhost:8080/salary/intern/authorization/${salaryInfo.salaryUrl}.do"/>
