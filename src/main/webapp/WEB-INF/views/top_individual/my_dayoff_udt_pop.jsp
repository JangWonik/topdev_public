			...
			<div class="center_cnt">
				<div class="centercnt_bot1-3">
					<div class="guest">
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">&nbsp;${user_name} 휴가수정</a></li>
							</ul>
						</div>
...
<!-- 				                    </tr> -->
									...
									<tr>
				                        ...
				                        <td>
				                        	<input type="text" id="title" name="title" value="${myDayoffUdtSel.title}" style="width:95%;"/>
				                        </td>
				                    </tr>
				                    <tr>
				                        <td bgcolor="#F8F8F8" class="td" height="28">
						...
						<br>
						<p align="center">
							<img src="./resources/ls_img/btn_edite.gif" onclick="mydayoffUdt()" style="cursor:pointer;"/>
						</p>
						</div>
					</div><!-- //guest -->
				</div><!-- //bot1-3 -->
