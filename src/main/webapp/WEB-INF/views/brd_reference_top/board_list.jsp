					...
					<div class="guest">
						...
						<div class="guestcntSearch" style="display:block;">
										...
										<c:forEach items="${boardList}" var="boardList">
											<tr>
													...
													<td style="text-align:left;padding-left:7px;">
														<a href="./referenceTopBoardDetail?boardNo=${boardList.board_no}&boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&reqPgNo=${reqPgNoInt1}">
															${boardList.title}
														</a>
													</td>
													<!--첨부-->
							...
							<table border="0" style="margin-top:7px;">
								<tr>
									<td width="50%">
										<form method="get" name="boardSrcForm" action="./referenceTopBoardList">
											...
											<a href="./referenceTopBoardList"><img src="./resources/ls_img/ls_board/btn_src_cancel.gif" /></a>
									...
									<td width="10%">
										<p style="text-align:right;">
											<a href="./referenceTopBoardWriteForm"><img src="./resources/ls_img/ls_board/btn_write.gif" /></a>
										</p>
									</td>
								</tr>
							</table>
