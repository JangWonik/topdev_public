							...
							function(data,status){
								if(status == "success"){
									if(data.length == 0){alert(data);
										...
										window.location.assign("./referenceTopBoardList?boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&reqPgNo=${reqPgNo}");
									}//if(data.length == 0){
								}else{
							...
							<div class="tableStyle21">
								<table>
									...
									<tr>
										...
										<td><a href="javascript:boardPrintPop(${boardDetail.board_no});"><img src="./resources/ls_img/ls_board/icon_print.gif" /></a></td>
									</tr>
									<tr>
...
<!-- 													</a> -->
							...
							<p style="text-align:center;margin-top:10px;">
								<c:if test="${mbrVo_Session.user_no eq boardDetail.user_no}">
									<a href="./referenceTopBoardUpdateForm?boardNo=${boardDetail.board_no}&boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&reqPgNo=${reqPgNo}"><img src="./resources/ls_img/ls_board/btn_modify.gif" /></a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="#"><img src="./resources/ls_img/ls_board/btn_del.gif" id="boardDeleteBtn" /></a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</c:if>
								<a href="./referenceTopBoardList?boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&reqPgNo=${reqPgNo}"><img src="./resources/ls_img/ls_board/btn_list.gif" /></a>
							</p>
							<br />
							<!-- memo -->
