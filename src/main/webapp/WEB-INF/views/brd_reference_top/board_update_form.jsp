					...
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							...
							<p style="text-align:center;margin-top:10px;">
								...
								<a href="./referenceTopBoardDetail?boardNo=${boardDetail.board_no}&boardSrcType=${searchVO.boardSrcType}&boardSrcWord=${searchVO.boardSrcWord}&reqPgNo=${reqPgNo}"><img src="./resources/ls_img/ls_board/btn_write_cancel.gif" /></a>
							</p>
						</div>
					</div>
				</div>
