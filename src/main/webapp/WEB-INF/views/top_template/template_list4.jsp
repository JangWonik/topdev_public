...
<head>
	...
	<script>
		$(document).ready(function(){
			...
			//분류 관리
			$("#category_manage").on("click", function () {	        	
				location.href = "./insu4TemplistCategory";
	        });
...
<div id="wrapper">
			...
			<div class="center_cnt">
				...
				<div class="centercnt_bot1-2">
					<div class="guest">
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">(인)보험 자료실</a></li>
							</ul>
						</div>
						<!-- 검색창 시작 -->						
						<form id="searchForm" name="searchForm" method="post" action="insu4Templist">
						<div id="search-box"  align="center" style="padding-top:10px;">
							<table style="width: 100%;" align="center" class="tableStyle2">											
								<tr>
									...
									<th width="10%">파일명</th>
									<td width="25%">										
										<input type="text" id="srchFileName" name="srchFileName" style="width:200px;" value="${searchParam.srchFileName}"/>
									</td>
									<td width="10%">
							...
							<tr>
								<td>
									<div id="function-box"  align="left" style="padding-top:10px;padding-left:5px;display: inline-block">
										<a class="btn-vacation-aprv" id="category_manage" href="#noloc">분류 관리</a>
									</div>
								</td>
								<td align="right">
	...
	<!-- //footer -->
	<form id="template4ActionFrm" name="template4ActionFrm" method="post">
	...
	<form id="filedownForm" name="filedownForm" action="insuTemplate4Filedown">
