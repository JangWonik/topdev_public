...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#btn_excel").click(function(){
			...
			$("#excelForm").attr("action","rptLockList_Excel");
			excelForm.submit();
		});
				...
				<div class="center_cnt_1300_bot">
					<div class="guest">
						...
						<div style="text-align:right;">
							...
							<form action="rptLockList_Excel" method="get" id="excelForm">
									<input type="hidden" id="rptlock" name="rptlock" />
							</form>
						</div>
						<div class="guestTap">
							<ul>
								<li class="on"><a href="#">수임대장 lock 관리</a></li>
							</ul>
						</div>
						

						<div class="guestcnt4" style="display:block;">
							<c:import url="../sysadm_report/rpt_lock_list.jsp"></c:import>
						</div>
