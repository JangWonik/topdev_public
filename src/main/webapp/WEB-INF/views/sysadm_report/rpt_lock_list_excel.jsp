...
<body>
	...
	<h1>보고서 락 관리 rptLockList.xls</h1>
	<br /><br />
	<!-- 검색 조건 테이블 -->
	<h2>검색 조건 테이블</h2>
			<table border="1">
									...
									<tbody>
										<!--  -->
										<c:forEach items="${rptLockListExcel}" var="suimVO" varStatus="status"> <!-- begin="1" end="20" step="1" -->
										<tr onMouseOver="this.style.backgroundColor='#FFECEC'" onMouseOut="this.style.backgroundColor=''"
										style ="cursor:pointer;" onclick="popSuimDtl('${suimVO.suim_rpt_no}')">
											<!-- no -->
											<td>${rptLockListExcel.size() - status.index}</td>
											<!-- lock -->
											<td>
												<c:choose>
