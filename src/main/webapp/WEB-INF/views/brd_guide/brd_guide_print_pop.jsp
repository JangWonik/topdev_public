				...
				<div class="centercnt_bot1-3">
					<div class="guest">
						...
						<div class="guestcnt4" style="display:block;">
							<form id="uploadForm" id="uploadForm" name="uploadForm" action="./brd_guide_write" method="post" enctype="multipart/form-data">
								<input type="hidden" id="guide_no" name="guide_no" value="${guideVo.guide_no}">
								<input type="hidden" id="user_no" name="user_no" value="${guideVo.regUserNo}">
								<div class="tableStyle21">
									<table>
										<tr>
											<td width="15%" bgcolor="#e7ecf1" style="text-align:center;">작성자</td>
											<td width="25%">${guideVo.userName}</td>
											<td width="15%" bgcolor="#e7ecf1" style="text-align:center;">작성일</td>
											<td width="25%">${guideVo.regDate}</td>
											<td width="10%" bgcolor="#e7ecf1" style="text-align:center;">분류</td>
											<td width="10%" style="text-align:center;">${guideVo.guideType}</td>
										</tr>
										<tr>
											<td width="15%" bgcolor="#e7ecf1" style="text-align:center;">제 목</td>
											<td colspan="4">${guideVo.title}</td>
										...
										<tr>
											...
											<td colspan="5">${guideVo.contents}</td>
										</tr>
									</table>
								</div>
							</form>
