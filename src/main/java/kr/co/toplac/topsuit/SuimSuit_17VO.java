...
public class SuimSuit_17VO {
	...
	private String policyholderTel1;
	private String policyholderTel2;
	private String policyholderHp;
	...
	public String getRidLock() {
		return ridLock;
	}
	public void setRidLock(String ridLock) {
		this.ridLock = ridLock;
	}
	...
	public String getInfoH() {
		return infoH;
	}
	public void setInfoH(String infoH) {
		this.infoH = infoH;
	}
	public String getInfoI() {
		return infoI;
	}
	public void setInfoI(String infoI) {
		this.infoI = infoI;
	}
	...
	public void setInfoK(String infoK) {
		this.infoK = infoK;
	}
	...
	public String getInfoAa() {
		return infoAa;
	}
	public void setInfoAa(String infoAa) {
		this.infoAa = infoAa;
	}
	public String getInfoAb() {
		return infoAb;
	}
	public void setInfoAb(String infoAb) {
		this.infoAb = infoAb;
	}
	public String getInfoAc() {
		return infoAc;
	}
	public void setInfoAc(String infoAc) {
		this.infoAc = infoAc;
	}
	...
	public String getInfoAe() {
		return infoAe;
	}
	public void setInfoAe(String infoAe) {
		this.infoAe = infoAe;
	}
	public String getInfoAf() {
		return infoAf;
	}
	public void setInfoAf(String infoAf) {
		this.infoAf = infoAf;
	}
	public String getInfoAg() {
		return infoAg;
	}
	public void setInfoAg(String infoAg) {
		this.infoAg = infoAg;
	}
	public String getD1() {
		return d1;
	...
	public String getPolicyholderTel1() {
		return policyholderTel1;
	}
	public void setPolicyholderTel1(String policyholderTel1) {
		this.policyholderTel1 = policyholderTel1;
	}
	public String getPolicyholderTel2() {
		return policyholderTel2;
	}
	public void setPolicyholderTel2(String policyholderTel2) {
		this.policyholderTel2 = policyholderTel2;
	}
	public String getPolicyholderHp() {
		return policyholderHp;
	}
	public void setPolicyholderHp(String policyholderHp) {
		this.policyholderHp = policyholderHp;
	}
	...
	public String getInfoUb() {
		return infoUb;
	}
	public void setInfoUb(String infoUb) {
		this.infoUb = infoUb;
	}
