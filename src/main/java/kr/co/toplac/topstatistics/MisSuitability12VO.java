...
public class MisSuitability12VO {
	...
	private String end_m_fail;
	private String end_y_fail;
	...
	public String getTmUserCnt() {
		return tmUserCnt;
	}
	public void setTmUserCnt(String tmUserCnt) {
		this.tmUserCnt = tmUserCnt;
	}
	...
	public String getEnd_m_fail() {
		return end_m_fail;
	}
	public void setEnd_m_fail(String end_m_fail) {
		this.end_m_fail = end_m_fail;
	}
	public String getEnd_y_fail() {
		return end_y_fail;
	}
	public void setEnd_y_fail(String end_y_fail) {
		this.end_y_fail = end_y_fail;
	}
	...
	public void setEnd_mi(String end_mi) {
		this.end_mi = end_mi;
	}
